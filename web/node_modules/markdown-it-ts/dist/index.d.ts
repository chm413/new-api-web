import type { Token as TokenType } from './common/token.js';
import type { ParserBlock } from './parse/parser_block.js';
import type { ParserInline } from './parse/parser_inline/index.js';
import type { StreamStats } from './stream/parser.js';
import type { UnboundedBufferStats, UnboundedChunkInfo } from './stream/unbounded.js';
import LinkifyIt from 'linkify-it';
import * as utils from './common/utils.js';
import * as helpers from './helpers/index.js';
import { normalizeLink, normalizeLinkText, validateLink } from './parse/link_utils.js';
import { ParserCore } from './parse/parser_core.js';
import Renderer from './render/renderer.js';
export { Token } from './common/token.js';
export { parse, parseInline } from './parse/index.js';
export type { ParseSource, TextSource } from './parse/source.js';
export { withRenderer } from './plugins/with-renderer.js';
export type { RendererEnv, RendererOptions } from './render/index.js';
...
export interface MarkdownItPluginModule {
    default: MarkdownItPluginFn;
}
...
declare const MarkdownItExport: MarkdownItConstructor;
