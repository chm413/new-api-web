...
//#region src/awesome/TypewriterEffect/type.d.ts
type CursorStyle = 'pipe' | 'underscore' | 'dot' | 'block';
type SegmentMode = 'grapheme' | 'word';
...
//#endregion
export { CursorStyle, SegmentMode, TypewriterEffectProps };
