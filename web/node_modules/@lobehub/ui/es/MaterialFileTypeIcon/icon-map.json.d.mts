//#region src/MaterialFileTypeIcon/icon-map.json.d.ts
...
//#endregion
export { __json_default_export as default, fileExtensions, fileNames, folderNames };
//# sourceMappingURL=icon-map.json.d.mts.map