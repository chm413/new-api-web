...
const itemStyles = createStaticStyles(({ css }) => ({
	itemMinWidth: css`
...
//#endregion
export { flatGroupStyles, flatGroupVariants, groupStyles, itemStyles, itemVariants, styles, submitFooterStyles, titleStyles, titleVariants, variants };
