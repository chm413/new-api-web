...
__webpack_require__.add({
    "../../node_modules/.pnpm/enhanced-resolve@5.24.2/node_modules/enhanced-resolve/lib/CachedInputFileSystem.js" (module, __unused_rspack_exports, __webpack_require__) {
...
You can also more options via the 'target' option: 'browserslist' / 'browserslist:env' / 'browserslist:query' / 'browserslist:path-to-config' / 'browserslist:path-to-config:env'`);
    ...
    }), D(output, 'bundlerInfo', {}), 'object' == typeof output.bundlerInfo && (D(output.bundlerInfo, 'version', "2.1.4"), D(output.bundlerInfo, 'bundler', 'rspack'), D(output.bundlerInfo, 'force', !1));
...
class MultiStats {
    ...
    toJson(options) {
        ...
        }), childOptions.version && (obj.rspackVersion = "2.1.4", obj.version = "5.75.0"), childOptions.hash && (obj.hash = obj.children.map((j)=>j.hash).join(''));
        let mapError = (j, obj)=>({
                ...obj,
...
}, CachedInputFileSystem = __webpack_require__("../../node_modules/.pnpm/enhanced-resolve@5.24.2/node_modules/enhanced-resolve/lib/CachedInputFileSystem.js");
...
let iterateConfig = (config, options, fn)=>{
    ...
    compilation: {
        ...
        version: (object)=>{
            object.version = "5.75.0", object.rspackVersion = "2.1.4";
        },
...
let CORE_VERSION = "2.1.4", VFILES_BY_COMPILER = new WeakMap();
...
let exports_rspackVersion = "2.1.4", exports_version = "5.75.0", exports_WebpackError = Error, exports_config = {
