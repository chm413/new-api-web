(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function addArrowMark(arrowSpec) {
        const { arrows } = arrowSpec, style = __rest(arrowSpec, ["arrows"]);
    ...
    function generateArrowLineSpec(line = {}, margin) {
        const { style = {} } = line, rest = __rest(line, ["style"]);
    ...
    function generateArrowSymbolSpec(symbol = {}, margin) {
        const { style = {} } = symbol, rest = __rest(symbol, ["style"]);
    ...
    function generateArrowTextSpec(text = {}, margin) {
        const { style = {}, formatMethod, textMargin = 4 } = text, rest = __rest(text, ["style", "formatMethod", "textMargin"]);
    ...
    function addFunnelBackgroundMark(funnelBackground) {
        const { style = {} } = funnelBackground, rest = __rest(funnelBackground, ["style"]);
    ...
    class CombinationCandlestickChartSpecTransformer extends vchart.CartesianChartSpecTransformer {
        ...
        _transformLayout(spec) {
            ...
            let totalRow = 0;
            let totalCol = 0;
            if (spec.title && ((_a = spec.title) === null || _a === void 0 ? void 0 : _a.visible) !== false) {
                totalRow++;
            }
            if (spec.legends) {
            ...
            if (spec.title && ((_b = spec.title) === null || _b === void 0 ? void 0 : _b.visible) !== false) {
    ...
    function getBarLinkConfig(style = {}, extraStyle) {
        const { linkType = 'total', doFill } = style, rest = __rest(style, ["linkType", "doFill"]);
        return {
            type: 'component',
    ...
    function appendScatterRegressionLineConfig(chartSpec, spec) {
        ...
        specs.forEach((s) => {
            if (s.visible !== false) {
                ...
                const { type } = s, rest = __rest(s, ["type"]);
