#!/usr/bin/env node
import {a as a$2}from'./chunk-NAQBA4XN.js';import {r,q,c as c$3,g as g$2,k,l,h as h$1,i,d as d$2,p,f as f$3}from'./chunk-NUMOKWW5.js';import {e,d,Q as Q$1,f,Da,g,h,Ga as Ga$1,a,ma as ma$1,da as da$1,Ea,X as X$1,Y,E,b,Z as Z$1,W,sa as sa$1,ua as ua$1,U,V,S,Fa as Fa$1,ba,oa as oa$1,R,c as c$1,ra as ra$1,aa as aa$1,Ja as Ja$1,Ka as Ka$1,La as La$1,xa as xa$1,va,ya as ya$1,J,F,G,I,H as H$1,y,ja,za as za$1,ca as ca$1,ea as ea$1,Ma as Ma$1,ia as ia$1,fa as fa$1,Aa as Aa$1,ta as ta$1,la as la$1,x,ha as ha$1,p as p$1,$,ga,_ as _$1,L as L$1,T,O,M,N as N$1,A as A$1,K,P,z as z$1,i as i$1,B,D,C}from'./chunk-2X25ZGWB.js';export{xa as fetchTree,ya as getItemTargetPath,Ca as getPreset,Ba as getPresets,za as getRegistries,qa as getRegistriesConfig,Aa as getRegistriesIndex,na as getRegistry,va as getRegistryBaseColor,ua as getRegistryBaseColors,ta as getRegistryIcons,oa as getRegistryItems,sa as getRegistryStyles,ra as getShadcnRegistryIndex,pa as resolveRegistryItems,wa as resolveTree}from'./chunk-2X25ZGWB.js';import {c,f as f$2,n}from'./chunk-3ORLOMOE.js';import {a as a$1,c as c$2,g as g$1,d as d$1,f as f$1,e as e$1}from'./chunk-7SBJAAAY.js';import {a as a$3}from'./chunk-CHWMSXYA.js';import*as A from'path';import A__default,{join}from'path';import {promises,existsSync}from'fs';import L from'fs-extra';import ds from'open';import Re from'prompts';import Ro from'dedent';import hs,{tmpdir}from'os';import {execa}from'execa';import P$1 from'postcss';import xs from'postcss/lib/at-rule';import Xr,{z}from'zod';import {twMerge}from'tailwind-merge';import {Project,ScriptKind,SyntaxKind,VariableDeclarationKind,Node}from'ts-morph';import Co from'deepmerge';import {Command}from'commander';import {loadConfig}from'tsconfig-paths';import {diffLines,structuredPatch,diffWords}from'diff';import {dim,yellow,bold,green,cyan,red}from'kleur/colors';import*as bt from'fs/promises';import bt__default from'fs/promises';import {StdioServerTransport}from'@modelcontextprotocol/sdk/server/stdio.js';import {randomBytes}from'crypto';import tn from'fast-glob';async function io(e$1){let t={};if(!L.existsSync(e$1.cwd)||!L.existsSync(A__default.resolve(e$1.cwd,"package.json")))return t["1"]=true,{errors:t,projectInfo:null};let r=E("Preflight checks.",{silent:e$1.silent}).start();L.existsSync(A__default.resolve(e$1.cwd,"components.json"))&&!e$1.force&&(r?.fail(),e.break(),e.error(`A ${d.info("components.json")} file already exists at ${d.info(e$1.cwd)}.
To start over, remove the ${d.info("components.json")} file and run ${d.info("init")} again.`),e.break(),process.exit(1)),r?.succeed();let n=E("Verifying framework.",{silent:e$1.silent}).start(),o=e$1.existingConfig?.tailwind,i=await Da(e$1.cwd,{configCssFile:typeof o?.css=="string"?o.css:void 0});if(!i||i?.framework.name==="manual"){if(t["7"]=true,n?.fail(),!e$1.monorepo&&await f(e$1.cwd)){let f=await g(e$1.cwd);f.length>0&&(h("init",f),process.exit(1));}e.break(),i?.framework.links.installation&&e.error(`We could not detect a supported framework at ${d.info(e$1.cwd)}.
Visit ${d.info(i?.framework.links.installation)} to manually configure your project.
Once configured, you can use the cli to add components.`),e.break(),process.exit(1);}n?.succeed(`Verifying framework. Found ${d.info(i.framework.label)}.`);let s="Validating Tailwind CSS.";i.tailwindVersion==="v4"&&(s=`Validating Tailwind CSS. Found ${d.info("v4")}.`);let l=E(s,{silent:e$1.silent}).start();i.tailwindVersion==="v3"&&(!i?.tailwindConfigFile||!i?.tailwindCssFile)?(t["5"]=true,l?.fail()):i.tailwindVersion==="v4"&&!i?.tailwindCssFile?(t["5"]=true,l?.fail()):i.tailwindVersion?l?.succeed():(t["5"]=true,l?.fail());let a$1=E("Validating import alias.",{silent:e$1.silent}).start();return i?.aliasPrefix?a$1?.succeed():(t["6"]=true,a$1?.fail()),Object.keys(t).length>0&&(t["5"]&&(e.break(),e.error(`No Tailwind CSS configuration found at ${d.info(e$1.cwd)}.`),e.error("It is likely you do not have Tailwind CSS installed or have an invalid configuration."),e.error("Install Tailwind CSS then try again."),i?.framework.links.tailwind&&e.error(`Visit ${d.info(i?.framework.links.tailwind)} to get started.`)),t["6"]&&(e.break(),e.error(`Could not find valid path aliases or package imports for ${d.info("init")}.`),e.error(`Configure path aliases in ${d.info("tsconfig.json")} or imports in ${d.info("package.json")}, then run ${d.info("init")} again.`),e.error(`Learn more at ${d.info(`${a}/docs/installation/manual#configure-import-aliases`)}.`)),e.break(),process.exit(1)),{errors:t,projectInfo:i}}async function so(e,t){let r=new Set,n=new Set,o=[...e];for(;o.length>0;){let i=o.shift();if(n.has(i))continue;n.add(i);let{registry:s}=x(i);s&&!b[s]&&r.add(s);try{let[l]=await ha$1([i],t,{useCache:!0});if(l?.registryDependencies)for(let a of l.registryDependencies){let{registry:f}=x(a);f&&!b[f]&&r.add(f),n.has(a)||o.push(a);}}catch(l){if(l instanceof p$1){let{registry:a}=x(i);a&&!b[a]&&r.add(a);continue}continue}}return Array.from(r)}async function H(e,t,r={}){r={silent:false,writeFile:true,...r};let o=(await so(e,t)).filter(f=>!t.registries?.[f]&&!Object.keys(b).includes(f));if(o.length===0)return {config:t,newRegistries:[]};let i=await Aa$1({useCache:process.env.NODE_ENV!=="development"});if(!i)return {config:t,newRegistries:[]};let s={};for(let f of o)i[f]&&(s[f]=i[f]);if(Object.keys(s).length===0)return {config:t,newRegistries:[]};let l=Object.fromEntries(Object.entries(t.registries||{}).filter(([f])=>!Object.keys(b).includes(f))),a={...t,registries:{...l,...s}};if(r.writeFile){let{resolvedPaths:f,...m}=a,p=E("Updating components.json.",{silent:r.silent}).start(),u=c.parse(m);await L.writeFile(A__default.resolve(t.resolvedPaths.cwd,"components.json"),JSON.stringify(u,null,2)+`
`,"utf-8"),p.succeed();}return {config:a,newRegistries:Object.keys(s)}}var Z={nova:{title:"Nova",description:"Lucide / Geist",style:"nova",baseColor:"neutral",theme:"neutral",chartColor:"neutral",iconLibrary:"lucide",font:"geist",fontHeading:"inherit",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false},vega:{title:"Vega",description:"Lucide / Inter",style:"vega",baseColor:"neutral",theme:"neutral",chartColor:"neutral",iconLibrary:"lucide",font:"inter",fontHeading:"inherit",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false},maia:{title:"Maia",description:"Hugeicons / Figtree",style:"maia",baseColor:"neutral",theme:"neutral",chartColor:"neutral",iconLibrary:"hugeicons",font:"figtree",fontHeading:"inherit",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false},lyra:{title:"Lyra",description:"Phosphor / JetBrains Mono",style:"lyra",baseColor:"neutral",theme:"neutral",chartColor:"neutral",iconLibrary:"phosphor",font:"jetbrains-mono",fontHeading:"inherit",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false},mira:{title:"Mira",description:"Hugeicons / Inter",style:"mira",baseColor:"neutral",theme:"neutral",chartColor:"neutral",iconLibrary:"hugeicons",font:"inter",fontHeading:"inherit",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false},luma:{title:"Luma",description:"Lucide / Inter",style:"luma",baseColor:"neutral",theme:"neutral",chartColor:"neutral",iconLibrary:"lucide",font:"inter",fontHeading:"inherit",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false},sera:{title:"Sera",description:"Lucide / Noto Sans + Playfair Display",style:"sera",baseColor:"taupe",theme:"taupe",chartColor:"taupe",iconLibrary:"lucide",font:"noto-sans",fontHeading:"playfair-display",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false},rhea:{title:"Rhea",description:"Lucide / Inter",style:"rhea",baseColor:"neutral",theme:"neutral",chartColor:"neutral",iconLibrary:"lucide",font:"inter",fontHeading:"inherit",menuAccent:"subtle",menuColor:"default",radius:"default",rtl:false}};function jr(e){let t=new URL(`${a}/create`),{rtl:r,pointer:n,...o}=e??{};for(let[i,s]of Object.entries(o))s!==void 0&&t.searchParams.set(i,String(s));return r&&t.searchParams.set("rtl","true"),n&&t.searchParams.set("pointer","true"),t.toString()}async function Er(e$1){if(e.break(),e.log(`  Build your custom preset on ${d.info(e$1.createUrl)}`),e.log(`  ${e$1.followUp}`),e.break(),e$1.prompt===false)return;let{proceed:t}=await Re({type:"confirm",name:"proceed",message:"Open in browser?",initial:true});t&&await ds(e$1.createUrl);}function he(e,t){let r=new URLSearchParams({base:e.base,style:e.style,baseColor:e.baseColor,theme:e.theme,iconLibrary:e.iconLibrary,font:e.font,rtl:String(e.rtl??false),menuAccent:e.menuAccent,menuColor:e.menuColor,radius:e.radius});return e.chartColor&&e.chartColor!=="neutral"&&r.set("chartColor",e.chartColor),e.fontHeading&&e.fontHeading!=="inherit"&&r.set("fontHeading",e.fontHeading),t?.preset&&r.set("preset",t.preset),t?.template&&r.set("template",t.template),t?.only&&r.set("only",t.only),t?.pointer&&r.set("pointer","true"),r.set("track","1"),`${a}/init?${r.toString()}`}async function qe(){let{base:e}=await Re({type:"select",name:"base",message:`Select a ${d.info("component library")}`,choices:[{title:"Radix",value:"radix"},{title:"Base",value:"base"}]});return e||process.exit(1),e}async function lt(e){let t=Object.entries(Z),{selectedPreset:r}=await Re({type:"select",name:"selectedPreset",message:`Which ${d.info("preset")} would you like to use?`,choices:[...t.map(([o,i])=>({title:i.title,description:i.description,value:o})),{title:"Custom",description:`Build your own at ${d.info(`${a}/create`)}`,value:"custom"}]});if(r||process.exit(1),r==="custom"){let o=jr({command:"init",rtl:e.rtl,pointer:e.pointer,base:e.base,...e.template&&{template:e.template}});await Er({createUrl:o,followUp:`Then ${d.info("copy and run the command")} from ui.shadcn.com.`}),process.exit(0);}let n=Z[r];return n||process.exit(1),{url:he({...n,base:e.base,rtl:e.rtl},{template:e.template,pointer:e.pointer}),base:e.base}}async function Te(e,t,r){let n=ca$1(ba({resolvedPaths:{cwd:t},...r?.registries&&{registries:r.registries}})),{config:o}=await H([e],n,{silent:true,writeFile:false});n=o,fa$1(e,n);let[i]=await oa$1([e],{config:n,useCache:true}),s=i?.type==="registry:base"&&i.config?i.config:void 0,l=e;if(gs(e)){let a=new URL(e);a.searchParams.delete("track"),l=a.toString();}return {registryBaseConfig:s,installStyleIndex:i?.extends!=="none",url:l}}function gs(e){try{return new URL(e).pathname==="/init"&&e.startsWith(a)}catch{return  false}}var ys=process.env.SHADCN_GITHUB_URL??"https://github.com/shadcn-ui/ui.git";function X(e){return {...e,frameworks:e.frameworks??[],scaffold:e.scaffold??co({title:e.title,templateDir:e.templateDir}),postInit:e.postInit??Cs}}function Ne(e,{monorepo:t}){if(!t||!e.monorepo)return e;let r=e.monorepo,n={...e,templateDir:r.templateDir,defaultProjectName:r.defaultProjectName??r.templateDir,init:r.init??e.init,files:r.files??e.files};return n.scaffold=co({title:e.title,templateDir:r.templateDir}),n}function ws(e){switch(e){case "pnpm":return ["--no-frozen-lockfile"];case "yarn":return ["--no-immutable"];default:return []}}async function bs(e,t){if(t==="pnpm")return;let r=A__default.join(e,"pnpm-workspace.yaml"),n=A__default.join(e,"package.json"),o=A__default.join(e,"pnpm-lock.yaml");L.existsSync(o)&&await L.remove(o);let i=L.existsSync(r),s=i?i$1(await L.readFile(r,"utf8")):[],l=s.length>0;if(L.existsSync(n)){let a=await L.readFile(n,"utf8"),f=JSON.parse(a);l?f.packageManager=await ks(t):delete f.packageManager,l&&(f.workspaces=s),await L.writeFile(n,JSON.stringify(f,null,2)+`
`);}i&&await L.remove(r),l&&t==="npm"&&await ao(e);}async function ks(e){try{let{stdout:t}=await execa(e,["--version"]);return `${e}@${t.trim()}`}catch{return `${e}@*`}}async function ao(e){let t=await L.readdir(e,{withFileTypes:true});for(let r of t){if(r.name==="node_modules")continue;let n=A__default.join(e,r.name);if(r.isDirectory())await ao(n);else if(r.name==="package.json"){let o=await L.readFile(n,"utf8");if(!o.includes("workspace:"))continue;let i=JSON.parse(o),s=false;for(let l of ["dependencies","devDependencies","peerDependencies","optionalDependencies"]){let a=i[l];if(a)for(let[f,m]of Object.entries(a))typeof m=="string"&&m.startsWith("workspace:")&&(a[f]="*",s=true);}s&&await L.writeFile(n,JSON.stringify(i,null,2)+`
`);}}}function co({title:e,templateDir:t}){return async({projectPath:r,packageManager:n})=>{let o=E(`Creating a new ${e} project. This may take a few minutes.`).start();try{let i=process.env.SHADCN_TEMPLATE_DIR;if(i){let f=A__default.resolve(i,t);await L.copy(f,r,{filter:m=>!m.includes("node_modules")});}else {let f=A__default.join(hs.tmpdir(),`shadcn-template-${Date.now()}`);await execa("git",["clone","--depth","1","--filter=blob:none","--sparse",ys,f]),await execa("git",["-C",f,"sparse-checkout","set",`templates/${t}`]);let m=A__default.resolve(f,"templates",t);await L.move(m,r),await L.remove(f);}await bs(r,n);let l=["install",...ws(n)];await execa(n,l,{cwd:r});let a=A__default.join(r,"package.json");if(L.existsSync(a)){let f=await L.readFile(a,"utf8"),m=JSON.parse(f);m.name=A__default.basename(r),await L.writeFile(a,JSON.stringify(m,null,2)+`
`);}o?.succeed(`Creating a new ${e} project.`);}catch(i){o?.fail(`Something went wrong creating a new ${e} project.`),ma$1(i);}}}async function Cs({projectPath:e}){try{await execa("git",["init"],{cwd:e}),await execa("git",["add","-A"],{cwd:e}),await execa("git",["commit","-m","feat: initial commit"],{cwd:e});}catch{}}var lo={"--font-heading":"cn-font-heading"};function Rs(e){return e.startsWith("--")?e:`--${e}`}function Oe(e){let t=new Set;for(let r of e){for(let n of r.fonts??[]){let o=n.font?.variable;if(!o)continue;let i=lo[o];i&&t.add(i);}for(let n of Object.values(r.cssVars??{}))for(let o of Object.keys(n??{})){let i=lo[Rs(o)];i&&t.add(i);}}return Array.from(t)}function fo(e,t){if(e.includes("\0"))return  false;let r;try{r=e;let u="";for(;r!==u&&r.includes("%");)u=r,r=decodeURIComponent(r);}catch{return  false}let n=A__default.normalize(r.replace(/\\/g,"/")),o=A__default.normalize(t),i=u=>u.replace(/\[\.\.\..*?\]/g,"").includes("..");if(i(n)||i(r)||i(e))return  false;let s=u=>u.replace(/\[\.\.\..*?\]/g,""),l=s(e),a=s(r);if([/\.\.[\/\\]/,/[\/\\]\.\./,/\.\./,/\.\.%/,/\x00/,/[\x01-\x1f]/].some(u=>u.test(l)||u.test(a))||(e.includes("~")||r.includes("~"))&&(e.includes("../")||r.includes("../")))return  false;if(/^[a-zA-Z]:[\/\\]/.test(r))return process.platform==="win32"?r.toLowerCase().startsWith(t.toLowerCase()):false;if(A__default.isAbsolute(n))return n.startsWith(o+A__default.sep);let p=A__default.resolve(o,n);return p.startsWith(o+A__default.sep)||p===o}async function Ht(e,t,r){if(!t.resolvedPaths.tailwindCss||!Object.keys(e??{}).length)return;r={cleanupDefaultNextStyles:false,silent:false,tailwindVersion:"v3",overwriteCssVars:false,...r};let n=t.resolvedPaths.tailwindCss,o=A__default.relative(t.resolvedPaths.cwd,n),i=E(`Updating CSS variables in ${d.info(o)}`,{silent:r.silent}).start(),s=await promises.readFile(n,"utf8"),l=await ft(s,e??{},t,{cleanupDefaultNextStyles:r.cleanupDefaultNextStyles,tailwindVersion:r.tailwindVersion,tailwindConfig:r.tailwindConfig,overwriteCssVars:r.overwriteCssVars});await promises.writeFile(n,l,"utf8"),i.succeed();}async function ft(e,t,r,n={cleanupDefaultNextStyles:false,tailwindVersion:"v3",tailwindConfig:void 0,overwriteCssVars:false}){n={cleanupDefaultNextStyles:false,tailwindVersion:"v3",tailwindConfig:void 0,overwriteCssVars:false,...n};let o=[Ss(t)];n.cleanupDefaultNextStyles&&o.push(uo()),n.tailwindVersion==="v4"&&(o=[],o.push(js({params:"dark (&:is(.dark *))"})),n.cleanupDefaultNextStyles&&o.push(uo()),o.push(Ps(t,{overwriteCssVars:n.overwriteCssVars})),o.push($s(t)),n.tailwindConfig&&(o.push(Es(n.tailwindConfig)),o.push(Ts(n.tailwindConfig)),o.push(Fs(n.tailwindConfig))));let s=(await P$1(o).process(e,{from:void 0})).css;return s=s.replace(/\/\* ---break--- \*\//g,""),n.tailwindVersion==="v4"&&(s=s.replace(/(\n\s*\n)+/g,`

`)),s}function Ss(e){return {postcssPlugin:"update-css-vars",Once(t){let r=t.nodes.find(n=>n.type==="atrule"&&n.name==="layer"&&n.params==="base");r instanceof xs||(r=P$1.atRule({name:"layer",params:"base",nodes:[],raws:{semicolon:true,before:`
`,between:" "}}),t.append(r),t.insertBefore(r,P$1.comment({text:"---break---"}))),r!==void 0&&Object.entries(e).forEach(([n,o])=>{let i=n==="light"?":root":`.${n}`;Is(r,i,o);});}}}function po(e){let t=e.nodes.find(r=>r.type==="rule"&&r.selector===":root");if(t){let r=["--background","--foreground"];t.nodes.filter(n=>n.type==="decl"&&r.includes(n.prop)).forEach(n=>n.remove()),t.nodes.length===0&&t.remove();}}function uo(){return {postcssPlugin:"cleanup-default-next-styles",Once(e){let t=e.nodes.find(n=>n.type==="rule"&&n.selector==="body");t&&(t.nodes.find(n=>n.type==="decl"&&n.prop==="color"&&["rgb(var(--foreground-rgb))","var(--foreground)"].includes(n.value))?.remove(),t.nodes.find(n=>n.type==="decl"&&n.prop==="background"&&(n.value.startsWith("linear-gradient")||n.value==="var(--background)"))?.remove(),t.nodes.find(n=>n.type==="decl"&&n.prop==="font-family"&&n.value==="Arial, Helvetica, sans-serif")?.remove(),t.nodes.length===0&&t.remove()),po(e);let r=e.nodes.find(n=>n.type==="atrule"&&n.params==="(prefers-color-scheme: dark)");r&&(po(r),r.nodes.length===0&&r.remove());}}}function Is(e,t,r){let n=e.nodes?.find(o=>o.type==="rule"&&o.selector===t);n||Object.keys(r).length>0&&(n=P$1.rule({selector:t,raws:{between:" ",before:`
  `}}),e.append(n)),Object.entries(r).forEach(([o,i])=>{let s=`--${o.replace(/^--/,"")}`,l=P$1.decl({prop:s,value:i,raws:{semicolon:true}}),a=n?.nodes.find(f=>f.type==="decl"&&f.prop===s);a?a.replaceWith(l):n?.append(l);});}function Ps(e,t){return {postcssPlugin:"update-css-vars-v4",Once(r){Object.entries(e).forEach(([n,o])=>{let i=n==="light"?":root":`.${n}`;if(n==="theme"){i="@theme";let l=Gt(r);Object.entries(o).forEach(([a,f])=>{let m=`--${a.replace(/^--/,"")}`,p=P$1.decl({prop:m,value:f,raws:{semicolon:true}}),u=l?.nodes?.find(h=>h.type==="decl"&&h.prop===m);t.overwriteCssVars?u?u.replaceWith(p):l?.append(p):u||l?.append(p);});return}let s=r.nodes?.find(l=>l.type==="rule"&&l.selector===i);!s&&Object.keys(o).length>0&&(s=P$1.rule({selector:i,nodes:[],raws:{semicolon:true,between:" ",before:`
`}}),r.append(s),r.insertBefore(s,P$1.comment({text:"---break---"}))),Object.entries(o).forEach(([l,a])=>{let f=`--${l.replace(/^--/,"")}`;f==="--sidebar-background"&&(f="--sidebar"),go(a)&&(a=`hsl(${a})`);let m=P$1.decl({prop:f,value:a,raws:{semicolon:true}}),p=s?.nodes.find(u=>u.type==="decl"&&u.prop===f);t.overwriteCssVars?p?p.replaceWith(m):s?.append(m):p||s?.append(m);});});}}}function $s(e){return {postcssPlugin:"update-theme",Once(t){let r=Array.from(new Set(Object.keys(e).flatMap(i=>Object.keys(e[i]||{}))));if(!r.length)return;let n=Gt(t),o=n.nodes?.filter(i=>i.type==="decl"&&i.prop.startsWith("--"));for(let i of r){let s=Object.values(e).find(p=>p[i])?.[i];if(!s)continue;if(i==="radius"){let p={sm:"calc(var(--radius) * 0.6)",md:"calc(var(--radius) * 0.8)",lg:"var(--radius)",xl:"calc(var(--radius) * 1.4)","2xl":"calc(var(--radius) * 1.8)","3xl":"calc(var(--radius) * 2.2)","4xl":"calc(var(--radius) * 2.6)"};for(let[u,h]of Object.entries(p)){let g=P$1.decl({prop:`--radius-${u}`,value:h,raws:{semicolon:true}});n?.nodes?.find(y=>y.type==="decl"&&y.prop===g.prop)||n?.append(g);}continue}let l=go(s)||Ns(s)?`--color-${i.replace(/^--/,"")}`:`--${i.replace(/^--/,"")}`;l==="--color-sidebar-background"&&(l="--color-sidebar");let a=`var(--${i})`;l==="--color-sidebar"&&(a="var(--sidebar)");let f=P$1.decl({prop:l,value:a,raws:{semicolon:true}});n?.nodes?.find(p=>p.type==="decl"&&p.prop===f.prop)||(o?.length?n?.insertAfter(o[o.length-1],f):n?.append(f));}}}}function Gt(e){let t=e.nodes.find(r=>r.type==="atrule"&&r.name==="theme"&&r.params==="inline");return t||(t=P$1.atRule({name:"theme",params:"inline",nodes:[],raws:{semicolon:true,between:" ",before:`
`}}),e.append(t),e.insertBefore(t,P$1.comment({text:"---break---"}))),t}function js({params:e}){return {postcssPlugin:"add-custom-variant",Once(t){if(!t.nodes.find(n=>n.type==="atrule"&&n.name==="custom-variant")){let n=t.nodes.filter(i=>i.type==="atrule"&&i.name==="import"),o=P$1.atRule({name:"custom-variant",params:e,raws:{semicolon:true,before:`
`}});if(n.length>0){let i=n[n.length-1];t.insertAfter(i,o);}else t.insertAfter(t.nodes[0],o);t.insertBefore(o,P$1.comment({text:"---break---"}));}}}}function Es(e){return {postcssPlugin:"update-tailwind-config",Once(t){if(!e?.plugins)return;let n=As(t)==="single"?"'":'"',o=t.nodes.filter(s=>s.type==="atrule"&&s.name==="plugin"),i=o[o.length-1]||t.nodes[0];for(let s of e.plugins){let l=s.replace(/^require\(["']|["']\)$/g,"");if(o.some(f=>f.params.replace(/["']/g,"")===l))continue;let a=P$1.atRule({name:"plugin",params:`${n}${l}${n}`,raws:{semicolon:true,before:`
`}});t.insertAfter(i,a),t.insertBefore(a,P$1.comment({text:"---break---"}));}}}}function Fs(e){return {postcssPlugin:"update-tailwind-config-keyframes",Once(t){if(!e?.theme?.extend?.keyframes)return;let r=Gt(t),n=r.nodes?.filter(i=>i.type==="atrule"&&i.name==="keyframes"),o=z.record(z.string(),z.record(z.string(),z.string()));for(let[i,s]of Object.entries(e.theme.extend.keyframes)){if(typeof i!="string")continue;let l=o.safeParse(s);if(!l.success||n?.find(f=>f.type==="atrule"&&f.name==="keyframes"&&f.params===i))continue;let a=P$1.atRule({name:"keyframes",params:i,nodes:[],raws:{semicolon:true,between:" ",before:`
  `}});for(let[f,m]of Object.entries(l.data)){let p=P$1.rule({selector:f,nodes:Object.entries(m).map(([u,h])=>P$1.decl({prop:u,value:h,raws:{semicolon:true,before:`
    ...
    `}});a.append(p);}r.append(a),r.insertBefore(a,P$1.comment({text:"---break---"}));}}}}function Ts(e){return {postcssPlugin:"update-tailwind-config-animation",Once(t){if(!e?.theme?.extend?.animation)return;let r=Gt(t),n=r.nodes?.filter(i=>i.type==="decl"&&i.prop.startsWith("--animate-")),o=z.record(z.string(),z.string()).safeParse(e.theme.extend.animation);if(o.success)for(let[i,s]of Object.entries(o.data)){let l=`--animate-${i}`;if(n?.find(f=>f.prop===l))continue;let a=P$1.decl({prop:l,value:s,raws:{semicolon:true,between:": ",before:`
  `}});r.append(a);}}}}function As(e){return e.nodes[0].toString().includes("'")?"single":"double"}function go(e){if(e.startsWith("hsl")||e.startsWith("rgb")||e.startsWith("#")||e.startsWith("oklch"))return  false;let t=e.split(" ");return t.length===3&&t.slice(1,3).every(r=>r.includes("%"))}function Ns(e){return e.startsWith("hsl")||e.startsWith("rgb")||e.startsWith("#")||e.startsWith("oklch")||e.includes("--color-")}async function mt(e,t,r){let n=e&&Object.keys(e).length>0,o=Object.keys(r.cssVars??{}).length>0;if(!t.resolvedPaths.tailwindCss||!n&&!o)return;r={silent:false,...r};let i=t.resolvedPaths.tailwindCss,s=A__default.relative(t.resolvedPaths.cwd,i),l=E(`Updating ${d.info(s)}`,{silent:r.silent}).start(),a=await promises.readFile(i,"utf8");o&&(a=await ft(a,r.cssVars,t,{cleanupDefaultNextStyles:r.cleanupDefaultNextStyles,tailwindVersion:r.tailwindVersion,tailwindConfig:r.tailwindConfig,overwriteCssVars:r.overwriteCssVars})),n&&(a=await Fr(a,e)),await promises.writeFile(i,a,"utf8"),l.succeed();}async function Fr(e,t){let r=[Vs(t)],n=await P$1(r).process(e,{from:void 0}),o=n.css,i=n.root;if(i.nodes&&i.nodes.length>0){let s=i.nodes[i.nodes.length-1];s.type==="atrule"&&!s.nodes&&!o.trimEnd().endsWith(";")&&(o=o.trimEnd()+";");}return o=o.replace(/\/\* ---break--- \*\//g,""),o=o.replace(/(\n\s*\n)+/g,`

`),o=o.trimEnd(),o}function Vs(e){return {postcssPlugin:"update-css",Once(t){for(let[r,n]of Object.entries(e))if(r.startsWith("@")){let o=r.match(/@([a-zA-Z-]+)\s*(.*)/);if(!o)continue;let[,i,s]=o;if(i==="import"){if(!t.nodes?.find(a=>a.type==="atrule"&&a.name==="import"&&a.params===s)){let a=P$1.atRule({name:"import",params:s,raws:{semicolon:true}}),f=t.nodes?.filter(m=>m.type==="atrule"&&m.name==="import");if(f&&f.length>0){let m=f[f.length-1];a.raws.before=`
...
`}}),t.append(l),t.insertBefore(l,P$1.comment({text:"---break---"})));let a=l.nodes?.find(m=>m.type==="atrule"&&m.name==="keyframes"&&m.params===s),f;if(a?(f=P$1.atRule({name:"keyframes",params:s,raws:{semicolon:true,between:" ",before:`
  ...
  `}}),l.append(f)),typeof n=="object")for(let[m,p]of Object.entries(n))De(f,m,p);}else if(i==="utility"){let l=t.nodes?.find(a=>a.type==="atrule"&&a.name===i&&a.params===s);if(l){if(typeof n=="object")for(let[a,f]of Object.entries(n))if(typeof f=="string"){let m=l.nodes?.find(u=>u.type==="decl"&&u.prop===a),p=P$1.decl({prop:a,value:f,raws:{semicolon:true,before:`
    ...
    `}});l.append(g);}}}else typeof f=="object"&&De(l,a,f);}else {let a=P$1.atRule({name:i,params:s,raws:{semicolon:true,between:" ",before:`
`}});if(t.append(a),t.insertBefore(a,P$1.comment({text:"---break---"})),typeof n=="object")for(let[f,m]of Object.entries(n))if(typeof m=="string"){let p=P$1.decl({prop:f,value:m,raws:{semicolon:true,before:`
    ...
    `}});a.append(y);}}}else typeof m=="object"&&De(a,f,m);}}else i==="property"?De(t,r,n):yo(t,i,s,n);}else De(t,r,n);}}}function yo(e,t,r,n){let o=e.nodes?.find(i=>i.type==="atrule"&&i.name===t&&i.params===r);if(o||(o=P$1.atRule({name:t,params:r,raws:{semicolon:true,between:" ",before:`
`}}),e.append(o),e.insertBefore(o,P$1.comment({text:"---break---"}))),typeof n=="object")for(let[i,s]of Object.entries(n))if(i.startsWith("@")){let l=i.match(/@([a-zA-Z-]+)\s*(.*)/);if(l){let[,a,f]=l;yo(o,a,f,s);}}else De(o,i,s);else if(typeof n=="string")try{let s=P$1.parse(`.temp{${n}}`).first;if(s&&s.nodes){let l=P$1.rule({selector:"temp",raws:{semicolon:!0,between:" ",before:`
  `}});s.nodes.forEach(a=>{if(a.type==="decl"){let f=a.clone();f.raws.before=`
    `,l.append(f);}}),l.nodes?.length&&o.append(l);}}catch(i){throw console.error("Error parsing at-rule content:",n,i),i}}function De(e,t,r){let n=e.nodes?.find(o=>o.type==="rule"&&o.selector===t);if(n||(n=P$1.rule({selector:t,raws:{semicolon:true,between:" ",before:`
  `}}),e.append(n)),typeof r=="object"){for(let[o,i]of Object.entries(r))if(o.startsWith("@")&&typeof i=="object"&&i!==null&&Object.keys(i).length===0){let s=o.match(/@([a-zA-Z-]+)\s*(.*)/);if(s){let[,l,a]=s;if(!n.nodes?.find(m=>m.type==="atrule"&&m.name===l&&m.params===a)){if(l==="apply"){let p=n.nodes?.find(u=>u.type==="atrule"&&u.name==="apply");if(p){p.params=twMerge(p.params,a);continue}}let m=P$1.atRule({name:l,params:a,raws:{semicolon:true,before:`
    ...
    `}}),l=n.nodes?.find(a=>a.type==="decl"&&a.prop===o);l?l.replaceWith(s):n.append(s);}else if(typeof i=="object"){let s=o.startsWith("&")?t.replace(/^([^:]+)/,`$1${o.substring(1)}`):o;De(e,s,i);}}else if(typeof r=="string")try{let i=P$1.parse(`.temp{${r}}`).first;i&&i.nodes&&i.nodes.forEach(s=>{if(s.type==="decl"){let l=s.clone();l.raws.before=`
    `,n?.append(l);}});}catch(o){throw console.error("Error parsing rule content:",t,r,o),o}}async function _(e$1,t,r,n){if(e$1=Array.from(new Set(e$1)),t=Array.from(new Set(t)),!e$1?.length&&!t?.length)return;n={silent:false,...n};let o=E("Installing dependencies.",{silent:n.silent})?.start(),i=await Us(r),s="";if(_s(r)&&i==="npm")if(n.silent)s="force";else {o.stopAndPersist(),e.warn(`
It looks like you are using React 19. 
Some packages may fail to install due to peer dependency issues in npm (see ${a}/react-19).
`);let l=await Re([{type:"select",name:"flag",message:"How would you like to proceed?",choices:[{title:"Use --force",value:"force"},{title:"Use --legacy-peer-deps",value:"legacy-peer-deps"}]}]);l&&(s=l.flag);}o?.start(),await Ms(i,e$1,t,r.resolvedPaths.cwd,s),o?.succeed();}function _s(e){let t=y(e.resolvedPaths.cwd,false);if(!t?.dependencies?.react)return  false;let r=/^(?:\^|~)?19(?:\.\d+)*(?:-.*)?$/.test(t.dependencies.react),n=t.dependencies["react-day-picker"]?.startsWith("8");return r&&n}async function Us(e){return y(e.resolvedPaths.cwd,false)?.dependencies?.expo?"expo":ja(e.resolvedPaths.cwd)}async function Ms(e,t,r,n,o){if(e==="npm")return Ws(t,r,n,o);if(e==="deno")return Bs(t,r,n);if(e==="expo")return zs(t,r,n);t?.length&&await execa(e,["add",...t],{cwd:n}),r?.length&&await execa(e,["add","-D",...r],{cwd:n});}async function Ws(e,t,r,n){e.length&&await execa("npm",["install",...n?[`--${n}`]:[],...e],{cwd:r}),t.length&&await execa("npm",["install",...n?[`--${n}`]:[],"-D",...t],{cwd:r});}async function Bs(e,t,r){e?.length&&await execa("deno",["add",...e.map(n=>`npm:${n}`)],{cwd:r}),t?.length&&await execa("deno",["add","-D",...t.map(n=>`npm:${n}`)],{cwd:r});}async function zs(e,t,r){e.length&&await execa("npx",["expo","install",...e],{cwd:r}),t.length&&await execa("npx",["expo","install","-- -D",...t],{cwd:r});}async function Ar(e$1,t,r){if(!e$1||Object.keys(e$1).length===0)return {envVarsAdded:[],envFileUpdated:null,envFileCreated:null};r={silent:false,...r};let n=E("Adding environment variables.",{silent:r.silent})?.start(),o=t.resolvedPaths.cwd,i=A__default.join(o,".env.local"),s=B(o);s&&(i=s);let l=existsSync(i),a=A__default.basename(i),f=Object.entries(e$1).map(([h,g])=>`${h}=${g}`).join(`
...
`,"utf-8"),u=A__default.relative(o,i),m=Object.keys(e$1),n?.succeed(`Added the following variables to ${d.info(a)}:`),!r.silent)for(let h of m)e.log(`  ${d.success("+")} ${h}`);return !r.silent&&m.length>0&&e.break(),{envVarsAdded:m,envFileUpdated:p,envFileCreated:u}}var Zs=new Set(["--font-sans","--font-serif","--font-mono"]);async function ut(e,t){if(!e.fonts?.length)return e;let r=await Da(t.resolvedPaths.cwd);if(!r)return e;e.cssVars??={},e.cssVars.theme??={};let n=r.framework.name==="next-app"||r.framework.name==="next-pages";for(let o of e.fonts)if(n)e.cssVars.theme[o.font.variable]=`var(${o.font.variable})`;else {let i=o.name.replace("font-",""),s=o.font.dependency??`@fontsource-variable/${i}`;e.dependencies??=[],e.dependencies.push(s),e.css??={},e.css[`@import "${s}"`]={},e.cssVars.theme[o.font.variable]=o.font.family;}if(e.fonts.length>0){let o=new Map;for(let i of e.fonts){let s=i.font.selector??ra(i.font.variable);if(!s)continue;let l=i.font.variable.replace("--","");o.has(s)||o.set(s,[]),o.get(s).push(l);}e.css??={},e.css["@layer base"]??={};for(let[i,s]of Array.from(o.entries())){let l=s.join(" ");e.css["@layer base"][i]??={};let a=Object.keys(e.css["@layer base"][i]).find(f=>f.startsWith("@apply "));a?(delete e.css["@layer base"][i][a],e.css["@layer base"][i][`${a} ${l}`]={}):e.css["@layer base"][i][`@apply ${l}`]={};}}return e}async function dt(e,t,r){if(!e?.length)return;let n=await Da(t.resolvedPaths.cwd);if(!n||n.framework.name!=="next-app"&&n.framework.name!=="next-pages")return;let o=E("Updating fonts.",{silent:r.silent})?.start();try{await Xs(e,t,n),o?.succeed("Updating fonts.");}catch(i){throw o?.fail("Failed to update fonts."),i}}async function Xs(e,t,r){let n=await Qs(t,r);if(!n)return;let o=await promises.readFile(n,"utf-8"),i=await ea(o,e,t);i!==o&&await promises.writeFile(n,i,"utf-8");}async function Qs(e,t){let r=e.resolvedPaths.cwd,n=t.isSrcDir,i=t.isTsx?"tsx":"jsx",s=n?[`src/app/layout.${i}`,`app/layout.${i}`]:[`app/layout.${i}`];for(let l of s){let a=A__default.join(r,l);if(existsSync(a))return a}return null}async function ea(e,t,r){let o=new Project({compilerOptions:{}}).createSourceFile("layout.tsx",e,{scriptKind:ScriptKind.TSX}),i=t.filter(p=>p.font.provider==="google"),s=[],l=[];for(let p of i){let u=p.font.import;if(!u)continue;let h=o.getImportDeclaration(x=>x.getModuleSpecifierValue()==="next/font/google"),g=false;h?(g=h.getNamedImports().some(R=>R.getName()===u),g||h.addNamedImport(u)):o.addImportDeclaration({moduleSpecifier:"next/font/google",namedImports:[u]});let y=oa(u,p.font.variable),k=ta(p),C=aa(o,p.font.variable),I=y;if(!(g&&!C&&Yt(p.font.variable)&&!ca(o,u))){if(C)C.setInitializer(`${u}(${k})`),C.getName()!==y&&C.rename(y),I=y;else {let x=la(o);o.insertVariableStatement(x,{declarationKind:VariableDeclarationKind.Const,declarations:[{name:y,initializer:`${u}(${k})`}]}).appendWhitespace(`
...
`}],monorepo:{templateDir:"astro-monorepo",init:Ce,files:[{type:"registry:page",path:"src/pages/index.astro",target:"src/pages/index.astro",content:Ro`---
...
`}]}});var xo=X({name:"laravel",title:"Laravel",description:"Requires `laravel new`",defaultProjectName:"laravel-app",templateDir:"laravel-app",frameworks:["laravel"],scaffold:async()=>{e.break(),e.log(`  Please create a new app with ${d.info("laravel new --react")} first then run ${d.info("shadcn init")}.`),e.log(`  See ${d.info(`${a}/docs/installation/laravel`)} for more information.`),e.break(),process.exit(0);},create:async()=>{}});var Po=X({name:"next",title:"Next.js",defaultProjectName:"next-app",templateDir:"next-app",frameworks:["next-app","next-pages"],create:async()=>{},files:[{type:"registry:page",path:"app/page.tsx",target:"app/page.tsx",content:Ro`import { ComponentExample } from "@/components/component-example";

export default function Page() {
  return <ComponentExample />;
}
`}],monorepo:{templateDir:"next-monorepo",init:async e=>{let t=A__default.resolve(e.projectPath,"packages/ui"),r=A__default.resolve(e.projectPath,"apps/web"),n=A__default.resolve(t,"components.json"),o=await L.readJson(n);e.registryBaseConfig&&(o=Co(o,e.registryBaseConfig)),o.tailwind.baseColor="neutral",e.rtl&&(o.rtl=true),await L.writeJson(n,o,{spaces:2});let i=A__default.resolve(r,"components.json"),s=await L.readJson(i);e.registryBaseConfig&&(s=Co(s,e.registryBaseConfig)),s.tailwind.baseColor="neutral",e.rtl&&(s.rtl=true),await L.writeJson(i,s,{spaces:2});let l=await Y(t,c.parse(o)),{config:a}=await H(e.components,l,{silent:true});await pe(e.components,a,{overwrite:true,silent:e.silent,isNewProject:true,skipFonts:true});let f=await Y(r,c.parse(s)),m=await ia$1(e.components,ca$1(a));if(m?.fonts?.length){let u={};for(let h of m.fonts)u[h.font.variable]=`var(${h.font.variable})`;await Ht({theme:u},l,{silent:e.silent,overwriteCssVars:false,tailwindVersion:"v4"}),await dt(m.fonts,f,{silent:e.silent});}let p=l.iconLibrary;if(p&&p in a$3){let u=[...a$3[p].packages];await _(u,[],l,{silent:true}),await _(u,[],f,{silent:true});}return f},files:[{type:"registry:page",path:"app/page.tsx",target:"app/page.tsx",content:Ro`import { ComponentExample } from "@/components/component-example";

export default function Page() {
  return <ComponentExample />;
}
`}]}});var jo=X({name:"react-router",title:"React Router",defaultProjectName:"react-router-app",templateDir:"react-router-app",frameworks:["react-router"],create:async()=>{},files:[{type:"registry:file",path:"app/routes/home.tsx",target:"app/routes/home.tsx",content:Ro`import { ComponentExample } from "@/components/component-example";

export default function Home() {
  return <ComponentExample />;
}
`}],monorepo:{templateDir:"react-router-monorepo",init:Ce,files:[{type:"registry:file",path:"app/routes/home.tsx",target:"app/routes/home.tsx",content:Ro`import { ComponentExample } from "@/components/component-example";

export default function Home() {
  return <ComponentExample />;
}
`}]}});var Fo=X({name:"start",title:"TanStack Start",defaultProjectName:"start-app",templateDir:"start-app",frameworks:["tanstack-start"],create:async()=>{},files:[{type:"registry:file",path:"src/routes/index.tsx",target:"src/routes/index.tsx",content:Ro`import { createFileRoute } from "@tanstack/react-router";
import { ComponentExample } from "@/components/component-example";
...
`}],monorepo:{templateDir:"start-monorepo",init:Ce,files:[{type:"registry:file",path:"src/routes/index.tsx",target:"src/routes/index.tsx",content:Ro`import { createFileRoute } from "@tanstack/react-router";
import { ComponentExample } from "@/components/component-example";
...
`}]}});var Ao=X({name:"vite",title:"Vite",defaultProjectName:"vite-app",templateDir:"vite-app",frameworks:["vite"],create:async()=>{},files:[{type:"registry:file",path:"src/App.tsx",target:"src/App.tsx",content:Ro`import { ComponentExample } from "@/components/component-example";
...
export default App;
`}],monorepo:{templateDir:"vite-monorepo",init:Ce,files:[{type:"registry:file",path:"src/App.tsx",target:"src/App.tsx",content:Ro`import { ComponentExample } from "@/components/component-example";
...
export default App;
`}]}});var Q={next:Po,vite:Ao,start:Fo,"react-router":jo,astro:vo,laravel:xo};function Xe(e){if(e){for(let[t,r]of Object.entries(Q))if(r.frameworks.includes(e))return t}}function Oo(e,t){let r=t?.lib??er(e,"lib");return {ui:t?.ui??er(e,"ui"),lib:r,hooks:t?.hooks??er(e,"hooks"),utils:t?.utils??er(e,"utils",r)}}function er(e,t,r){let n=e||S;if(t==="ui")return `${n}/ui`;if(t==="utils"){let o=r||No(n,"lib");return o?`${o}/utils`:T}return No(n,t)}function No(e,t){return e==="components"?t:e.endsWith("/components")?`${e.slice(0,-11)}/${t}`:e.endsWith("components")&&!e.includes("/")?`${e.slice(0,-10)}${t}`:""}async function tr(e$1){let t=e$1.template&&e$1.template in Q?e$1.template:"next",r=Ne(Q[t],{monorepo:e$1.monorepo}),n=e$1.name??r.defaultProjectName,o=e$1.components?.length===1&&!!e$1.components[0].match(/\/chat\/b\//);if(o&&(t="next"),!e$1.force){let{type:a,name:f}=await Re([{type:e$1.template||o?null:"select",name:"type",message:`The path ${d.info(e$1.cwd)} does not contain a package.json file.
  Would you like to start a new project?`,choices:Object.entries(Q).map(([m,p])=>({title:p.title,value:m,description:p.description})),initial:0},{type:e$1.name?null:"text",name:"name",message:"What is your project named?",initial:n,format:m=>m.trim(),validate:m=>m.length>128?"Name should be less than 128 characters.":true}]);t=a??t,n=f??n;}let i=Ne(Q[t],{monorepo:e$1.monorepo}),s=await ja(e$1.cwd,{withFallback:true}),l=A__default.join(e$1.cwd,n);try{await L.access(e$1.cwd,L.constants.W_OK);}catch{e.break(),e.error(`The path ${d.info(e$1.cwd)} is not writable.`),e.error(`It is likely you do not have write permissions for this folder or the path ${d.info(e$1.cwd)} does not exist.`),e.break(),process.exit(1);}return L.existsSync(A__default.resolve(e$1.cwd,n,"package.json"))&&(e.break(),e.error(`A project with the name ${d.info(n)} already exists.`),e.error("Please choose a different name and try again."),e.break(),process.exit(1)),await i.scaffold({projectPath:l,packageManager:s,cwd:e$1.cwd}),{projectPath:l,projectName:n,template:t}}async function ee(e$1=process.cwd()){try{let{config:t}=await import('@dotenvx/dotenvx'),r=[".env.local",".env.development.local",".env.development",".env"];for(let n of r){let o=join(e$1,n);existsSync(o)&&t({path:o,overload:!1,quiet:!0});}}catch(t){e.warn("Failed to load env files:",t);}}var tt=".bak",Qe=class extends Error{filePath;constructor(t){super(`Could not back up ${t}.`),this.name="FileBackupError",this.filePath=t;}};function gt(e){if(!L.existsSync(e))return null;let t=`${e}${tt}`;try{return L.renameSync(e,t),t}catch{return null}}function et(e){let t=`${e}${tt}`;if(!L.existsSync(t))return  false;try{return L.renameSync(t,e),!0}catch(r){return console.error(`Warning: Could not restore backup file ${t}: ${r}`),false}}function ht(e){let t=`${e}${tt}`;if(!L.existsSync(t))return  false;try{return L.unlinkSync(t),!0}catch{return  false}}async function Vo(e,t){if(!L.existsSync(e))return t();if(!gt(e))throw new Qe(e);let n=()=>et(e);process.on("exit",n);try{let o=await t();return process.removeListener("exit",n),ht(e),o}catch(o){throw process.removeListener("exit",n),et(e),o}}var xa=z.object({cwd:z.string(),name:z.string().optional(),preset:z.union([z.boolean(),z.string()]).optional(),components:z.array(z.string()).optional(),yes:z.boolean(),defaults:z.boolean(),force:z.boolean(),reinstall:z.boolean().optional(),silent:z.boolean(),isNewProject:z.boolean().default(false),cssVariables:z.boolean().default(true),rtl:z.boolean().optional(),pointer:z.boolean().optional(),base:z.enum(["radix","base"]).optional(),template:z.string().optional(),monorepo:z.boolean().optional(),existingConfig:z.record(z.unknown()).optional(),installStyleIndex:z.boolean().default(true),registryBaseConfig:c.deepPartial().optional(),menuColor:z.enum(["default","inverted","default-translucent","inverted-translucent"]).optional(),menuAccent:z.enum(["subtle","bold"]).optional(),iconLibrary:z.string().optional()});function Sa(e,t){return t.rtl?e.searchParams.set("rtl","true"):t.rtl===false&&e.searchParams.delete("rtl"),t.pointer?e.searchParams.set("pointer","true"):t.pointer===false&&e.searchParams.delete("pointer"),e}var Lo=new Command().name("init").alias("create").description("initialize your project and install dependencies").argument("[components...]","names, url or local path to component").option("-t, --template <template>","the template to use. (next, start, vite, react-router, laravel, astro)").option("-b, --base <base>","the component library to use. (radix, base)").option("--monorepo","scaffold a monorepo project.").option("--no-monorepo","skip the monorepo prompt.").option("-p, --preset [name]","use a preset configuration").option("-y, --yes","skip confirmation prompt.",true).option("-d, --defaults","use default configuration: --template=next --preset=base-nova",false).option("-f, --force","force overwrite of existing configuration.",false).option("-c, --cwd <cwd>","the working directory. defaults to the current directory.",process.cwd()).option("-n, --name <name>","the name for the new project.").option("-s, --silent","mute output.",false).option("--css-variables","use css variables for theming.",true).option("--no-css-variables","do not use css variables for theming.").option("--rtl","enable RTL support.").option("--no-rtl","disable RTL support.").option("--pointer","enable pointer cursor for buttons.").option("--no-pointer","disable pointer cursor for buttons.").option("--reinstall","re-install existing UI components.").option("--no-reinstall","do not re-install existing UI components.").action(async(e$1,t)=>{let r$1,n=[],o=()=>{r$1&&et(r$1.replace(tt,""));};process.on("exit",o);try{let i=xa.parse({...t,reinstall:t.reinstall,cwd:A__default.resolve(t.cwd)}),s=new Map(Object.entries(Z)),l;if(i.defaults&&(i.template=i.template||"next",i.base=i.base||"base",i.reinstall=i.reinstall??!1),i.template&&!(i.template in Q)&&(e.error(`Invalid template: ${d.info(i.template)}. Available templates: ${Object.keys(Q).map(u=>d.info(u)).join(", ")}.`),e.break(),process.exit(1)),typeof i.preset=="string"&&!Q$1(i.preset)&&!r(i.preset)){let u=Array.from(s.keys());s.has(i.preset)||(e.error(`Invalid preset: ${d.info(i.preset)}. Available presets: ${u.join(", ")}`),e.break(),process.exit(1));}let a$1=i.cwd,f$1=L.existsSync(A__default.resolve(a$1,"components.json"));if(!i.monorepo&&!f$1&&await f(a$1)){let u=await Da(a$1);if(!u||u.framework.name==="manual"){let h$1=await g(a$1);h$1.length>0&&(h("init",h$1),process.exit(1));}}if(f$1&&!i.force){let{overwrite:u}=await Re({type:"confirm",name:"overwrite",message:`A ${d.info("components.json")} file already exists. Would you like to overwrite it?`,initial:!1});u||(e.info(`  To start over, remove the ${d.info("components.json")} file and run ${d.info("init")} again.`),e.break(),process.exit(1)),i.force=!0;}let m;if(f$1){try{m=await L.readJson(A__default.resolve(a$1,"components.json"));}catch{}m&&(i.existingConfig=m);let u=i.reinstall;if(u===void 0){let{reinstall:h}=await Re({type:"confirm",name:"reinstall",message:"Would you like to re-install existing UI components?",initial:!1});u=h;}if(u&&(n=await Ga$1(a$1),n.length)){e.break(),e.log("  The following components will be re-installed and overwritten:");for(let h=0;h<n.length;h+=8)e.log(`  - ${n.slice(h,h+8).join(", ")}`);e.break();}}if(i.preset===void 0&&e$1.length===0&&!i.defaults){let u=L.existsSync(A__default.resolve(a$1,"package.json"));if(!i.template&&!u){let{template:h}=await Re({type:"select",name:"template",message:"Select a template",choices:Object.entries(Q).map(([g,y])=>({title:y.title,value:g,description:y.description,disabled:i.monorepo&&g==="laravel"}))});h||process.exit(1),i.template=h;}if(!i.template&&u){let h=await Da(a$1),g=Xe(h?.framework.name);g&&(i.template=g);}if(i.template==="laravel"&&!u&&(e.break(),e.log(`  Please create a new app with ${d.info("laravel new --react")} first then run ${d.info("shadcn init")}.`),e.log(`  See ${d.info(`${a}/docs/installation/laravel`)} for more information.`),e.break(),process.exit(0)),i.monorepo===void 0&&!u&&i.template&&Q[i.template]?.monorepo){let{monorepo:h}=await Re({type:"confirm",name:"monorepo",message:"Would you like to set up a monorepo?",initial:!1});i.monorepo=h;}i.base||(i.base=await qe()),i.preset=!0;}if(i.preset!==void 0){let u=i.preset===!0?!0:i.preset;if(u===!0){let h=await lt({rtl:i.rtl??!1,template:i.template,base:i.base,pointer:i.pointer});e$1=[h.url,...e$1],l=h.base;}if(typeof u=="string"){let h;if(Q$1(u)){let g=new URL(u);Sa(g,i),g.pathname==="/init"&&u.startsWith(a)&&g.searchParams.set("track","1"),h=g.toString(),l=g.searchParams.get("base")??void 0;}else if(r(u)){let g=q(u);g||(e.error(`Invalid preset code: ${d.info(u)}`),e.break(),process.exit(1)),h=he({...g,base:"radix",rtl:i.rtl??!1},{template:i.template,preset:u,pointer:i.pointer}),l=void 0;}else {let g=s.get(u);if(!g)throw new Error(`Unknown preset: ${u}`);h=he({...g,base:i.base??"radix",rtl:i.rtl??g.rtl},{template:i.template,pointer:i.pointer}),l=void 0;}e$1=[h,...e$1];}}let p=i.base??l??(m?.style?m.style.startsWith("base-")?"base":"radix":"");if(!p)if(e$1.length>0)p="radix";else {let u=await qe();p=u,i.base=u;}if(i.defaults&&!e$1.some(Q$1)&&(e$1=[he({...Z.nova,base:p,rtl:i.rtl??!1},{template:i.template,pointer:i.pointer}),...e$1]),e$1.length>0&&Q$1(e$1[0])){let u=new URL(e$1[0]);u.searchParams.set("base",p),e$1[0]=u.toString();}if(m?.style){let u=await $a(m.style,p);if(u!==p&&(p=u,e$1.length>0&&Q$1(e$1[0]))){let h=new URL(e$1[0]);h.searchParams.set("base",u),e$1[0]=h.toString();}}if(n.length&&(e$1=[...e$1,...n]),i.components=e$1,await ee(i.cwd),e$1.length>0){let u=A__default.resolve(a$1,"components.json");f$1&&(r$1=gt(u)??void 0,r$1||e.warn(`Could not back up ${d.info("components.json")}.`));let{registryBaseConfig:h,installStyleIndex:g,url:y}=await Te(e$1[0],a$1,{registries:m?.registries});e$1[0]=y,g||(i.installStyleIndex=!1),h&&(i.registryBaseConfig=h);}await rt(i),e.break(),e.log(`Project initialization completed.
You may now add components.`),process.removeListener("exit",o),ht(A__default.resolve(a$1,"components.json")),e.break();}catch(i){process.removeListener("exit",o),o(),e.break(),ma$1(i);}finally{da$1();}});async function rt(e){let t,r,n,o=e.template,i=o?Ne(Q[o],{monorepo:e.monorepo}):void 0;if(e.monorepo&&i?.init&&L.existsSync(A__default.resolve(e.cwd,"package.json")))t=await Da(e.cwd);else if(e.skipPreflight)t=await Da(e.cwd);else {let R=await io(e);if(R.errors["1"]){let{projectPath:$,template:U}=await tr(e);$||process.exit(1),e.cwd=$,e.isNewProject=true,n=U,t=await Da(e.cwd);}else t=R.projectInfo;}r=await Ea(e.cwd,t);let l=n??o,a=l?Ne(Q[l],{monorepo:e.monorepo}):void 0,f=[...e.installStyleIndex?["index"]:[],...e.components??[],...a?["button"]:[]],m=n?a?.postInit:void 0;if(a?.init){let R=await a.init({projectPath:e.cwd,components:f,registryBaseConfig:e.registryBaseConfig,rtl:e.rtl??false,menuColor:e.menuColor,menuAccent:e.menuAccent,iconLibrary:e.iconLibrary,silent:e.silent});return m&&await m({projectPath:e.cwd}),R}let p=r?await Pa(r,e):await Ia(await X$1(e.cwd));if(!e.yes){let{proceed:R}=await Re({type:"confirm",name:"proceed",message:`Write configuration to ${d.info("components.json")}. Proceed?`,initial:true});R||process.exit(1);}let u=await Y(e.cwd,p),{config:h}=await H(f,u,{silent:true});h.registries&&(p.registries=h.registries);let g=E("Writing components.json.").start(),y=A__default.resolve(e.cwd,"components.json"),k=`${y}${tt}`,C=(R,$)=>{let{registries:U,...Y}=Co(R,$);return {...Y,registries:U}};if(L.existsSync(k)){let R=await L.readJson(k);e.force?R.registries&&(p.registries={...R.registries,...p.registries||{}}):p=C(R,p);}e.registryBaseConfig&&(p=C(p,e.registryBaseConfig)),e.rtl!==void 0&&(p.rtl=e.rtl),p.registries=Object.fromEntries(Object.entries(p.registries||{}).filter(([R])=>!Object.keys(b).includes(R))),await promises.writeFile(y,`${JSON.stringify(p,null,2)}
`,"utf8"),g.succeed();let I=await Y(e.cwd,p),x=await Z$1(I);if(x){let R={};if(p.menuColor&&(R.menuColor=p.menuColor),p.menuAccent&&(R.menuAccent=p.menuAccent),p.rtl!==void 0&&(R.rtl=p.rtl),p.iconLibrary&&(R.iconLibrary=p.iconLibrary),Object.keys(R).length>0)for(let $ of Object.keys(x)){let U=x[$];if(U.resolvedPaths.cwd===I.resolvedPaths.cwd)continue;let Y=A__default.resolve(U.resolvedPaths.cwd,"components.json");if(L.existsSync(Y)){let $e=await L.readJson(Y);await L.writeJson(Y,{...$e,...R},{spaces:2});}}}return W.clearCaches(),await pe(f,I,{overwrite:true,overwriteCssVars:e.reinstall||void 0,silent:e.silent,isNewProject:e.isNewProject||t?.framework.name==="next-app"}),m&&await m({projectPath:e.cwd}),I}async function Ia(e$1=null){let[t,r]=await Promise.all([sa$1(),ua$1()]);e.info("");let n=await Re([{type:"toggle",name:"typescript",message:`Would you like to use ${d.info("TypeScript")} (recommended)?`,initial:e$1?.tsx??true,active:"yes",inactive:"no"},{type:"select",name:"style",message:`Which ${d.info("style")} would you like to use?`,choices:t.map(s=>({title:s.label,value:s.name}))},{type:"select",name:"tailwindBaseColor",message:`Which color would you like to use as the ${d.info("base color")}?`,choices:r.map(s=>({title:s.label,value:s.name}))},{type:"text",name:"tailwindCss",message:`Where is your ${d.info("global CSS")} file?`,initial:e$1?.tailwind.css??U},{type:"toggle",name:"tailwindCssVariables",message:`Would you like to use ${d.info("CSS variables")} for theming?`,initial:e$1?.tailwind.cssVariables??true,active:"yes",inactive:"no"},{type:"text",name:"tailwindPrefix",message:`Are you using a custom ${d.info("tailwind prefix eg. tw-")}? (Leave blank if not)`,initial:""},{type:"text",name:"tailwindConfig",message:`Where is your ${d.info("tailwind.config.js")} located?`,initial:e$1?.tailwind.config??V},{type:"text",name:"components",message:`Configure the import alias for ${d.info("components")}:`,initial:e$1?.aliases.components??S},{type:"toggle",name:"rsc",message:`Are you using ${d.info("React Server Components")}?`,initial:e$1?.rsc??true,active:"yes",inactive:"no"}]);n.style||process.exit(1);let o=e$1&&e$1.aliases.components===n.components?e$1.aliases:void 0,i=Oo(n.components,o);return c.parse({$schema:"https://ui.shadcn.com/schema.json",style:n.style,tailwind:{config:n.tailwindConfig,css:n.tailwindCss,baseColor:n.tailwindBaseColor,cssVariables:n.tailwindCssVariables,prefix:n.tailwindPrefix},rsc:n.rsc,tsx:n.typescript,aliases:{components:n.components,ui:i.ui,lib:i.lib,hooks:i.hooks,utils:i.utils}})}async function Pa(e,t){let r=e.style,n="neutral",o=e.tailwind.cssVariables,i=e.iconLibrary??"lucide";if(!t.defaults){let[s,l]=await Promise.all([sa$1(),Fa$1(e)]);r=(await Re([{type:l==="v4"||r?null:"select",name:"style",message:`Which ${d.info("style")} would you like to use?`,choices:s.map(f=>({title:f.name==="new-york"?"New York (Recommended)":f.label,value:f.name})),initial:0}])).style??r??"new-york";}return o=t.cssVariables,c.parse({$schema:e?.$schema,style:r,tailwind:{...e?.tailwind,baseColor:n,cssVariables:o},rsc:e?.rsc,tsx:e?.tsx,iconLibrary:i,rtl:t.rtl??e?.rtl??false,aliases:e?.aliases})}async function $a(e$1,t){let r=e$1.startsWith("base-")?"base":"radix";if(t===r)return t;e.warn(`  You are switching from ${d.info(r)} to ${d.info(t)}.`),e.warn(`  Components outside the ${d.info("ui")} directory that depend on ${d.info(r)} primitives may need manual updates.`),e.break();let{proceed:n}=await Re({type:"confirm",name:"proceed",message:"Would you like to continue?",initial:false});return n?t:r}async function Uo(e$1){let t={};if(!L.existsSync(e$1.cwd)||!L.existsSync(A__default.resolve(e$1.cwd,"package.json")))return t["1"]=true,{errors:t,config:null};if(!L.existsSync(A__default.resolve(e$1.cwd,"components.json"))){if(await f(e$1.cwd)){let r=await g(e$1.cwd);r.length>0&&(h("add [component]",r),process.exit(1));}return t["3"]=true,{errors:t,config:null}}try{let r=await X$1(e$1.cwd);return {errors:t,config:r}}catch{e.break(),e.error(`An invalid ${d.info("components.json")} file was found at ${d.info(e$1.cwd)}.
Before you can add components, you must create a valid ${d.info("components.json")} file by running the ${d.info("init")} command.`),e.error(`Learn more at ${d.info(`${a}/docs/components-json`)}.`),e.break(),process.exit(1);}}async function Wo(e,t,r={}){let n={files:[],dependencies:[],devDependencies:[],css:null,envVars:null,fonts:[],docs:null};if(!e.length)return n;let o=await ia$1(e,ca$1(t));if(!o)throw new Error("Failed to fetch components from registry.");r.skipFonts||(o=await ut(o,t));let i=Oe([o]);return n.dependencies=Array.from(new Set(o.dependencies??[])),n.devDependencies=Array.from(new Set(o.devDependencies??[])),n.docs=o.docs??null,await Fa(o,t,n,r,i),await Ta(o,t,n,r),Aa(o,t,n),r.skipFonts||Na(o,n),n}async function Fa(e,t,r,n,o){let i=e.files;if(!i?.length)return;let[s,l]=await Promise.all([Da(t.resolvedPaths.cwd),t.tailwind.baseColor?va(t.tailwind.baseColor):Promise.resolve(void 0)]),a;try{a=loadConfig(t.resolvedPaths.cwd);}catch{a={resultType:"failed"};}let f=new Project({compilerOptions:{}}),m=O(i,t,{isSrcDir:s?.isSrcDir,framework:s?.framework.name});for(let p=0;p<i.length;p++){let u=i[p];if(!u.content)continue;let h=M(u,t,{isSrcDir:s?.isSrcDir,framework:s?.framework.name,commonRoot:N$1(i.map($=>$.path),u.path),fileIndex:p});if(!h)continue;t.tsx||(h=h.replace(/\.tsx?$/,$=>$===".tsx"?".jsx":".js"));let g=existsSync(h),y=A__default.relative(t.resolvedPaths.cwd,h),k=u.type==="registry:file"||u.type==="registry:item",C=A$1(h)||k?u.content:await J({filename:u.path,raw:u.content,config:t,baseColor:l,transformJsx:!t.tsx,isRemote:false,supportedFontMarkers:o},[F,G,a$1,I,c$2,g$1,K,d$1,f$1,H$1]),I$1=A$1(h)||k?C:await P({config:t,content:C,filePaths:m,project:f,projectInfo:s,resolvedPath:h,tsConfig:a}),x="create",R;g&&(R=await promises.readFile(h,"utf-8"),z$1(R,I$1)?x="skip":x="overwrite"),r.files.push({path:y,action:x,content:I$1,...x==="overwrite"&&{existingContent:R},type:u.type??"registry:ui"});}}async function Ta(e,t,r,n){let o=e.css&&Object.keys(e.css).length>0,i=Object.keys(e.cssVars??{}).length>0;if(!t.resolvedPaths.tailwindCss||!o&&!i)return;let s=t.resolvedPaths.tailwindCss,l=existsSync(s),a=A__default.relative(t.resolvedPaths.cwd,s),f=l?await promises.readFile(s,"utf8"):"",m=f;i&&(m=await ft(m,e.cssVars,t,{overwriteCssVars:n.overwriteCssVars})),o&&(m=await Fr(m,e.css));let p=0;if(e.cssVars)for(let u of Object.values(e.cssVars))u&&(p+=Object.keys(u).length);r.css={path:a,content:m,...l&&{existingContent:f},action:l?"update":"create",cssVarsCount:p};}function Aa(e,t,r){if(!e.envVars||Object.keys(e.envVars).length===0)return;let n=A__default.join(t.resolvedPaths.cwd,".env.local"),o=existsSync(n),i=A__default.relative(t.resolvedPaths.cwd,n);r.envVars={path:i,variables:e.envVars,action:o?"update":"create"};}function Na(e,t){if(e.fonts?.length)for(let r of e.fonts)t.fonts.push({name:r.font.family,provider:r.font.provider==="google"?"Google Fonts":r.font.provider});}var ve=5,Va=dim("\u250C"+"\u2500".repeat(46)),La=dim("\u2514"+"\u2500".repeat(46)),_a={create:"+",overwrite:"~",skip:"="},Ua={create:"create",overwrite:"overwrite",skip:"skip (identical)"};function yt(e){return e==="create"?green(e):e==="overwrite"||e==="update"?yellow(e):dim(e)}function wt(e){return `${bold("\u250C")} ${bold(`shadcn add ${e.join(", ")}`)} ${dim("(dry run)")}`}function Jo(e,t){return e===t||e.includes(t)||e.endsWith(t)}function Le(e,t,r=n=>n){e.push(`${dim("\u2502")} ${Va}`);for(let n of t)e.push(`${dim("\u2502")} ${dim("\u2502")} ${r(n)}`);e.push(`${dim("\u2502")} ${La}`);}function Ho(e,t,r={}){return r.diff?typeof r.diff=="string"?Wa(e,t,r.diff):Ba(e,t):r.view?typeof r.view=="string"?Ja(e,t,r.view):za(e,t):Ma(e,t)}function Ma(e,t){let r=[];r.push(wt(t)),r.push(dim("\u2502")),Ha(e,r),Bo("Dependencies",e.dependencies,r),Bo("Dev Dependencies",e.devDependencies,r),Ga(e,r),Ka(e,r),Ya(e,r);let n=e.files.filter(i=>i.action==="overwrite").length;n>0&&(r.push(yellow(`\u26A0 ${n} ${n===1?"file":"files"} will be overwritten.`)),r.push(dim("\u2502")));let o=[];return e.files.length>0&&o.push(`${e.files.length} ${e.files.length===1?"file":"files"}`),e.dependencies.length>0&&o.push(`${e.dependencies.length} ${e.dependencies.length===1?"dep":"deps"}`),e.css?.cssVarsCount&&o.push(`${e.css.cssVarsCount} CSS vars`),o.length>0&&(r.push(`${dim("\u2502")} ${dim(o.join(", "))}`),r.push(dim("\u2502"))),r.push(`${dim("\u2502")} ${dim("Run with --diff to view changes.")}`),r.push(`${dim("\u2502")} ${dim("Run with --view to view file contents.")}`),r.push(`${dim("\u2514")} ${dim("Run without --dry-run to apply.")}`),r.join(`
`)}function Wa(e,t,r){let n=[];n.push(wt(t)),n.push(dim("\u2502"));let o=Ko(e.files,r),i=e.css&&Jo(e.css.path,r);if(o.length===0&&!i)n.push(`${dim("\u2502")} ${yellow(`No file matching "${r}" found.`)}`),n.push(dim("\u2502"));else {for(let s of o)Go(s,n);if(i&&e.css){if(n.push(`${dim("\u251C")} ${bold(e.css.path)} ${dim("(")}${yt(e.css.action)}${dim(")")}`),e.css.action==="create"||!e.css.existingContent)Le(n,e.css.content.split(`
`),s=>green(`+${s}`));else {let s=Yo(e.css.existingContent,e.css.content,e.css.path,{fullContext:true});Le(n,s);}n.push(dim("\u2502"));}}return n.push(`${dim("\u2514")} ${dim("Run without --dry-run to apply.")}`),n.join(`
`)}function Ba(e,t){let r=[];r.push(wt(t)),r.push(dim("\u2502"));let n=e.files.slice(0,ve);if(n.length===0&&!e.css)r.push(`${dim("\u2502")} ${dim("No changes.")}`),r.push(dim("\u2502"));else {for(let s of n)Go(s,r);e.files.length>ve&&r.push(dim("\u2502"));}let o=e.files.length;return o>ve&&r.push(`  ${dim(`Showing ${ve} of ${o} files. Use --diff <path> to view a specific file.`)}`),r.push(`${dim("\u2514")} ${dim("Run without --dry-run to apply.")}`),r.join(`
`)}function za(e,t){let r=[];r.push(wt(t)),r.push(dim("\u2502"));let n=e.files.slice(0,ve);if(n.length===0&&!e.css)r.push(`${dim("\u2502")} ${dim("No files.")}`),r.push(dim("\u2502"));else {for(let s of n){let l=s.content.split(`
`);r.push(`${dim("\u251C")} ${bold(s.path)} ${dim("(")}${yt(s.action)}${dim(")")} ${dim(`${l.length} lines`)}`),Le(r,l),r.push(dim("\u2502"));}e.files.length>ve&&r.push(dim("\u2502"));}let o=e.files.length;return o>ve&&r.push(`  ${dim(`Showing ${ve} of ${o} files. Use --view <path> to view a specific file.`)}`),r.push(`${dim("\u2514")} ${dim("Run without --dry-run to apply.")}`),r.join(`
`)}function Go(e,t){if(t.push(`${dim("\u251C")} ${bold(e.path)} ${dim("(")}${yt(e.action)}${dim(")")}`),e.action==="skip")t.push(`${dim("\u2502")} ${dim("No changes.")}`);else if(e.action==="create")Le(t,e.content.split(`
`),r=>green(`+${r}`));else {let r=Yo(e.existingContent,e.content,e.path);Le(t,r);}t.push(dim("\u2502"));}function Ja(e,t,r){let n=[];n.push(wt(t)),n.push(dim("\u2502"));let o=Ko(e.files,r),i=e.css&&Jo(e.css.path,r);if(o.length===0&&!i)n.push(`${dim("\u2502")} ${yellow(`No file matching "${r}" found.`)}`),n.push(dim("\u2502"));else {for(let s of o){let l=s.content.split(`
...
`)}function Ha(e,t){if(e.files.length===0)return;let r={create:0,overwrite:0,skip:0};for(let s of e.files)r[s.action]++;let n=[];r.create>0&&n.push(green(`+${r.create} new`)),r.overwrite>0&&n.push(yellow(`~${r.overwrite} overwrite`)),r.skip>0&&n.push(dim(`=${r.skip} skip`));let o=n.length>0?` ${n.join(dim(", "))}`:"";t.push(`${dim("\u251C")} ${bold("Files")} ${dim(`(${e.files.length})`)}${o}`);let i=Math.max(...e.files.map(s=>s.path.length));for(let s of e.files){let l=_a[s.action],a=Ua[s.action],f=" ".repeat(Math.max(1,i-s.path.length+2)),m=s.action==="create"?green:s.action==="overwrite"?yellow:dim,p=s.action==="skip"?dim(s.path):s.path;t.push(`${dim("\u2502")} ${m(l)} ${p}${f}${m(a)}`);}t.push(dim("\u2502"));}function Bo(e,t,r){if(t.length){r.push(`${dim("\u251C")} ${bold(e)} ${dim(`(${t.length})`)}`);for(let n of t)r.push(`${dim("\u2502")} ${green("+")} ${n}`);r.push(dim("\u2502"));}}function Ga(e,t){e.css&&(t.push(`${dim("\u251C")} ${bold("CSS")}`),e.css.cssVarsCount>0?t.push(`${dim("\u2502")} ${green("+")} ${e.css.cssVarsCount} CSS variables added to ${cyan(e.css.path)}`):t.push(`${dim("\u2502")} ${green("+")} Updated ${cyan(e.css.path)}`),t.push(dim("\u2502")));}function Ka(e,t){if(!e.envVars)return;let r=Object.keys(e.envVars.variables);t.push(`${dim("\u251C")} ${bold("Environment Variables")}`);for(let n of r)t.push(`${dim("\u2502")} ${green("+")} ${n}`);t.push(dim("\u2502"));}function Ya(e,t){if(e.fonts.length){t.push(`${dim("\u251C")} ${bold("Fonts")}`);for(let r of e.fonts)t.push(`${dim("\u2502")} ${green("+")} ${r.name} ${dim(`(${r.provider})`)}`);t.push(dim("\u2502"));}}function Ko(e,t){let r=e.filter(n=>n.path===t);return r.length>0?r:e.filter(n=>n.path.includes(t)||n.path.replace(/\\/g,"/").includes(t))}function Yo(e,t,r,n={}){if(ec(e,t))return [dim("  Formatting-only changes (spacing, quotes, semicolons).")];let o=zo(e),i=zo(t),s=n.fullContext?Math.max(o.split(`
`).length,i.split(`
`).length):3,l=structuredPatch(`a/${r}`,`b/${r}`,o,i,"","",{context:s});if(!l.hunks.length)return [dim("  No changes.")];let a=[dim(`--- a/${r}`),dim(`+++ b/${r}`)],f=t.split(`
`);for(let m of l.hunks){let{entries:p}=qa(m,f);if(!p.some(k=>k.kind!=="context"))continue;let h=p.filter(k=>k.kind==="context").length,g=p.filter(k=>k.kind==="removed").length,y=p.filter(k=>k.kind==="added").length;a.push(cyan(`@@ -${m.oldStart},${h+g} +${m.newStart},${h+y} @@`));for(let k of p)a.push(k.formatted);}return a}function qa(e,t){let r=[],n=e.newStart-1,o=0;for(;o<e.lines.length;){let i=e.lines[o];if(i.startsWith("-")){let s=[];for(;o<e.lines.length&&e.lines[o].startsWith("-");)s.push(e.lines[o].slice(1)),o++;for(;o<e.lines.length&&e.lines[o].startsWith("\\");)o++;let l=[];for(;o<e.lines.length&&e.lines[o].startsWith("+");)l.push(e.lines[o].slice(1)),o++;for(;o<e.lines.length&&e.lines[o].startsWith("\\");)o++;n=Za(s,l,t,n,r);}else if(i.startsWith("+")){let s=t[n]??i.slice(1);r.push({kind:"added",formatted:green(`+${s}`)}),n++,o++;}else if(i.startsWith("\\"))o++;else {let s=t[n]??i.slice(1);r.push({kind:"context",formatted:dim(` ${s}`)}),n++,o++;}}return {entries:r,newLineIndex:n}}function Za(e,t,r,n,o){if(tc(e,t)){for(let a=0;a<t.length;a++){let f=r[n]??t[a];o.push({kind:"context",formatted:dim(` ${f}`)}),n++;}return n}let i=Xa(e),s=i.map(nr),l=new Set;for(let a=0;a<t.length;a++){let f=r[n]??t[a],m=nr(t[a]),p=s.findIndex((u,h)=>!l.has(h)&&u===m);if(p!==-1)l.add(p),o.push({kind:"context",formatted:dim(` ${f}`)});else {let u=s.findIndex((h,g)=>!l.has(g));if(u!==-1){l.add(u);let{oldHighlighted:h,newHighlighted:g}=Qa(i[u],f);o.push({kind:"removed",formatted:h}),o.push({kind:"added",formatted:g});}else o.push({kind:"added",formatted:green(`+${f}`)});}n++;}for(let a=0;a<i.length;a++)l.has(a)||o.push({kind:"removed",formatted:red(`-${i[a]}`)});return n}function zo(e){return e.split(`
`).map(t=>{let r=t.match(/^(\s*)/)?.[1]??"",n=t.slice(r.length);return r+n.replace(/['"]/g,'"').replace(/;$/g,"")}).join(`
`)}function Xa(e){let t=[];for(let r=0;r<e.length;r++){let n=e[r];for(;r+1<e.length&&n.trimEnd().endsWith(":");)r++,n=n.trimEnd()+" "+e[r].trim();t.push(n);}return t}function Qa(e,t){let r=diffWords(e,t),n="-",o="+";for(let i of r)i.added?o+=bold(green(i.value)):i.removed?n+=bold(red(i.value)):(n+=red(i.value),o+=green(i.value));return {oldHighlighted:n,newHighlighted:o}}function nr(e){return e.replace(/\s+/g," ").trim().replace(/['"]/g,"'").replace(/;/g,"").replace(/,$/,"")}function ec(e,t){let r=n=>n.split(`
`).map(nr).filter(o=>o.length>0).join(" ");return r(e)===r(t)}function tc(e,t){let r=n=>n.map(nr).filter(o=>o.length>0).join(" ");return r(e)===r(t)}async function Zo(e,t){let r=A__default.join(t.resolvedPaths.cwd,"app/page.tsx");if(!(await bt__default.stat(r)).isFile())return;let[n]=await oa$1([e],{config:t});if(!n?.meta?.importSpecifier||!n?.meta?.moduleSpecifier)return;let o=`import { ${n?.meta?.importSpecifier} } from "${n.meta.moduleSpecifier}"

export default function Page() {
  return <${n?.meta?.importSpecifier} />
}`;await bt__default.writeFile(r,o,"utf8");}var ic=z.object({components:z.array(z.string()).optional(),yes:z.boolean(),overwrite:z.boolean(),cwd:z.string(),all:z.boolean(),path:z.string().optional(),silent:z.boolean(),dryRun:z.boolean(),diff:z.union([z.string(),z.literal(true)]).optional(),view:z.union([z.string(),z.literal(true)]).optional()}),Xo=new Command().name("add").description("add a component to your project").argument("[components...]","names, url or local path to component").option("-y, --yes","skip confirmation prompt.",false).option("-o, --overwrite","overwrite existing files.",false).option("-c, --cwd <cwd>","the working directory. defaults to the current directory.",process.cwd()).option("-a, --all","add all available components",false).option("-p, --path <path>","the path to add the component to.").option("-s, --silent","mute output.",false).option("--dry-run","preview changes without writing files.",false).option("--diff [path]","show diff for a file.").option("--view [path]","show file contents.").action(async(e$1,t)=>{try{let r=ic.parse({components:e$1,...t,cwd:A__default.resolve(t.cwd)});await ee(r.cwd);let n=r.dryRun||r.diff||r.view,o=await X$1(r.cwd);o||(o=ba({style:"new-york",resolvedPaths:{cwd:r.cwd}}));let i=!1;if(e$1.length>0){let{config:g,newRegistries:y}=await H(e$1,o,{silent:r.silent,writeFile:!1});o=g,i=y.length>0;}let s,l=!0;if(e$1.length>0){let[g]=await oa$1([e$1[0]],{config:o});if(s=g?.type,l=s!=="registry:theme"&&s!=="registry:style"&&s!=="registry:base",R(g)&&!n){await pe(e$1,o,r);return}if(!r.yes&&!n&&(s==="registry:style"||s==="registry:theme")){e.break();let{confirm:y}=await Re({type:"confirm",name:"confirm",message:d.warn(`You are about to install a new ${s.replace("registry:","")}. 
Existing CSS variables and components will be overwritten. Continue?`)});y||(e.break(),e.log("Installation cancelled."),e.break(),process.exit(1));}}r.components?.length||(r.components=await sc(r));let a=await Da(r.cwd);if(a?.tailwindVersion==="v4"){let g=c$1.filter(y=>r.components?.includes(y.name));g?.length&&(e.break(),g.forEach(y=>{e.warn(d.warn(y.message));}),e.break(),process.exit(1));}let{errors:f,config:m}=await Uo(r),p=!1;if(f["3"]){let{proceed:g}=await Re({type:"confirm",name:"proceed",message:`You need to create a ${d.info("components.json")} file to add components. Proceed?`,initial:!0});g||(e.break(),process.exit(1));let y=Xe(a?.framework.name),k=await qe(),{url:C}=await lt({rtl:!1,base:k,template:y}),{registryBaseConfig:I,installStyleIndex:x,url:R}=await Te(C,r.cwd);m=await rt({cwd:r.cwd,yes:!0,force:!0,defaults:!1,skipPreflight:!1,silent:r.silent&&!i,isNewProject:!1,cssVariables:!0,rtl:!1,installStyleIndex:x,components:[R,...r.components??[]],registryBaseConfig:I}),p=!0;}let u=!1;if(f["1"]){let{projectPath:g,template:y}=await tr({cwd:r.cwd,force:r.overwrite,components:r.components});g||(e.break(),process.exit(1)),r.cwd=g;let k=await qe(),{url:C}=await lt({rtl:!1,base:k,template:y}),{registryBaseConfig:I,installStyleIndex:x,url:R}=await Te(C,r.cwd);m=await rt({cwd:r.cwd,yes:!0,force:!0,defaults:!1,skipPreflight:!0,silent:!i&&r.silent,isNewProject:!0,cssVariables:!0,rtl:!1,installStyleIndex:x,components:[R,...r.components??[]],registryBaseConfig:I}),p=!0,u=r.components?.length===1&&!!r.components[0].match(/\/chat\/b\//);}if(!m)throw new Error(`Failed to read config at ${d.info(r.cwd)}.`);let{config:h}=await H(r.components,m,{silent:r.silent||i,writeFile:!n});if(m=h,n){let g=E("Resolving items.",{silent:r.silent}).start(),y=await Wo(r.components,m,{overwrite:r.overwrite});g.stop(),e.log(Ho(y,r.components,{diff:r.diff,view:r.view}));return}p||await pe(r.components,m,r),u&&await Zo(r.components[0],m);}catch(r){e.break(),ma$1(r);}finally{da$1();}});async function sc(e$1){let t=await ra$1();if(!t)return e.break(),ma$1(new Error("Failed to fetch registry index.")),[];if(e$1.all)return t.map(o=>o.name).filter(o=>!c$1.some(i=>i.name===o));if(e$1.components?.length)return e$1.components;let{components:r}=await Re({type:"multiselect",name:"components",message:"Which components would you like to add?",hint:"Space to select. A to toggle all. Enter to submit.",instructions:false,choices:t.filter(o=>o.type==="registry:ui"&&!c$1.some(i=>i.name===o.name)).map(o=>({title:o.name,value:o.name,selected:e$1.all?true:e$1.components?.includes(o.name)}))});r?.length||(e.warn("No components selected. Exiting."),e.info(""),process.exit(1));let n=z.array(z.string()).safeParse(r);return n.success?n.data:(e.error(""),ma$1(new Error("Something went wrong. Please try again.")),[])}async function Qo(e$1){let t={};if(!L.existsSync(e$1.cwd)||!L.existsSync(A__default.resolve(e$1.cwd,"package.json")))return t["1"]=true,{errors:t,config:null};if(!L.existsSync(A__default.resolve(e$1.cwd,"components.json"))){if(await f(e$1.cwd)){let r=await g(e$1.cwd),n=[];for(let o of r){let i=await Da(A__default.resolve(e$1.cwd,o.name));i?.framework&&i.framework.name!=="manual"&&n.push(o);}n.length>0&&(h("apply --preset <preset>",n,{cwdFlag:"-c"}),process.exit(1));}return t["3"]=true,{errors:t,config:null}}try{let r=await X$1(e$1.cwd);return {errors:t,config:r}}catch{e.break(),e.error(`An invalid ${d.info("components.json")} file was found at ${d.info(e$1.cwd)}.
Before you can apply a preset, you must create a valid ${d.info("components.json")} file by running the ${d.info("init")} command.`),e.error(`Learn more at ${d.info(`${a}/docs/components-json`)}.`),e.break(),process.exit(1);}}var lc=z.object({cwd:z.string(),positionalPreset:z.string().optional(),preset:z.string().optional(),only:z.union([z.boolean(),z.string()]).optional(),yes:z.boolean(),silent:z.boolean()}),ri=["theme","font"],ot=class extends Error{constructor(t){super(t),this.name="ApplyOnlyError";}},or=class extends Error{constructor(t){super(t),this.name="ApplyWorkspaceSyncError";}},ni=new Command().name("apply").description("apply a preset to an existing project").argument("[preset]","the preset to apply").option("--preset <preset>","preset configuration to apply").option("--only [parts]","apply only parts of a preset: theme, font").option("-y, --yes","skip confirmation prompt.",false).option("-c, --cwd <cwd>","the working directory. defaults to the current directory.",process.cwd()).option("-s, --silent","mute output.",false).action(async(e$1,t)=>{try{let r=lc.parse({...t,cwd:A__default.resolve(t.cwd),positionalPreset:e$1}),n=fc(r),o=ei(r.only);uc({preset:n,only:o});let i=await Qo(r);i.errors["1"]&&(e.break(),e.error(`The ${d.info("apply")} command only works in an existing project.`),e.error(`Run ${d.info(ti(n))} first.`),e.break(),process.exit(1)),i.errors["3"]&&(e.break(),e.error(`No ${d.info("components.json")} found at ${d.info(r.cwd)}.`),e.error(`Run ${d.info(ti(n))} first.`),e.break(),process.exit(1));let s=i.config;s||process.exit(1);let l=s.rtl??!1,a=await hc(r.cwd);if(!n){let y=jr({command:"init",template:a,base:aa$1(s.style),rtl:l});await Er({createUrl:y,followUp:`Then run ${d.info("shadcn apply --preset <preset>")} with the preset code or preset URL from ui.shadcn.com.`,prompt:!r.yes}),process.exit(0);}gc(n);let f=o??ei(mc(n)),m=!f,p=m?await Ga$1(r.cwd):[];if(!r.yes){if(e.break(),f?e.warn(d.warn("Applying the selected preset parts will update your project configuration and styles.")):e.warn(d.warn("Applying a new preset will overwrite existing UI components, fonts, and CSS variables.")),e.warn("Commit or stash your changes before continuing so you can easily go back."),m)if(e.break(),e.log("  The following components will be re-installed:"),p.length)for(let k=0;k<p.length;k+=8)e.log(`  - ${p.slice(k,k+8).join(", ")}`);else e.log("  - No installed UI components were detected.");e.break();let{proceed:y}=await Re({type:"confirm",name:"proceed",message:"Would you like to continue?",initial:!1});y||(e.break(),process.exit(1));}await ee(r.cwd);let u=aa$1(s.style),h=bc(n,u,{template:a,rtl:l,only:f?.join(",")}),g=await Vo(A__default.resolve(r.cwd,"components.json"),async()=>{let{registryBaseConfig:y,installStyleIndex:k,url:C}=await Te(h,r.cwd,{registries:s.registries}),I=dc({registryBaseConfig:y,existingConfig:s,only:f});return await rt({cwd:r.cwd,yes:!0,force:!1,reinstall:m,defaults:!1,silent:r.silent,isNewProject:!1,cssVariables:!0,installStyleIndex:k,registryBaseConfig:I,existingConfig:s,components:[C,...p]})});await yc(g,{only:f}),e.break(),e.log("Preset applied successfully."),e.break();}catch(r){if(r instanceof ot){for(let n of r.message.split(`
`))e.error(n);e.break(),process.exit(1);}r instanceof Qe&&(e.error(`Could not back up ${d.info("components.json")}. Aborting.`),e.break(),process.exit(1)),r instanceof or&&(e.error(r.message),e.break(),process.exit(1)),e.break(),ma$1(r);}finally{da$1();}});function fc(e$1){let t=e$1.positionalPreset?.trim(),r=e$1.preset?.trim();return t&&r&&t!==r&&(e.error(`Received two different preset values. Use either the positional preset or ${d.info("--preset")}, or pass the same value to both.`),e.break(),process.exit(1)),r??t}function mc(e){if(!Q$1(e))return;let t=new URL(e);if(t.pathname==="/init")return t.searchParams.get("only")??void 0}function ei(e){if(!(e===void 0||e===false)){if(e===true)throw new ot(["Missing value for --only.",`Use one or more of: ${ri.join(", ")}.`,"Example: shadcn apply <preset> --only theme,font."].join(`
`));return pc(e)}}function pc(e){let t={theme:"theme",font:"font",fonts:"font"},r=e.split(",").map(o=>o.trim().toLowerCase()).filter(Boolean),n=r.filter(o=>!t[o]);if(!r.length||n.length)throw new ot([`Invalid value for --only: ${e}.`,`Use one or more of: ${ri.join(", ")}.`,"Example: shadcn apply <preset> --only theme,font."].join(`
`));return Array.from(new Set(r.map(o=>t[o])))}function uc(e){if(!(!e.only||e.preset))throw new ot(["Missing preset for --only.","Use: shadcn apply <preset> --only theme,font."].join(`
`))}function dc(e){if(!e.only||e.only.includes("theme"))return e.registryBaseConfig;let t=typeof e.existingConfig.tailwind=="object"&&e.existingConfig.tailwind!==null?e.existingConfig.tailwind:{},r=typeof e.registryBaseConfig?.tailwind=="object"&&e.registryBaseConfig.tailwind!==null?e.registryBaseConfig.tailwind:{},n={...e.registryBaseConfig,tailwind:{...t,...r}};return e.existingConfig.menuColor&&(n.menuColor=e.existingConfig.menuColor),e.existingConfig.menuAccent&&(n.menuAccent=e.existingConfig.menuAccent),n}function gc(e$1){if(Q$1(e$1)||r(e$1))return;let t=Object.keys(Z);t.includes(e$1)||(e.error(`Invalid preset: ${d.info(e$1)}.
Use one of the available presets: ${t.join(", ")} 
or build your own at ${d.info(`${a}/create`)}`),e.break(),process.exit(1));}async function hc(e){let t=await Da(e);return Xe(t?.framework.name)}async function yc(e,t){if(t?.only&&!t.only.includes("theme"))return;let r=await wc(e);if(!r.length)return;let n={style:e.style,tailwind:{baseColor:e.tailwind.baseColor,cssVariables:e.tailwind.cssVariables},...e.iconLibrary?{iconLibrary:e.iconLibrary}:{},...e.rtl!==void 0?{rtl:e.rtl}:{},...e.menuColor?{menuColor:e.menuColor}:{},...e.menuAccent?{menuAccent:e.menuAccent}:{}},o=[];for(let i of r){let s=A__default.resolve(i.resolvedPaths.cwd,"components.json");await L.pathExists(s)&&o.push({configPath:s,existingConfig:await L.readJson(s)});}try{for(let i of o)if(!gt(i.configPath))throw new Qe(i.configPath);for(let i of o)await L.writeJson(i.configPath,{...i.existingConfig,...n,tailwind:{...i.existingConfig.tailwind,...n.tailwind}},{spaces:2});for(let i of o)ht(i.configPath);}catch(i){for(let s of [...o].reverse())et(s.configPath);throw new or(`Failed to sync linked workspace configs.${i instanceof Error?` ${i.message}`:""}`)}}async function wc(e){let t=await Z$1(e);if(!t)return [];let r=new Map;for(let n of Object.values(t))n.resolvedPaths.cwd!==e.resolvedPaths.cwd&&r.set(n.resolvedPaths.cwd,n);return Array.from(r.values()).sort((n,o)=>n.resolvedPaths.cwd.localeCompare(o.resolvedPaths.cwd))}function bc(e$1,t,r$1={}){if(Q$1(e$1)){let o=new URL(e$1);return o.pathname==="/init"&&e$1.startsWith(a)&&o.searchParams.set("track","1"),o.searchParams.set("base",t),o.searchParams.set("rtl",String(r$1.rtl??false)),r$1.only&&o.searchParams.set("only",r$1.only),o.toString()}if(r(e$1)){let o=q(e$1);return o||(e.error(`Invalid preset code: ${d.info(e$1)}`),e.break(),process.exit(1)),he({...o,base:t,rtl:r$1.rtl??false},{preset:e$1,template:r$1.template,only:r$1.only})}let n=Z[e$1];return he({...n,base:t,rtl:r$1.rtl??n.rtl},{template:r$1.template,only:r$1.only})}function kc(e){return /[^A-Za-z0-9_./:-]/.test(e)?JSON.stringify(e):e}function ti(e){return e?`shadcn init --preset ${kc(e)}`:"shadcn init"}async function ai(e$1){let t={},r={cwd:e$1.cwd,registryFile:A__default.resolve(e$1.cwd,e$1.registryFile),outputDir:A__default.resolve(e$1.cwd,e$1.outputDir)};return L.existsSync(r.registryFile)||(t["13"]=true),await L.mkdir(r.outputDir,{recursive:true}),Object.keys(t).length>0&&(t["13"]&&(e.break(),e.error(`The path ${d.info(r.registryFile)} does not exist.`)),e.break(),process.exit(1)),{errors:t,resolvePaths:r}}var Rc=z.object({cwd:z.string(),registryFile:z.string(),outputDir:z.string()}),ci=new Command().name("build").description("build components for a shadcn registry").argument("[registry]","path to registry.json file","./registry.json").option("-o, --output <path>","destination directory for json files","./public/r").option("-c, --cwd <cwd>","the working directory. defaults to the current directory.",process.cwd()).action(async(e$1,t)=>{try{let r=Rc.parse({cwd:A.resolve(t.cwd),registryFile:e$1,outputDir:t.output}),{resolvePaths:n}=await ai(r),o=await Ja$1(n.registryFile,{cwd:n.cwd}),i=o.registry,s=o.usesInclude?A.dirname(n.registryFile):n.cwd,l=Ka$1(o,s,n.cwd),a=E("Building registry...");for(let f of i.items){a.start(`Building ${f.name}...`);let m=await La$1(f,o,s,n.cwd);await bt.writeFile(A.resolve(n.outputDir,`${m.name}.json`),JSON.stringify(m,null,2));}o.usesInclude?await bt.writeFile(A.resolve(n.outputDir,"registry.json"),JSON.stringify(l,null,2)):await bt.copyFile(n.registryFile,A.resolve(n.outputDir,"registry.json")),a.succeed("Building registry.");}catch(r){e.break(),ma$1(r);}});var Ic=z.object({component:z.string().optional(),yes:z.boolean(),cwd:z.string(),path:z.string().optional()}),fi=new Command().name("diff").description("[DEPRECATED] Use `add [component] --diff` instead.").argument("[component]","the component name").option("-y, --yes","skip confirmation prompt.",false).option("-c, --cwd <cwd>","the working directory. defaults to the current directory.",process.cwd()).action(async(e$1,t)=>{try{let r=Ic.parse({component:e$1,...t}),n=A__default.resolve(r.cwd);existsSync(n)||(e.error(`The path ${n} does not exist. Please try again.`),process.exit(1));let o=await X$1(n);if(!o){if(await f(n)){let a=await g(n);a.length>0&&(h("diff [component]",a),process.exit(1));}e.warn(`Configuration is missing. Please run ${d.success("init")} to create a components.json file.`),process.exit(1);}let i=await ra$1();if(i||(ma$1(new Error("Failed to fetch registry index.")),process.exit(1)),!r.component){let a=o.resolvedPaths.components,f=i.filter(p=>{for(let u of p.files??[]){let h=A__default.resolve(a,typeof u=="string"?u:u.path);if(existsSync(h))return !0}return !1}),m=[];for(let p of f){let u=await li(p,o);u.length&&m.push({name:p.name,changes:u});}m.length||(e.info("No updates found."),process.exit(0)),e.info("The following components have updates available:");for(let p of m){e.info(`- ${p.name}`);for(let u of p.changes)e.info(`  - ${u.filePath}`);}e.break(),e.info(`Run ${d.success("diff <component>")} to see the changes.`),process.exit(0);}let s=i.find(a=>a.name===r.component);s||(e.error(`The component ${d.success(r.component)} does not exist.`),process.exit(1));let l=await li(s,o);l.length||(e.info(`No updates found for ${r.component}.`),process.exit(0));for(let a of l)e.info(`- ${a.filePath}`),await Pc(a.patch),e.info("");}catch(r){ma$1(r);}});async function li(e,t){let r=await xa$1(t.style,[e]),n=await va(t.tailwind.baseColor),o=Oe(r);if(!r)return [];let i=[];for(let s of r){let l=await ya$1(t,s);if(l)for(let a of s.files??[]){let f=A__default.resolve(l,typeof a=="string"?a:a.path);if(!existsSync(f))continue;let m=await promises.readFile(f,"utf8");if(typeof a=="string"||!a.content)continue;let p=await J({filename:a.path,raw:a.content,config:t,baseColor:n,supportedFontMarkers:o},[F,G,a$1,I,c$2,g$1,d$1,f$1,H$1]),u=diffLines(p,m);u.length>1&&i.push({filePath:f,patch:u});}}return i}async function Pc(e){e.forEach(t=>{if(t)return t.added?process.stdout.write(d.success(t.value)):t.removed?process.stdout.write(d.error(t.value)):process.stdout.write(t.value)});}var mi="https://ui.shadcn.com",pi=new Command().name("docs").description("get docs, api references and usage examples for components").argument("<components...>","component names").option("-c, --cwd <cwd>","the working directory. defaults to the current directory.",process.cwd()).option("-b, --base <base>","the base to use either 'base' or 'radix'. defaults to project base.").option("--json","output as JSON.",false).action(async(e$1,t)=>{try{let r=A__default.resolve(t.cwd),n=await X$1(r),o=t.base??aa$1(n?.style),i=await ra$1();i||(e.error("Failed to fetch the registry index."),process.exit(1));let s=[];for(let a of e$1){let f=i.find(p=>p.name===a);f||(e.error(`Component ${d.info(a)} not found in the shadcn registry.`),process.exit(1));let m=f.meta?.links?.[o];if(!m||Object.keys(m).length===0){e.warn(`No documentation links available for ${d.info(a)}.`);continue}s.push({component:a,base:o,links:Ec(m)});}if(t.json){console.log(JSON.stringify({base:o,results:s},null,2));return}let l=Math.max(...s.flatMap(a=>Object.keys(a.links).map(f=>f.length)));for(let{component:a,links:f}of s){e.log(d.info(a));for(let[m,p]of Object.entries(f))e.log(`  - ${m.padEnd(l+2)}${p}`);e.break();}}catch(r){ma$1(r);}});function Ec(e){return Object.fromEntries(Object.entries(e).map(([t,r])=>[t,r.startsWith(mi)?`${a}${r.slice(mi.length)}`:r]))}var ui=/@import\s+["']shadcn\/tailwind\.css["'];?\s*\n?/,Ac=z.object({cwd:z.string(),yes:z.boolean(),silent:z.boolean()}),di=new Command().name("eject").description("inline shadcn/tailwind.css and remove the shadcn dependency").option("-c, --cwd <cwd>","the working directory. defaults to the current directory.",process.cwd()).option("-y, --yes","skip confirmation prompt.",false).option("-s, --silent","mute output.",false).action(async e=>{try{let t=Ac.parse({cwd:A__default.resolve(e.cwd),yes:e.yes,silent:e.silent});await Nc(t);}catch(t){ma$1(t);}});async function Nc(e$1){if(!L.existsSync(A__default.resolve(e$1.cwd,"components.json"))){if(await f(e$1.cwd)){let m=await g(e$1.cwd);m.length>0&&(h("eject",m),process.exit(1));}e.break(),e.error(`No ${d.info("components.json")} found. Run ${d.info("shadcn init")} first.`),e.error(`Learn more at ${d.info(`${a}/docs/components-json`)}.`),e.break(),process.exit(1);}let t=await X$1(e$1.cwd);t?.resolvedPaths.tailwindCss||(e.break(),e.error("Could not resolve the Tailwind CSS file from components.json."),e.break(),process.exit(1));let r=t.resolvedPaths.tailwindCss,n=A__default.relative(e$1.cwd,r),o=await promises.readFile(r,"utf8");ui.test(o)||(e.break(),e.error(`Could not find ${d.info('@import "shadcn/tailwind.css"')} in ${d.info(n)}.`),e.error("Nothing to eject."),e.break(),process.exit(1));let i=y(e$1.cwd,false),s=Oc(i),l=Vc(e$1.cwd),a$1=await promises.readFile(l,"utf8");if(e$1.silent||(e.break(),e.warn("This action is not reversible. Future shadcn CLI updates to tailwind.css will not apply automatically."),e.break()),!e$1.yes){e.log("This will:"),e.log(`  - Inline ${d.info("shadcn/tailwind.css")} into ${d.info(n)}`),e.log(`  - Remove the ${d.info("shadcn")} dependency`),e.break();let{proceed:m}=await Re({type:"confirm",name:"proceed",message:"Proceed?",initial:false});m||process.exit(0);}let f$1=E(`Inlining ${d.info("shadcn/tailwind.css")}.`,{silent:e$1.silent})?.start();if(o=o.replace(ui,()=>`/* ejected from shadcn@${s} */
${a$1.trim()}
