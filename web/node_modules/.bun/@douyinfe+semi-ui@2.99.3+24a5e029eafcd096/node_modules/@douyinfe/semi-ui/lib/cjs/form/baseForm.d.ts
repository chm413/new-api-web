...
declare class Form<Values extends Record<string, any> = any> extends BaseComponent<BaseFormProps<Values>, BaseFormState> {
    ...
    static Input: React.ComponentType<Omit<Omit<import("../input").InputProps, "forwardRef"> & React.RefAttributes<HTMLInputElement>, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static TextArea: React.ComponentType<Omit<Omit<import("../input").TextAreaProps, "forwardRef"> & React.RefAttributes<HTMLTextAreaElement>, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static InputNumber: React.ComponentType<Omit<import("../inputNumber").InputNumberProps & React.RefAttributes<HTMLInputElement>, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static Select: React.ComponentType<Omit<{
    ...
    static RadioGroup: React.ComponentType<Omit<import("../radio").RadioGroupProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static DatePicker: React.ComponentType<Omit<import("../datePicker").DatePickerProps & React.RefAttributes<import("../datePicker").BaseDatePicker>, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static TimePicker: React.ComponentType<Omit<import("../timePicker").TimePickerProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static Switch: React.ComponentType<Omit<import("../switch").SwitchProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static Slider: React.ComponentType<Omit<import("../slider").SliderProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static TreeSelect: React.ComponentType<Omit<import("../treeSelect").TreeSelectProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static Cascader: React.ComponentType<Omit<import("../cascader").CascaderProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static Rating: React.ComponentType<Omit<import("../rating").RatingProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static AutoComplete: React.ComponentType<Omit<import("../autoComplete").AutoCompleteProps<import("../autoComplete").AutoCompleteItems>, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static Upload: React.ComponentType<Omit<import("../upload").UploadProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static TagInput: React.ComponentType<Omit<import("../tagInput").TagInputProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
    static PinCode: React.ComponentType<Omit<import("../pincode").PinCodeProps, keyof import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
