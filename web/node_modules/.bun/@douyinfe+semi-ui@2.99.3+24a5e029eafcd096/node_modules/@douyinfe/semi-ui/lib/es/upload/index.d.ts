...
import type { FileItem, RenderFileItemProps, UploadListType, PromptPositionType, BeforeUploadProps, AfterUploadProps, OnChangeProps, customRequestArgs, CustomError, RenderPictureCloseProps, RenderFileListTitleProps, CropProps } from './interface';
...
export type { FileItem, FileItemStatus, RenderFileItemProps, UploadListType, PromptPositionType, BeforeUploadProps, AfterUploadProps, OnChangeProps, customRequestArgs, CustomError, BeforeUploadObjectResult, AfterUploadResult, RenderFileListTitleProps, CropProps, };
...
declare class Upload extends BaseComponent<UploadProps, UploadState> {
    static propTypes: {
        ...
        crop: PropTypes.Requireable<NonNullable<boolean | object>>;
        beforeCrop: PropTypes.Requireable<(...args: any[]) => any>;
        onCropError: PropTypes.Requireable<(...args: any[]) => any>;
        cropModalProps: PropTypes.Requireable<object>;
    };
     ...
     */
    handleCropFiles: (files: File[], isReplaceOperation?: boolean) => Promise<void>;
    /**
     ...
     */
    shouldCropFile: (file: File, files: File[]) => Promise<boolean>;
    /**
