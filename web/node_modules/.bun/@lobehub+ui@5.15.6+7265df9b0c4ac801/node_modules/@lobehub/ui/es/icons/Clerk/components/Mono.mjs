...
//#region src/icons/Clerk/components/Mono.tsx
const Icon = memo(({ size = "1em", style, ...rest }) => {
	return /* @__PURE__ */ jsxs("svg", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("path", { d: "M12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM18.757 20.879c.319.319.287.847-.088 1.098A11.944 11.944 0 0111.999 24c-2.468 0-4.762-.745-6.67-2.023-.374-.25-.407-.779-.087-1.098l2.74-2.74c.248-.248.632-.287.944-.128a6.722 6.722 0 003.073.739 6.722 6.722 0 003.074-.739c.311-.16.695-.12.943.127l2.74 2.741z" }),
			/* @__PURE__ */ jsx("path", {
