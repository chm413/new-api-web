...
const Icon = memo(({ size = "1em", style, ...rest }) => {
	return /* @__PURE__ */ jsxs("svg", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("path", { d: "M.47 12.956l10-11.28c.4-.45.966-.676 1.531-.676v.001c.564 0 1.129.226 1.527.676l3.439 3.879a4.152 4.152 0 00-1.751-.388 4.07 4.07 0 00-3.07 1.368l-5.965 6.73L12 16.902l-2.407 1.504-.002.001c-.638.41-1.407.65-2.235.65-.91 0-1.77-.36-2.287-.682L.901 15.771C-.1 15.145-.3 13.828.471 12.956z" })
		]
	});
});
//#endregion
