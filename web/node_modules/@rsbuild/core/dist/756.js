...
let parseRangeHeaders = async (value)=>{
    let { default: rangeParser } = await import("./range-parser.js").then(__webpack_require__.t.bind(__webpack_require__, "../../node_modules/.pnpm/range-parser@1.3.0/node_modules/range-parser/index.js", 23)), [len, rangeHeader] = value.split('|');
...
function setupCommands() {
    ...
    cli.version("2.1.1"), cli.option('--base <base>', 'Set the base path of the server').option('-c, --config <config>', 'Set the configuration file (relative or absolute path)').option('--config-loader <loader>', 'Set the config file loader (auto | jiti | native)', {
        default: 'auto'
