...
function _registerGifImage() {
    if (_registerGifImage.__loaded) return;
    _registerGifImage.__loaded = !0;
    const legacyContext = getLegacyBindingContext();
    registerGifGraphic(), bindGifImageRenderContribution(legacyContext), bindGifImageCanvasPickerContribution(legacyContext);
}
