...
const generator_1 = require("@visactor/vrender-core/common/generator"), application_1 = require("@visactor/vrender-core/application"), vrender_core_1 = require("@visactor/vrender-core"), vutils_1 = require("@visactor/vutils");
...
function createImageElement(src, isSvg = !1) {
    ...
    if (application_1.application.global.isImageAnonymous && (img.crossOrigin = "anonymous"), 
    isSvg) {
...
class BrowserEnvContribution extends vrender_core_1.BaseEnvContribution {
    constructor() {
