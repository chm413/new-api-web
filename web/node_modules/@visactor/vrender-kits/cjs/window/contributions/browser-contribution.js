...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindBrowserWindowContribution = exports.BrowserWindowHandlerContribution = void 0;

const application_1 = require("@visactor/vrender-core/application"), vrender_core_1 = require("@visactor/vrender-core"), vutils_1 = require("@visactor/vutils"), browser_1 = require("../../canvas/contributions/browser");

class BrowserWindowHandlerContribution extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
    ...
    constructor() {
        super(), this.type = "browser", this._canvasIsIntersecting = !0, this.global = application_1.application.global, 
    ...
    createWindowByCanvas(params) {
        ...
        if ("string" == typeof params.canvas) {
            if (canvas = null === (_a = this.global) || void 0 === _a ? void 0 : _a.getElementById(params.canvas), 
            canvas || "undefined" == typeof document || (canvas = document.getElementById(params.canvas)), 
...
function bindBrowserWindowContribution(container) {
    var _a, _b;
    (null === (_a = container.isBound) || void 0 === _a ? void 0 : _a.call(container, BrowserWindowHandlerContribution)) || container.bind(BrowserWindowHandlerContribution).toSelf(), 
    (null === (_b = container.getNamed) || void 0 === _b ? void 0 : _b.call(container, vrender_core_1.WindowHandlerContribution, BrowserWindowHandlerContribution.env)) || container.bind(vrender_core_1.WindowHandlerContribution).toService(BrowserWindowHandlerContribution).whenTargetNamed(BrowserWindowHandlerContribution.env);
}

exports.BrowserWindowHandlerContribution = BrowserWindowHandlerContribution, BrowserWindowHandlerContribution.env = "browser", 
BrowserWindowHandlerContribution.idprefix = "visactor_window", BrowserWindowHandlerContribution.prefix_count = 0, 
exports.bindBrowserWindowContribution = bindBrowserWindowContribution;
