...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindWxWindowContribution = exports.WxWindowHandlerContribution = void 0;

const generator_1 = require("@visactor/vrender-core/common/generator"), application_1 = require("@visactor/vrender-core/application"), vrender_core_1 = require("@visactor/vrender-core"), wx_1 = require("../../canvas/contributions/wx");
...
class WxWindowHandlerContribution extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
        return null;
    }
...
function bindWxWindowContribution(container) {
    ...
    (null === (_b = container.getNamed) || void 0 === _b ? void 0 : _b.call(container, vrender_core_1.WindowHandlerContribution, WxWindowHandlerContribution.env)) || container.bind(vrender_core_1.WindowHandlerContribution).toService(WxWindowHandlerContribution).whenTargetNamed(WxWindowHandlerContribution.env);
}

exports.WxWindowHandlerContribution = WxWindowHandlerContribution, WxWindowHandlerContribution.env = "wx", 
exports.bindWxWindowContribution = bindWxWindowContribution;
