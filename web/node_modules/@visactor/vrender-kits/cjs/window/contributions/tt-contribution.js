...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindTTWindowContribution = exports.TTWindowHandlerContribution = void 0;

const generator_1 = require("@visactor/vrender-core/common/generator"), vrender_core_1 = require("@visactor/vrender-core"), tt_1 = require("../../canvas/contributions/tt"), application_1 = require("@visactor/vrender-core/application");
...
class TTWindowHandlerContribution extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
        return null;
    }
...
function bindTTWindowContribution(container) {
    var _a, _b;
    (null === (_a = container.isBound) || void 0 === _a ? void 0 : _a.call(container, TTWindowHandlerContribution)) || container.bind(TTWindowHandlerContribution).toSelf(), 
    (null === (_b = container.getNamed) || void 0 === _b ? void 0 : _b.call(container, vrender_core_1.WindowHandlerContribution, TTWindowHandlerContribution.env)) || container.bind(vrender_core_1.WindowHandlerContribution).toService(TTWindowHandlerContribution).whenTargetNamed(TTWindowHandlerContribution.env);
}

exports.TTWindowHandlerContribution = TTWindowHandlerContribution, TTWindowHandlerContribution.env = "tt", 
exports.bindTTWindowContribution = bindTTWindowContribution;
