...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.bindFeishuWindowContribution = exports.FeishuWindowHandlerContribution = void 0;

const generator_1 = require("@visactor/vrender-core/common/generator"), vrender_core_1 = require("@visactor/vrender-core"), feishu_1 = require("../../canvas/contributions/feishu"), application_1 = require("@visactor/vrender-core/application");
...
class FeishuWindowHandlerContribution extends vrender_core_1.BaseWindowHandlerContribution {
    get container() {
        return null;
    }
...
function bindFeishuWindowContribution(container) {
    var _a, _b;
    (null === (_a = container.isBound) || void 0 === _a ? void 0 : _a.call(container, FeishuWindowHandlerContribution)) || container.bind(FeishuWindowHandlerContribution).toSelf(), 
    (null === (_b = container.getNamed) || void 0 === _b ? void 0 : _b.call(container, vrender_core_1.WindowHandlerContribution, FeishuWindowHandlerContribution.env)) || container.bind(vrender_core_1.WindowHandlerContribution).toService(FeishuWindowHandlerContribution).whenTargetNamed(FeishuWindowHandlerContribution.env);
}

exports.FeishuWindowHandlerContribution = FeishuWindowHandlerContribution, FeishuWindowHandlerContribution.env = "feishu", 
exports.bindFeishuWindowContribution = bindFeishuWindowContribution;
