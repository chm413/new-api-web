...
const generator_1 = require("@visactor/vrender-core/common/generator"), application_1 = require("@visactor/vrender-core/application"), vrender_core_1 = require("@visactor/vrender-core"), lynx_1 = require("../../canvas/contributions/lynx");
...
function bindLynxWindowContribution(container) {
    var _a, _b;
    (null === (_a = container.isBound) || void 0 === _a ? void 0 : _a.call(container, LynxWindowHandlerContribution)) || container.bind(LynxWindowHandlerContribution).toSelf(), 
    (null === (_b = container.getNamed) || void 0 === _b ? void 0 : _b.call(container, vrender_core_1.WindowHandlerContribution, LynxWindowHandlerContribution.env)) || container.bind(vrender_core_1.WindowHandlerContribution).toService(LynxWindowHandlerContribution).whenTargetNamed(LynxWindowHandlerContribution.env);
}

exports.LynxWindowHandlerContribution = LynxWindowHandlerContribution, LynxWindowHandlerContribution.env = "lynx", 
exports.bindLynxWindowContribution = bindLynxWindowContribution;
