...
const application_1 = require("@visactor/vrender-core/application"), vrender_core_1 = require("@visactor/vrender-core"), vutils_1 = require("@visactor/vutils"), PRESS_TIME = 251, PRESS_THRESHOLD = 9, SWIPE_VELOCITY = .3, SWIPE_THRESHOLD = 10, TAP_INTERVAL = 300, calcDirection = (start, end) => {
...
class Gesture extends vutils_1.EventEmitter {
    ...
    triggerEvent(type, ev) {
        ...
        throttleTimer || (this.throttleTimer = application_1.application.global.getRequestAnimationFrame()((() => {
            application_1.application.global.getCancelAnimationFrame()(this.throttleTimer), 
