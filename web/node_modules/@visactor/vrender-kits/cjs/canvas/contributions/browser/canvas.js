...
const application_1 = require("@visactor/vrender-core/application"), vrender_core_1 = require("@visactor/vrender-core"), context_1 = require("./context");

class BrowserCanvas extends vrender_core_1.BaseCanvas {
    constructor(params) {
        super(params);
    }
    init(params) {
        ...
        this._context = new context_1.BrowserContext2d(this, this._dpr), this.initStyle();
    }
    initStyle() {
...
exports.BrowserCanvas = BrowserCanvas, BrowserCanvas.env = "browser";
