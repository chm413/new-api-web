...
const graphic_creator_1 = require("../util/graphic-creator"), vutils_1 = require("@visactor/vutils"), base_1 = require("../core/base"), type_1 = require("./type"), config_1 = require("./config"), register_1 = require("./register"), delayMap = {
...
class Brush extends base_1.AbstractComponent {
    constructor(attributes, options) {
        ...
        this._onBrushStart = e => {
            ...
            const {updateTrigger: updateTrigger = config_1.DEFAULT_BRUSH_ATTRIBUTES.updateTrigger, endTrigger: endTrigger = config_1.DEFAULT_BRUSH_ATTRIBUTES.endTrigger, brushMoved: brushMoved = !0} = this.attribute, stage = this.stage;
            stage && ((0, vutils_1.array)(updateTrigger).forEach((t => stage.addEventListener(t, this._onBrushingWithDelay))), 
            (0, vutils_1.array)(endTrigger).forEach((t => stage.addEventListener(t, this._onBrushEnd))), 
    ...
    _bindBrushEvents() {
        ...
        (0, vutils_1.array)(trigger).forEach((t => stage.addEventListener(t, this._onBrushStart))), 
        (0, vutils_1.array)(resetTrigger).forEach((t => stage.addEventListener(t, this._onBrushClear)));
    }
    _initDraw(e) {
        if (!1 === this.attribute.interactive) return;
    ...
    releaseBrushEvents() {
        ...
        if (!stage) return;
        const {trigger: trigger = config_1.DEFAULT_BRUSH_ATTRIBUTES.trigger, resetTrigger: resetTrigger = config_1.DEFAULT_BRUSH_ATTRIBUTES.resetTrigger} = this.attribute;
        (0, vutils_1.array)(trigger).forEach((t => stage.removeEventListener(t, this._onBrushStart))), 
        (0, vutils_1.array)(resetTrigger).forEach((t => stage.removeEventListener(t, this._onBrushClear))), 
    ...
    _releaseBrushUpdateEvents(stage) {
        ...
        (0, vutils_1.array)(updateTrigger).forEach((t => stage.removeEventListener(t, this._onBrushingWithDelay))), 
        (0, vutils_1.array)(endTrigger).forEach((t => stage.removeEventListener(t, this._onBrushEnd)));
    }
    _computeMaskPoints() {
    ...
    _addBrushMask() {
        var _a;
        const {brushStyle: brushStyle, hasMask: hasMask} = this.attribute, brushMask = graphic_creator_1.graphicCreator.polygon(Object.assign(Object.assign({
