...
class DiscreteLegend extends base_1.LegendBase {
    ...
    _renderContent() {
        ...
        const itemsContainer = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0
        });
    ...
    _renderEachItem(item, isSelected, index, items) {
        ...
        let itemGroup;
        !1 === background.visible ? (itemGroup = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0,
            cursor: null === (_a = backgroundStyle.style) || void 0 === _a ? void 0 : _a.cursor
        }), this._appendDataToShape(itemGroup, constant_1.LEGEND_ELEMENT_NAME.item, item, itemGroup)) : (itemGroup = graphic_creator_1.graphicCreator.group(Object.assign({
            x: 0,
            y: 0
        ...
        const innerGroup = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0,
            pickable: !1
        });
        ...
        if (shapeAttr && !1 !== shapeAttr.visible) {
            ...
            const itemShape = graphic_creator_1.graphicCreator.symbol(Object.assign(Object.assign({
                x: 0,
                y: 0,
                symbolType: "circle",
        ...
        if (focus) {
            ...
            focusShape = graphic_creator_1.graphicCreator.symbol(Object.assign(Object.assign({
                x: 0,
                y: -focusSize / 2 - 1,
                strokeBoundsBuffer: 0,
    ...
    _updatePositionOfPager(renderStartY, compWidth, compHeight) {
        var _a;
        const {pager: pager} = this.attribute, {totalPage: totalPage, isHorizontal: isHorizontal} = this._itemContext, position = pager && pager.position || "middle", hugContent = !(!pager || !pager.hugContent), pagerSpace = null !== (_a = pager && pager.space) && void 0 !== _a ? _a : constant_1.DEFAULT_PAGER_SPACE;
    ...
    _renderPager() {
        ...
        const clipGroup = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: renderStartY,
            width: clipWidth,
            height: clipHeight,
    ...
    renderScrollMask(clipGroup) {
        ...
        const width = clipGroup.AABBBounds.width(), height = clipGroup.AABBBounds.height(), totalLength = this._itemContext.isHorizontal ? width : height, startStops = gradientStops.map((stop => ({
            ...
            color: stop.color
        }))), mask = graphic_creator_1.graphicCreator.rect({
            x: 0,
            y: 0,
            width: width,
            height: height
