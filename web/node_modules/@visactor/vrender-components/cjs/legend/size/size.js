...
const graphic_creator_1 = require("../../util/graphic-creator"), vutils_1 = require("@visactor/vutils"), base_1 = require("../base"), slider_1 = require("../../slider"), constant_1 = require("../constant"), util_1 = require("../util"), register_1 = require("../register");
...
class SizeContinuousLegend extends base_1.LegendBase {
    ...
    _renderContent() {
        const {slidable: slidable, layout: layout, align: align, min: min, max: max, value: value, railWidth: railWidth, railHeight: railHeight, showHandler: showHandler = !0, handlerSize: handlerSize, handlerStyle: handlerStyle, railStyle: railStyle, trackStyle: trackStyle, startText: startText, endText: endText, handlerText: handlerText, showTooltip: showTooltip, tooltip: tooltip, sizeBackground: sizeBackground, disableTriggerEvent: disableTriggerEvent, inverse: inverse} = this.attribute, mainContainer = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0
        });
        ...
        const background = graphic_creator_1.graphicCreator.path(Object.assign(Object.assign({
            x: 0,
            y: start,
            path: path
        }, sizeBackground), {
