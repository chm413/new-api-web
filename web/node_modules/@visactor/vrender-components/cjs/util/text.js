...
const text_1 = require("@visactor/vrender-core/text"), graphic_creator_1 = require("./graphic-creator"), vutils_1 = require("@visactor/vutils"), constant_1 = require("../constant"), initTextMeasure = (textSpec, option, useNaiveCanvas, defaultFontParams) => new vutils_1.TextMeasure(Object.assign({
    defaultFontParams: Object.assign({
        fontFamily: constant_1.DEFAULT_TEXT_FONT_FAMILY,
        fontSize: constant_1.DEFAULT_TEXT_FONT_SIZE
    }, defaultFontParams),
    getTextBounds: useNaiveCanvas ? void 0 : text_1.getTextBounds,
...
function measureTextSize(text, textSpec, defaultTextTheme = {}) {
    ...
    const bounds = (0, text_1.getTextBounds)({
        text: text,
