...
const vutils_1 = require("@visactor/vutils"), vrender_core_1 = require("@visactor/vrender-core"), graphic_creator_1 = require("../util/graphic-creator"), base_1 = require("../core/base"), constant_1 = require("./constant"), register_1 = require("./register"), event_1 = require("../util/event");
...
class Slider extends base_1.AbstractComponent {
    ...
    render() {
        ...
        const innerView = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0
        });
        ...
        if (startText && startText.visible) {
            startTextShape = graphic_creator_1.graphicCreator.text(Object.assign({
        ...
        const mainContainer = graphic_creator_1.graphicCreator.group({
            x: isHorizontal ? startLen : 0,
            y: isHorizontal ? 0 : startLen
        });
        innerView.add(mainContainer);
        const railContainer = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0
        });
        let endTextShape;
        ...
        startLen += isHorizontal ? railWidth : railHeight, endText && endText.visible) {
            ...
            endTextShape = graphic_creator_1.graphicCreator.text(Object.assign({
    ...
    _renderRail(container) {
        ...
        const railShape = graphic_creator_1.graphicCreator.rect(Object.assign({
            x: 0,
            y: 0,
            width: railWidth,
            height: railHeight,
    ...
    _renderTrack(container) {
        ...
        const trackContainer = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0,
            width: railWidth,
            height: railHeight,
        ...
        const startPos = this.calculatePosByValue(startValue, "start"), endPos = this.calculatePosByValue(endValue, range ? "end" : "start"), track = graphic_creator_1.graphicCreator.rect(Object.assign({
    ...
    _renderHandler(style) {
        return graphic_creator_1.graphicCreator.symbol(style);
    }
    _renderHandlerText(value, position) {
        return graphic_creator_1.graphicCreator.text(this._getHandlerTextAttributes(value, position));
    }
    ...
    _renderTooltip() {
        ...
        if (tooltip && tooltip.shape) {
            const shape = graphic_creator_1.graphicCreator.symbol(Object.assign({
                pickable: !1,
        ...
        const text = graphic_creator_1.graphicCreator.text(Object.assign(Object.assign({}, textStyle), textConfig.style));
