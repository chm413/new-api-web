...
class Tooltip extends base_1.AbstractComponent {
    ...
    render() {
        ...
        if (this._tooltipContent = this.createOrUpdateChild("tooltip-content", {
            ...
            content.forEach(((item, i) => {
                ...
                keyGraphic && ((0, text_2.alignTextInLine)(align, keyGraphic, itemAttr.key.textAlign, x, keyWidth), 
                ...
                if (valueGraphic) {
                    ...
                    (0, text_2.alignTextInLine)(align, valueGraphic, textAlign, x, valueWidth), valueGraphic.setAttribute("y", 0);
                }
    ...
    _createShape(x, itemAttr, itemGroup, itemGroupName) {
        ...
        if ((0, util_1.isVisible)(itemAttr.shape)) return itemGroup.createOrUpdateChild(`${itemGroupName}-shape`, Object.assign({
            visible: !0,
            x: x,
            y: itemAttr.shape.size / 2 + ((null !== (_a = (0, text_1.calculateLineHeight)(itemAttr.key.lineHeight, itemAttr.key.fontSize)) && void 0 !== _a ? _a : itemAttr.key.fontSize) - itemAttr.shape.size) / 2
    ...
    static measureTooltip(attribute) {
        ...
        if ((0, vutils_1.isValid)(titleValue) && "object" != typeof titleAttr.value.text) {
            const {width: width, height: height} = (0, text_2.initTextMeasure)(titleValue).quickMeasure(titleValue.text);
        ...
        content && content.length) {
            ...
            if (content.forEach(((item, i) => {
                ...
                filteredContent.forEach((([item, itemAttr], i) => {
                    ...
                    text_2.initTextMeasure)(key), valueTextMeasure = (0, text_2.initTextMeasure)(value);
                    let itemHeight = 0;
