...
class LabelBase extends animate_component_1.AnimateComponent {
    ...
    _createLabelLine(text, baseMark) {
        ...
        if (points) {
            const lineGraphic = graphic_creator_1.graphicCreator.line({
                points: points
    ...
    _runUpdateAnimation(prevLabel, currentLabel) {
        ...
        (0, static_truth_1.commitUpdateAnimationTarget)(prevText, null == curText ? void 0 : curText.attribute), 
        (0, static_truth_1.commitUpdateAnimationTarget)(prevLabelLine, null == curLabelLine ? void 0 : curLabelLine.attribute), 
    ...
    _updateLabel(prevLabel, currentLabel) {
        const {labelLine: prevLabelLine} = prevLabel, {text: curText, labelLine: curLabelLine} = currentLabel;
