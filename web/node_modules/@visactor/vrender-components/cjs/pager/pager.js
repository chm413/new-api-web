...
const graphic_creator_1 = require("../util/graphic-creator"), vutils_1 = require("@visactor/vutils"), base_1 = require("../core/base"), util_1 = require("../util"), register_1 = require("./register"), DEFAULT_HANDLER_STYLE = {
    space: 8,
    style: {
        fill: "rgb(47, 69, 84)",
        cursor: "pointer",
...
class Pager extends base_1.AbstractComponent {
    ...
    render() {
        ...
        const parsedPadding = (0, vutils_1.normalizePadding)(padding), isHorizontal = "horizontal" === layout, container = graphic_creator_1.graphicCreator.group({
            x: 0,
            y: 0
        ...
        const preHandler = graphic_creator_1.graphicCreator.symbol(Object.assign(Object.assign({
        ...
        vutils_1.isNumber)(handlerSize) ? handlerSize : handlerSize[1], text = graphic_creator_1.graphicCreator.text(Object.assign({
        ...
        const nextHandler = graphic_creator_1.graphicCreator.symbol(Object.assign(Object.assign({
            strokeBoundsBuffer: 0,
            pickMode: "imprecise"
        }, handlerStyle), {
