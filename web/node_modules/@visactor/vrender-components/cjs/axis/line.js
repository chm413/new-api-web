...
class LineAxis extends base_1.AxisBase {
    ...
    _renderInner(container) {
        ...
        super._renderInner(container), this._breaks && this._breaks.length && this._breaks.forEach(((b, index) => {
            ...
            if (!1 !== (null == breakSymbol ? void 0 : breakSymbol.visible)) {
                const axisBreakGroup = graphic_creator_1.graphicCreator.group({
                ...
                const symbolStyle = (0, util_2.getAxisBreakSymbolAttrs)(breakSymbol), shape1 = graphic_creator_1.graphicCreator.symbol(Object.assign({
                    x: startPoint.x,
                    y: startPoint.y
                }, symbolStyle));
                shape1.name = constant_1.AXIS_ELEMENT_NAME.axisBreakSymbol;
                const shape2 = graphic_creator_1.graphicCreator.symbol(Object.assign({
                    x: endPoint.x,
                    y: endPoint.y
                }, symbolStyle));
        ...
        if (panel && panel.visible) {
            const axisContainer = this.axisContainer, axisContainerBounds = axisContainer.AABBBounds, bgRect = graphic_creator_1.graphicCreator.rect(Object.assign({
    ...
    afterLabelsOverlap(labelShapes, labelData, labelContainer, layer, layerCount) {
        ...
        if ((0, vutils_1.isValidNumber)(verticalMinSize) && (!(0, vutils_1.isValidNumber)(verticalLimitSize) || verticalMinSize <= verticalLimitSize)) {
            ...
            const bgRect = graphic_creator_1.graphicCreator.rect({
                x: x,
                y: y,
