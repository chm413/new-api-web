...
const vutils_1 = require("@visactor/vutils"), graphic_creator_1 = require("../../util/graphic-creator"), base_1 = require("../../core/base"), constant_1 = require("../constant"), util_1 = require("../util");
...
class BaseGrid extends base_1.AbstractComponent {
    ...
    _renderGridByType(isSubGrid, container) {
        ...
        if (items.forEach(((item, index) => {
            ...
            const shape = graphic_creator_1.graphicCreator.path(Object.assign({
                path: path,
                z: depth
            ...
            vutils_1.abs)(nextPoints[0].y - nextPoints[1].y), shape = graphic_creator_1.graphicCreator.path(Object.assign({
                path: path,
                z: 0,
            ...
            for (let index = 0; index < allPoints.length - 1; index++) {
                const path = getRegionPath(allPoints[index], allPoints[index + 1], gridAttrs), shape = graphic_creator_1.graphicCreator.path({
                    path: path,
                    fill: getColor(index)
                });
