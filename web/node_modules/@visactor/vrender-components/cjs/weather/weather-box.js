...
const base_1 = require("../core/base"), vutils_1 = require("@visactor/vutils"), animate_1 = require("@visactor/vrender-animate/animate"), timeline_1 = require("@visactor/vrender-animate/timeline");
...
class WeatherBox extends base_1.AbstractComponent {
    constructor(attributes, options) {
        ...
        this.name = "weatherBox", this.timeline = null !== (_a = null == options ? void 0 : options.timeline) && void 0 !== _a ? _a : new timeline_1.DefaultTimeline;
    }
    render() {
    ...
    generateWind(windRatio, windIconPath, group, size, speed) {
        ...
        new animate_1.Animate(void 0, this.timeline).bind(wind).to(fromAttribute, duration, "linear").to(toAttribute, duration, "linear").wait(duration / 2).loop(1 / 0);
    }
    generateRainOrSnow(type, ratio, threshold, windRatio, group, path, windAngle, sizeRange, speed) {
        ...
        for (let i = 0; i < maxCount; i++) {
            ...
            new animate_1.Animate(void 0, this.timeline).bind(particle).to({
                x: endX,
                y: height - snowRainBottomPadding
            }, duration, "linear").loop(1 / 0), new animate_1.Animate(void 0, this.timeline).bind(particle).to({
                opacity: 0
