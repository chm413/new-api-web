...
const constant_1 = require("@visactor/vrender-core/event/constant"), group_1 = require("@visactor/vrender-core/graphic/group"), vutils_1 = require("@visactor/vutils"), GROUP_ATTRIBUTES = [ "x", "y", "dx", "dy", "scaleX", "scaleY", "angle", "anchor", "postMatrix", "visible", "clip", "pickable", "childrenPickable", "zIndex", "cursor" ];

class AbstractComponent extends group_1.Group {
    constructor(attributes, options) {
        ...
        }), this.attribute = attributes, this.onSetStage(((_, stage) => {
            stage && (this.render(), this.bindEvents());
        }));
    }
    ...
    _dispatchEvent(eventName, details) {
        var _a;
        const changeEvent = new constant_1.CustomEvent(eventName, details);
