import { type IGraphic, type IGroup, MarkPoint } from '@visactor/vchart';
import type { Maybe } from '@visactor/vchart';
import { LayoutZIndex, VChart, BaseComponent } from '@visactor/vchart';
import type { IPoint, Datum, IModelSpecInfo, PanEventParam, ICartesianSeries, IGeoSeries } from '@visactor/vchart';
...
export declare class MapLabelComponent extends BaseComponent<IMapLabelSpec> {
    ...
    protected _evaluateMarker(data: Datum, index: number): {
        pairInfo: IPairInfo;
        contentMarks: Partial<Record<import("./type").IMapLabelNodes, IGraphic<Partial<import("@visactor/vrender-core/es/interface").IGraphicAttribute>>>>;
    };
