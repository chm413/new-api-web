...
function appendScatterRegressionLineConfig(chartSpec, spec) {
    var _a;
    if (!spec) {
        const seriesSpecs = Array.isArray(chartSpec.series) ? chartSpec.series : chartSpec.series ? [ chartSpec.series ] : [];
        spec = null !== (_a = (0, vchart_1.get)(chartSpec, regression_line_1.REGRESSION_LINE)) && void 0 !== _a ? _a : (0, 
        vchart_1.get)(seriesSpecs.find((s => s.type === vchart_2.SeriesTypeEnum.scatter)), regression_line_1.REGRESSION_LINE);
    }
