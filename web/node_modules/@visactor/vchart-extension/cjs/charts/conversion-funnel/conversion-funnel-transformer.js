...
class ConversionFunnelChartSpecTransformer extends vchart_1.FunnelChartSpecTransformer {
    transformSpec(spec) {
        ...
        if (conversionArrow && conversionArrow.arrows && conversionArrow.arrows.length) {
            const marks = addArrowMark(conversionArrow, null === (_c = null === (_b = null === (_a = this._option) || void 0 === _a ? void 0 : _a.getTheme) || void 0 === _b ? void 0 : _b.call(_a, "series", "funnel")) || void 0 === _c ? void 0 : _c.conversionArrow);
...
function addArrowMark(arrowSpec, theme) {
    const {arrows: arrows} = arrowSpec, style = __rest(arrowSpec, [ "arrows" ]), leftArrows = arrows.filter((arrow => "left" === arrow.position)), rightGroup = computeArrows(arrows.filter((arrow => "right" === arrow.position)), style, theme), leftGroup = computeArrows(leftArrows, style, theme), result = [];
...
function computeArrows(arrows, style, theme) {
    var _a, _b, _c;
    ...
    const {line: line, symbol: symbol, text: text, margin: margin} = style, result = [], rootGroup = {
        ...
        children: []
    }, lineMark = generateArrowLineSpec(line, margin, null === (_a = null == theme ? void 0 : theme.line) || void 0 === _a ? void 0 : _a.style);
    lineMark && result.push(lineMark);
    const arrowMark = generateArrowSymbolSpec(symbol, margin, null === (_b = null == theme ? void 0 : theme.symbol) || void 0 === _b ? void 0 : _b.style);
    arrowMark && result.push(arrowMark);
    const textMark = generateArrowTextSpec(text, margin, null === (_c = null == theme ? void 0 : theme.text) || void 0 === _c ? void 0 : _c.style);
...
function generateArrowLineSpec(line = {}, margin, themeStyle = {}) {
    ...
    return Object.assign(Object.assign({
        ...
        style: Object.assign(Object.assign(Object.assign(Object.assign({}, constants_1.DEFAULT_ARROW_MARK_STYLE), themeStyle), style), {
...
function generateArrowSymbolSpec(symbol = {}, margin, themeStyle = {}) {
    ...
    return Object.assign(Object.assign({
        ...
        style: Object.assign(Object.assign(Object.assign(Object.assign({}, constants_1.DEFAULT_ARROW_SYMBOL_MARK_STYLE), themeStyle), style), {
            x: (arrow, ctx) => {
                var _a, _b;
                let points = arrow.layout.points;
...
function generateArrowTextSpec(text = {}, margin, themeStyle = {}) {
    ...
    return Object.assign(Object.assign({
        ...
        style: Object.assign(Object.assign(Object.assign(Object.assign({}, constants_1.DEFAULT_ARROW_TEXT_MARK_STYLE), themeStyle), {
            text: (arrow, ctx) => {
