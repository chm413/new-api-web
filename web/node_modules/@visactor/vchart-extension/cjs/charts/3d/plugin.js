...
const vrender_core_1 = require("@visactor/vrender-core"), base_plugin_1 = require("@visactor/vchart/esm/plugin/base/base-plugin"), register_1 = require("@visactor/vchart/esm/plugin/chart/register"), util_1 = require("./util");

class VChart3dPlugin extends base_plugin_1.BasePlugin {
    constructor() {
...
const register3DPlugin = () => {
    (0, register_1.registerChartPlugin)(VChart3dPlugin), (0, vrender_core_1.registerDirectionalLight)(), 
