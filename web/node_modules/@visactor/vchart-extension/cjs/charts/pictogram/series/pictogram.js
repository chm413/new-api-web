...
class PictogramSeries extends vchart_4.GeoSeries {
    ...
    initMarkStyle() {
        ...
        }, "normal", vchart_4.AttributeLevel.Built_In), svgViewportRect && this._pictogramMark.setMarkConfig({
            clip: !0,
            clipPath: [ (0, vchart_3.createRect)(Object.assign(Object.assign({}, svgViewportRect), {
                fill: !0
            })) ]
        }));
    ...
    _getSvgRootMatrix() {
        ...
        return transform ? new vchart_2.Matrix(transform.a, transform.b, transform.c, transform.d, transform.e, transform.f) : new vchart_2.Matrix;
    }
    _getSvgViewportRect() {
        var _a, _b, _c, _d;
        ...
        return Number.isFinite(width) && Number.isFinite(height) && width > 0 && height > 0 ? {
            ...
            width: width,
            height: height
        } : null !== (_d = null === (_c = this._parsedSvgResult) || void 0 === _c ? void 0 : _c[svg_source_1.SVG_VIEWPORT_RECT_KEY]) && void 0 !== _d ? _d : null;
    }
    _getSvgRootBounds(rootMatrix) {
        const viewBoxRect = this._getSvgViewportRect();
        if (!viewBoxRect) return null;
        const bounds = (new vchart_2.Bounds).setValue(viewBoxRect.x, viewBoxRect.y, viewBoxRect.x + viewBoxRect.width, viewBoxRect.y + viewBoxRect.height);
        return bounds.transformWithMatrix(rootMatrix), bounds;
    }
    _appendMatrixScale(matrix, scale, center) {
        const nextMatrix = new vchart_2.Matrix;
