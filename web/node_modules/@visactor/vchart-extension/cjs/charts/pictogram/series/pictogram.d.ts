import { type SVGParsedElement } from '@visactor/vchart';
import type { IPictogramSeriesSpec } from './interface';
import { type SVGParserResultWithViewport } from './svg-source';
...
export declare class PictogramSeries<T extends IPictogramSeriesSpec = IPictogramSeriesSpec> extends GeoSeries<T> {
    ...
    private _getSvgRootBounds;
    private _appendMatrixScale;
    private _appendMatrixTranslate;
