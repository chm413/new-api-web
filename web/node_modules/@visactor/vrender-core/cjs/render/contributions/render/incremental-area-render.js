...
const constants_1 = require("../../../graphic/constants"), theme_1 = require("../../../graphic/theme"), utils_1 = require("./utils"), area_render_1 = require("./area-render"), render_curve_1 = require("../../../common/render-curve");

class DefaultIncrementalCanvasAreaRender extends area_render_1.DefaultCanvasAreaRender {
    constructor() {
