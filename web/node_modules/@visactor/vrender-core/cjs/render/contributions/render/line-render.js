...
const vutils_1 = require("@visactor/vutils"), theme_1 = require("../../../graphic/theme"), constants_1 = require("../../../graphic/constants"), base_render_1 = require("./base-render"), render_curve_1 = require("../../../common/render-curve"), segment_1 = require("../../../common/segment");

class DefaultCanvasLineRender extends base_render_1.BaseRender {
    constructor() {
