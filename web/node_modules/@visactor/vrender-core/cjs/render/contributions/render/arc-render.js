...
const vutils_1 = require("@visactor/vutils"), theme_1 = require("../../../graphic/theme"), utils_1 = require("../../../common/utils"), utils_2 = require("../render/utils"), utils_3 = require("./utils"), conical_gradient_1 = require("../../../canvas/conical-gradient"), constants_1 = require("../../../graphic/constants"), base_render_1 = require("./base-render"), contributions_1 = require("./contributions");

class DefaultCanvasArcRender extends base_render_1.BaseRender {
    constructor(graphicRenderContributions) {
        super(), this.graphicRenderContributions = graphicRenderContributions, this.numberType = constants_1.ARC_NUMBER_TYPE, 
