...
const sort_1 = require("../../../common/sort"), config_1 = require("../../../graphic/config"), vutils_1 = require("@visactor/vutils"), canvas_utils_1 = require("../../../common/canvas-utils"), bounds_allocate_1 = require("../../../allocator/bounds-allocate"), matrix_allocate_1 = require("../../../allocator/matrix-allocate"), application_1 = require("../../../application"), base_contribution_render_1 = require("./contributions/base-contribution-render"), EMPTY_DRAW_ITEM_INTERCEPTOR_PROVIDER = {
    getContributions: () => []
};

function getIncrementalDrawContribution() {
    const factory = application_1.application.incrementalDrawContributionFactory;
    if (!factory) throw new Error("Incremental draw contribution factory is not configured.");
    return factory();
}

class DefaultDrawContribution {
    constructor(contributions = [], drawItemInterceptorContributions = EMPTY_DRAW_ITEM_INTERCEPTOR_PROVIDER, deps = {}) {
        ...
        this.layerService = null !== (_b = deps.layerService) && void 0 !== _b ? _b : application_1.application.layerService, 
        this.rendererRegistry = deps.rendererRegistry, this.contributions = null !== (_d = null === (_c = this.rendererRegistry) || void 0 === _c ? void 0 : _c.getAll()) && void 0 !== _d ? _d : this.contributions, 
        this.drawItemInterceptorContributions = null !== (_f = null !== (_e = deps.drawItemInterceptorContributions) && void 0 !== _e ? _e : this.drawItemInterceptorContributions) && void 0 !== _f ? _f : EMPTY_DRAW_ITEM_INTERCEPTOR_PROVIDER, 
        (0, vutils_1.isArray)(this.contributions) || (this.contributions = [ this.contributions ]), 
        this.init();
    }
    reInit() {
        this.defaultRenderMap.clear(), this.styleRenderMap.clear(), this.currentRenderMap.clear(), 
    ...
    init() {
        var _a, _b;
        const contributions = null !== (_b = null === (_a = this.rendererRegistry) || void 0 === _a ? void 0 : _a.getAll()) && void 0 !== _b ? _b : this.contributions;
        this.contributions = contributions, contributions.forEach((item => {
            if (item.style) {
    ...
    _increaseRender(group, drawContext) {
        ...
        const incrementalContext = incrementalLayer.layer.getNativeHandler().getContext(), idc = incrementalLayer.drawContribution || getIncrementalDrawContribution();
