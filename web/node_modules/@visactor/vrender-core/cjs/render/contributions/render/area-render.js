...
const vutils_1 = require("@visactor/vutils"), segment_1 = require("../../../common/segment"), theme_1 = require("../../../graphic/theme"), enums_1 = require("../../../common/enums"), render_area_1 = require("../../../common/render-area"), constants_1 = require("../../../graphic/constants"), render_curve_1 = require("../../../common/render-curve"), base_render_1 = require("./base-render"), area_contribution_render_1 = require("./contributions/area-contribution-render");

class DefaultCanvasAreaRender extends base_render_1.BaseRender {
    constructor(graphicRenderContributions) {
        super(), this.graphicRenderContributions = graphicRenderContributions, this.numberType = constants_1.AREA_NUMBER_TYPE, 
