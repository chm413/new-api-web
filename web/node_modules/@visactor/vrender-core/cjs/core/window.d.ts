import { type IBoundsLike, type IPointLike } from '@visactor/vutils';
...
export declare class DefaultWindow extends EventListenerManager implements IWindow {
    ...
    global: IGlobal;
    get dpr(): number;
    constructor(vRenderGlobal?: IGlobal, handlerFactory?: IWindowHandlerFactory);
    ...
    getViewBox(): import("@visactor/vutils").IBounds;
    getViewBoxTransform(): import("@visactor/vutils").IMatrix;
