...
const tapable_1 = require("../tapable"), generator_1 = require("../common/generator"), performance_raf_1 = require("../common/performance-raf"), event_listener_manager_1 = require("../common/event-listener-manager"), defaultEnv = "browser";

class DefaultGlobal extends event_listener_manager_1.EventListenerManager {
    get env() {
        return this._env;
    }
    ...
    getSpecifiedPerformanceRAF(id) {
        return this._env || this.setEnv("browser"), this._performanceRAFList[id] || (this._performanceRAFList[id] = new performance_raf_1.PerformanceRAF), 
        this._performanceRAFList[id];
    }
