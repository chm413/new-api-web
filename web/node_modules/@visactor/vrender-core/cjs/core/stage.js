...
const vutils_1 = require("@visactor/vutils"), window_1 = require("./window"), event_1 = require("../event"), group_1 = require("../graphic/group"), theme_1 = require("../graphic/theme"), global_picker_service_1 = require("../picker/global-picker-service"), render_service_1 = require("../render/render-service"), plugin_service_1 = require("../plugins/plugin-service"), auto_render_plugin_1 = require("../plugins/builtin-plugin/auto-render-plugin"), auto_refresh_plugin_1 = require("../plugins/builtin-plugin/auto-refresh-plugin"), incremental_auto_render_plugin_1 = require("../plugins/builtin-plugin/incremental-auto-render-plugin"), dirty_bounds_plugin_1 = require("../plugins/builtin-plugin/dirty-bounds-plugin"), tapable_1 = require("../tapable"), application_1 = require("../application"), env_check_1 = require("../env-check"), factory_1 = require("../factory"), layer_service_1 = require("./layer-service"), graphic_service_1 = require("../graphic/graphic-service/graphic-service"), shared_state_scope_1 = require("../graphic/state/shared-state-scope"), shared_state_refresh_1 = require("../graphic/state/shared-state-refresh"), DefaultConfig = {
    WIDTH: 500,
    HEIGHT: 500,
    X: 0,
    Y: 0,
...
class Stage extends group_1.Group {
    ...
    constructor(params = {}, deps = {}) {
        ...
        super({}), this.tickedBeforeRender = !0, this._onVisibleChange = visible => {
            ...
            (null == pendingSharedRefresh ? void 0 : pendingSharedRefresh.size) && (0, shared_state_refresh_1.flushStageSharedStateRefresh)(this), 
        ...
        }, this.global = null !== (_a = deps.global) && void 0 !== _a ? _a : application_1.application.global, 
        !this.global.env && (0, env_check_1.isBrowserEnv)() && this.global.setEnv("browser"), 
        this.windowFactory = null !== (_d = null !== (_b = deps.windowFactory) && void 0 !== _b ? _b : application_1.application.windowFactory) && void 0 !== _d ? _d : () => new window_1.DefaultWindow(this.global), 
        this.pickerServiceFactory = null !== (_e = deps.pickerServiceFactory) && void 0 !== _e ? _e : deps.pickerService ? () => deps.pickerService : null !== (_f = application_1.application.pickerServiceFactory) && void 0 !== _f ? _f : () => new global_picker_service_1.DefaultGlobalPickerService, 
        this.window = null !== (_g = deps.window) && void 0 !== _g ? _g : this.windowFactory(), 
        this.renderService = null !== (_l = null !== (_k = null !== (_h = deps.renderService) && void 0 !== _h ? _h : null === (_j = application_1.application.renderServiceFactory) || void 0 === _j ? void 0 : _j.call(application_1.application)) && void 0 !== _k ? _k : application_1.application.renderService) && void 0 !== _l ? _l : new render_service_1.DefaultRenderService, 
        this.pluginService = null !== (_q = null !== (_p = null !== (_m = deps.pluginService) && void 0 !== _m ? _m : null === (_o = application_1.application.pluginServiceFactory) || void 0 === _o ? void 0 : _o.call(application_1.application)) && void 0 !== _p ? _p : application_1.application.pluginService) && void 0 !== _q ? _q : new plugin_service_1.DefaultPluginService, 
        this.layerService = null !== (_s = null !== (_r = deps.layerService) && void 0 !== _r ? _r : application_1.application.layerService) && void 0 !== _s ? _s : new layer_service_1.DefaultLayerService(this.global), 
        this.graphicService = null !== (_u = null !== (_t = deps.graphicService) && void 0 !== _t ? _t : application_1.application.graphicService) && void 0 !== _u ? _u : new graphic_service_1.DefaultGraphicService, 
        this.pickerService = deps.pickerService, this.pluginService.active(this, params), 
        this._beforeRenderList = [], this._afterRenderList = [], this.window.create({
            ...
            canvasControled: null !== (_v = params.canvasControled) && void 0 !== _v ? _v : !params.canvas,
            title: params.title || "",
        ...
        this.stage = this, this.appendChild(this.layerService.createLayer(this, {
            ...
            rootScope && ((0, shared_state_scope_1.setRootSharedStateScopeThemeDefinitions)(rootScope, definitions), 
            (0, shared_state_refresh_1.markScopeActiveDescendantsDirty)(rootScope, this));
    ...
    ensureRootSharedStateScope(themeStateDefinitions) {
        ...
        this.rootSharedStateScope) : (this.rootSharedStateScope = (0, shared_state_scope_1.createRootSharedStateScope)(this, themeStateDefinitions), 
    ...
    renderToNewWindow(fullImage = !0, viewBox) {
        if ("released" === this.releaseStatus) return;
        const window = this.windowFactory(), x1 = viewBox ? -viewBox.x1 : 0, y1 = viewBox ? -viewBox.y1 : 0, x2 = viewBox ? viewBox.x2 : this.viewWidth, y2 = viewBox ? viewBox.y2 : this.viewHeight, width = viewBox ? viewBox.width() : this.viewWidth, height = viewBox ? viewBox.height() : this.viewHeight;
    ...
    getPickerService() {
        return this.pickerService || (this.pickerService = this.pickerServiceFactory()), 
        this.pickerService;
    }
    reInit() {
