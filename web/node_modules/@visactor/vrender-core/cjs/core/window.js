...
const vutils_1 = require("@visactor/vutils"), generator_1 = require("../common/generator"), tapable_1 = require("../tapable"), application_1 = require("../application"), event_listener_manager_1 = require("../common/event-listener-manager");

function defaultWindowHandlerFactory(env) {
    const handlerFactory = application_1.application.windowHandlerFactory;
    if (!handlerFactory) throw new Error("Window handler factory is not configured.");
...
class DefaultWindow extends event_listener_manager_1.EventListenerManager {
    get width() {
        if (this._handler) {
    ...
    constructor(vRenderGlobal = application_1.application.global, handlerFactory = defaultWindowHandlerFactory) {
        ...
        }, this._uid = generator_1.Generator.GenAutoIncrementId(), this.global = vRenderGlobal, 
        this.postInit();
    }
