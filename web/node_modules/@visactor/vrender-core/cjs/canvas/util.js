...
const vutils_1 = require("@visactor/vutils"), path_svg_1 = require("../common/path-svg"), application_1 = require("../application");

function resolveCanvasFactory() {
    var _c, _d;
    const env = null === (_c = application_1.application.global) || void 0 === _c ? void 0 : _c.env, factory = env ? null === (_d = application_1.application.canvasFactory) || void 0 === _d ? void 0 : _d.call(application_1.application, env) : void 0;
    if (!factory) throw new Error(`CanvasFactory is not configured for env "${null != env ? env : "unknown"}"`);
    return factory;
}

function resolveContext2dFactory() {
    var _c, _d;
    const env = null === (_c = application_1.application.global) || void 0 === _c ? void 0 : _c.env, factory = env ? null === (_d = application_1.application.context2dFactory) || void 0 === _d ? void 0 : _d.call(application_1.application, env) : void 0;
    if (!factory) throw new Error(`Context2dFactory is not configured for env "${null != env ? env : "unknown"}"`);
    return factory;
}
