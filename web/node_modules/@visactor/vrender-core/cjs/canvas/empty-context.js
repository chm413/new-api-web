...
const vutils_1 = require("@visactor/vutils"), util_1 = require("./util"), custom_path2d_1 = require("../common/custom-path2d"), canvas_utils_1 = require("../common/canvas-utils"), matrix_allocate_1 = require("../allocator/matrix-allocate"), initMatrix = new vutils_1.Matrix(1, 0, 0, 1, 0, 0), globalPoint = {
    x: 0,
    y: 0
};

class EmptyContext2d {
    get nativeContext() {
        return this.path;
    }
