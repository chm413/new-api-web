import type { IGlobal, IGraphicService, ILayer, ILayerParams, IPickerService, IPluginService, IRenderService, IStage, IStageParams, IWindow } from '../interface';
...
export type IStageConstructor<TStage extends IStage = IStage> = new (params: Partial<IStageParams>, deps?: IStageFactoryDeps) => TStage;
...
export type ILayerConstructor<TLayer extends ILayer = ILayer> = new (stage: IStage, global: IGlobal, window: IWindow, params: ILayerParams) => TLayer;
export interface ILayerFactory<TLayer extends ILayer = ILayer> {
    create: (params: ILayerFactoryCreateParams) => TLayer;
}
export type IGraphicConstructor<TGraphic extends IGraphic = IGraphic, TAttributes extends Partial<IGraphicAttribute> = Partial<IGraphicAttribute>> = new (attributes: TAttributes) => TGraphic;
