...
const vutils_1 = require("@visactor/vutils"), sort_1 = require("../common/sort"), theme_1 = require("../graphic/theme"), config_1 = require("../graphic/config"), matrix_1 = require("../common/matrix"), matrix_allocate_1 = require("../allocator/matrix-allocate"), application_1 = require("../application"), EMPTY_PICK_ITEM_INTERCEPTOR_PROVIDER = {
    getContributions: () => []
...
class DefaultPickService {
    constructor(pickItemInterceptorContributions = EMPTY_PICK_ITEM_INTERCEPTOR_PROVIDER, pickServiceInterceptorContributions = EMPTY_PICK_SERVICE_INTERCEPTOR_PROVIDER, deps = {}) {
        ...
        this.type = "default", this.global = null !== (_a = deps.global) && void 0 !== _a ? _a : application_1.application.global, 
