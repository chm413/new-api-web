...
class DefaultGraphicService {
    constructor(creator = graphic_creator_1.graphicCreator) {
    ...
    updateTempAABBBounds(aabbBounds) {
        ...
        tb2.setValue(aabbBounds.x1, aabbBounds.y1, aabbBounds.x2, aabbBounds.y2), this.tempAABBBoundsResult;
    }
}
