...
class Arc extends graphic_1.Graphic {
    ...
    getParsedAngle() {
        ...
        if (deltaAngle *= Math.max(0, Math.min(clipRange, 1)), startAngle = (0, vutils_1.clampAngleByRadian)(startAngle), 
        endAngle = startAngle + deltaAngle, cap && (0, vutils_1.abs)(deltaAngle) > vutils_1.epsilon && (0, 
        vutils_1.abs)(deltaAngle) < vutils_1.pi2 - vutils_1.epsilon) {
