...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.xul = exports.verticalLayout = exports.TextDirection = exports.genNumberType = exports.boundStroke = exports.waitForAllSubLayers = exports.incrementalAddTo = void 0;

const application_1 = require("../application"), xml_1 = require("../common/xml"), vutils_1 = require("@visactor/vutils");
...
exports.genNumberType = genNumberType, function(TextDirection) {
    TextDirection[TextDirection.HORIZONTAL = 0] = "HORIZONTAL", TextDirection[TextDirection.VERTICAL = 1] = "VERTICAL";
}(TextDirection = exports.TextDirection || (exports.TextDirection = {})), exports.verticalLayout = verticalLayout;
...
function xul(str) {
    const xmlStr = (0, vutils_1.isArray)(str) ? str[0] : str, config = [];
    if (!xmlStr) return config;
    if (!0 === (0, xml_1.isXML)(xmlStr)) {
        const data = (new xml_1.XMLParser).parse(xmlStr);
...
noRotateCharList.forEach((c => noRotateCharMap.set(c, !0))), exports.xul = xul;
