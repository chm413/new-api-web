...
export declare class DefaultCanvasStarRender extends BaseRender<IStar> implements IGraphicRender {
    protected readonly graphicRenderContributions: IContributionProvider<IStarRenderContribution>;
    type: 'star';
    numberType: number;
    constructor(graphicRenderContributions: IContributionProvider<IStarRenderContribution>);
