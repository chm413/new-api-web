...
import { type IBounds, type IMatrix } from '@visactor/vutils';
...
export declare class DefaultDrawContribution implements IDrawContribution {
    ...
    constructor(contributions?: IGraphicRender[], drawItemInterceptorContributions?: IContributionProvider<IDrawItemInterceptorContribution>, deps?: IDrawContributionDeps);
    reInit(): void;
    init(): void;
