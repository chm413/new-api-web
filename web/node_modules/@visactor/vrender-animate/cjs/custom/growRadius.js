...
const custom_animate_1 = require("./custom-animate"), vutils_1 = require("@visactor/vutils"), transient_1 = require("./transient"), growRadiusInIndividual = (graphic, options, animationParameters) => {
...
class GrowRadiusIn extends GrowPointsBase {
    onBind() {
        ...
        !1 !== (null === (_c = this.params.controlOptions) || void 0 === _c ? void 0 : _c.immediatelyApply) && (0, 
        transient_1.applyAppearStartAttributes)(this.target, fromAttrs);
    }
}
