...
const vutils_1 = require("@visactor/vutils"), interpolate_1 = require("@visactor/vrender-core/interpolate"), custom_animate_1 = require("./custom-animate"), transient_1 = require("./transient"), static_truth_1 = require("./static-truth");
...
class TagPointsUpdate extends custom_animate_1.ACustomAnimate {
    ...
    onEnd(cb) {
        cb ? super.onEnd(cb) : (this.to && (0, static_truth_1.commitAnimationStaticAttrs)(this.target, Object.keys(this.to), this.animate, this.to), 
        super.onEnd());
    }
    applyPointTransientAttributes(attributes) {
        ...
        })), Object.keys(validAttrs).length && ((0, transient_1.applyAnimationFrameAttributes)(this.target, validAttrs), 
    ...
    onUpdate(end, ratio, out) {
        if (end) this.applyPointTransientAttributes(this.to); else {
            if (this.points = this.points.map(((point, index) => {
                const newPoint = (0, interpolate_1.pointInterpolation)(this.interpolatePoints[index][0], this.interpolatePoints[index][1], ratio);
