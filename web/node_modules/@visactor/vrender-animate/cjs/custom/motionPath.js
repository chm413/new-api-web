...
class MotionPath extends custom_animate_1.ACustomAnimate {
    constructor(from, to, duration, easing, params) {
        ...
        this.commitOnEnd = null === (_c = null !== (_b = params.commitOnEnd) && void 0 !== _b ? _b : params.saveOnEnd) || void 0 === _c || _c, 
        this.cb = params.cb);
    }
    onBind() {
        this.from = {
    ...
    onUpdate(end, ratio, out) {
        ...
        this.cb && this.cb(this.from, this.to, ratio, this.target), end && this.commitOnEnd ? this.target.setAttributes(attrs) : ((0, 
        transient_1.applyAnimationFrameAttributes)(this.target, attrs), this.target.addUpdatePositionTag(), 
