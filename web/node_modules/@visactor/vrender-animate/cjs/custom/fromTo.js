...
const constant_1 = require("@visactor/vrender-core/event/constant"), custom_animate_1 = require("./custom-animate"), transient_1 = require("./transient");
...
class FromTo extends custom_animate_1.ACustomAnimate {
    ...
    applyTransientFromAttributes() {
        (0, transient_1.applyAnimationTransientAttributes)(this.target, this.from, constant_1.AttributeUpdateType.ANIMATE_START);
    }
    onBind() {
        var _a, _b, _c;
