...
const fade_1 = require("./fade"), interpolate_1 = require("@visactor/vrender-core/interpolate"), custom_animate_1 = require("./custom-animate"), animate_executor_1 = require("../executor/animate-executor"), transient_1 = require("./transient");
...
function applyStoryFrame(target, attrs) {
    (0, transient_1.applyAnimationFrameAttributes)(target, attrs), target.addUpdatePositionTag(), 
...
class SlideIn extends custom_animate_1.ACustomAnimate {
    ...
    onBind() {
        ...
        this.from = from, this.to = to, this.props = to, (0, transient_1.applyAppearStartAttributes)(this.target, from);
    }
...
class GrowIn extends custom_animate_1.ACustomAnimate {
    ...
    onBind() {
        ...
        (0, transient_1.applyAppearStartAttributes)(this.target, from);
    }
    onUpdate(end, ratio, out) {
        applyStoryFrame(this.target, buildInterpolatedAttrs(this.propKeys, this.from, this.to, ratio));
    }
...
class SpinIn extends custom_animate_1.ACustomAnimate {
    ...
    onBind() {
        ...
        this.to = to, this.props = to, (0, transient_1.applyAppearStartAttributes)(this.target, from);
    }
    onUpdate(end, ratio, out) {
        applyStoryFrame(this.target, buildInterpolatedAttrs(this.propKeys, this.from, this.to, ratio));
    }
...
class StrokeIn extends custom_animate_1.ACustomAnimate {
    ...
    onBind() {
        ...
        this.props = this.to, (0, transient_1.applyAppearStartAttributes)(this.target, this.from);
    }
    onUpdate(end, ratio, out) {
        var _a;
        const attrs = {
        ...
        (null === (_a = this.params) || void 0 === _a ? void 0 : _a.showFill) && (attrs.fillOpacity = this.from.fillOpacity + (this.to.fillOpacity - this.from.fillOpacity) * ratio), 
        (0, transient_1.applyAnimationTransientAttributes)(this.target, attrs);
    }
    onEnd() {
        var _a;
...
class PulseAnimate extends custom_animate_1.ACustomAnimate {
    ...
    onUpdate(end, ratio, out) {
        const angle = ratio * Math.PI * this.pulseCount, pulseValue = Math.abs(Math.sin(angle)), attrs = {};
        if (this.useOpacity) {
            const opacity = 1 + (this.pulseOpacity - 1) * pulseValue;
            this.useStroke && (attrs.strokeOpacity = (this.originalAttributes.strokeOpacity || 1) * opacity), 
            this.useFill && (attrs.fillOpacity = (this.originalAttributes.fillOpacity || 1) * opacity);
        }
        if (this.useScale) {
        ...
        this.useColor && this.pulseColor && this.applyColorPulse(attrs, pulseValue), (0, 
        transient_1.applyAnimationFrameAttributes)(this.target, attrs), this.target.addUpdateShapeAndBoundsTag(), 
        this.target.addUpdatePositionTag();
    }
    applyColorPulse(attrs, pulseValue) {
        const colorRatio = this.pulseColorIntensity * pulseValue;
        this.useFill && this.originalFill && this.pulseColor && (attrs.fill = (0, interpolate_1.interpolateColor)(this.originalFill, this.pulseColor, colorRatio, !0)), 
        this.useStroke && this.originalStroke && this.pulseColor && (attrs.stroke = (0, 
        interpolate_1.interpolateColor)(this.originalStroke, this.pulseColor, colorRatio, !0));
    }
    onEnd() {
