...
const vutils_1 = require("@visactor/vutils"), custom_animate_1 = require("./custom-animate"), transient_1 = require("./transient"), rotateIn = (graphic, options) => {
    var _a;
...
class RotateIn extends RotateBase {
    onBind() {
        ...
        this.props = to, this.propKeys = [ "angle" ], this.from = from, this.to = to, this.target.applyFinalAttributeToAttribute(), 
        !1 !== (null === (_a = this.params.controlOptions) || void 0 === _a ? void 0 : _a.immediatelyApply) && (0, 
