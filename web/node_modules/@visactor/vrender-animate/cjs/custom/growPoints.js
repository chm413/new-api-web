...
const vrender_core_1 = require("@visactor/vrender-core"), vutils_1 = require("@visactor/vutils"), custom_animate_1 = require("./custom-animate"), transient_1 = require("./transient"), getCenterPoints = (graphic, options, animationParameters) => {
...
class GworPointsBase extends custom_animate_1.ACustomAnimate {
    ...
    onUpdate(end, ratio, out) {
        ...
        fromPoints && toPoints && ((0, transient_1.applyAnimationFrameAttributes)(this.target, {
            points: fromPoints.map(((point, index) => (0, vrender_core_1.pointInterpolation)(fromPoints[index], toPoints[index], ratio)))
...
class GrowPointsIn extends GworPointsBase {
    onBind() {
        ...
        if (super.onBind(), [ "area", "line", "polygon" ].includes(this.target.type)) {
            ...
            this.from = from, this.to = to, this.target.applyFinalAttributeToAttribute(), !1 !== (null === (_a = this.params.controlOptions) || void 0 === _a ? void 0 : _a.immediatelyApply) && (0, 
