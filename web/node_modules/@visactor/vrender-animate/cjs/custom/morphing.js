...
const vrender_core_1 = require("@visactor/vrender-core"), vutils_1 = require("@visactor/vutils"), custom_animate_1 = require("./custom-animate"), morphing_1 = require("../config/morphing"), transform_1 = require("../utils/transform"), transient_1 = require("./transient"), interpolateOtherAttrs = (attrs, out, ratio) => {
    attrs.forEach((entry => {
...
class MorphingPath extends custom_animate_1.ACustomAnimate {
    ...
    onUpdate(end, ratio, out) {
        ...
        end && this.saveOnEnd ? this.target.setAttributes(out) : (0, transient_1.applyAnimationTransientAttributes)(this.target, out), 
