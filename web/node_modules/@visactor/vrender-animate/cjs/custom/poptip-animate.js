...
const custom_animate_1 = require("./custom-animate"), component_1 = require("../component"), input_text_1 = require("./input-text"), transient_1 = require("./transient");
...
class PoptipAppear extends custom_animate_1.AComponentAnimate {
    onBind() {
        ...
        if ((0, transient_1.applyAppearStartAttributes)(target, {
            scaleX: 0,
            scaleY: 0
