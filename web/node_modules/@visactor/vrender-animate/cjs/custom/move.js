...
const vutils_1 = require("@visactor/vutils"), custom_animate_1 = require("./custom-animate"), transient_1 = require("./transient"), moveIn = (graphic, options, animationParameters) => {
    var _a, _b, _c, _d;
