...
const vrender_core_1 = require("@visactor/vrender-core"), custom_animate_1 = require("./custom-animate"), transient_1 = require("./transient");
...
class ClipGraphicAnimate extends custom_animate_1.ACustomAnimate {
    ...
    onBind() {
        ...
        this._lastPath = this._group.attribute.path, (0, transient_1.applyAppearStartAttributes)(this._group, {
            clip: !0,
