...
const interpolate_1 = require("@visactor/vrender-core/interpolate"), number_1 = require("./number");
...
class InterpolateUpdateStore {
    constructor() {
        this.opacity = (key, from, to, ratio, step, target) => {
            ...
            target.attribute.fill = (0, interpolate_1.interpolateColor)(from, to, ratio, !1);
        }, this.fillPure = (key, from, to, ratio, step, target) => {
            target.attribute.fill = step.fromParsedProps.fill ? (0, interpolate_1.interpolatePureColorArrayToStr)(step.fromParsedProps.fill, step.toParsedProps.fill, ratio) : step.toParsedProps.fill;
        }, this.stroke = (key, from, to, ratio, step, target) => {
            target.attribute.stroke = (0, interpolate_1.interpolateColor)(from, to, ratio, !1);
        }, this.strokePure = (key, from, to, ratio, step, target) => {
            target.attribute.stroke = step.fromParsedProps.stroke ? (0, interpolate_1.interpolatePureColorArrayToStr)(step.fromParsedProps.stroke, step.toParsedProps.stroke, ratio) : step.toParsedProps.stroke;
            ...
            target.attribute.points = (0, interpolate_1.pointsInterpolation)(from, to, ratio), 
            target.addUpdateBoundTag();
        };
    }
}
