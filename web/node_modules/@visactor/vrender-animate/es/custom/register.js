...
export const registerCustomAnimate = () => {
    registerBasicCustomAnimate(), AnimateExecutor.registerBuiltInAnimate("labelItemAppear", LabelItemAppear), 
    ...
    registerRichTextCustomAnimate(), registerStoryCustomAnimate(), registerDisappearCustomAnimate();
};
...
export { MotionPath, SlideIn, GrowIn, SpinIn, MoveScaleIn, MoveRotateIn, SlideOut, GrowOut, SpinOut, MoveScaleOut, MoveRotateOut, StrokeIn, StrokeOut, PulseAnimate, StreamLight } from "./register-story";
