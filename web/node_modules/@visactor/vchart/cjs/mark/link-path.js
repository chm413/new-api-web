...
const factory_1 = require("./../core/factory"), glyph_1 = require("./glyph"), vrender_core_1 = require("@visactor/vrender-core"), register_path_1 = require("@visactor/vrender-kits/register/register-path"), getHorizontalPath = (options, ratio) => {
    var _a;
...
const registerLinkPathMark = () => {
    (0, glyph_1.registerGlyphMark)(), (0, register_path_1.registerPath)(), factory_1.Factory.registerGraphicComponent("path", (attrs => (0, 
