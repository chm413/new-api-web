...
const factory_1 = require("./../core/factory"), glyph_1 = require("./glyph"), vrender_bridge_1 = require("../vrender-bridge"), getHorizontalPath = (options, ratio) => {
    var _a;
...
const registerLinkPathMark = () => {
    (0, glyph_1.registerGlyphMark)(), (0, vrender_bridge_1.registerPath)(), factory_1.Factory.registerGraphicComponent("path", (attrs => (0, 
    vrender_bridge_1.createPath)(attrs))), factory_1.Factory.registerMark(LinkPathMark.type, LinkPathMark);
};
