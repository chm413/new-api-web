...
const factory_1 = require("./../core/factory"), debug_1 = require("../util/debug"), base_mark_1 = require("./base/base-mark"), interface_1 = require("./interface"), vrender_bridge_1 = require("../vrender-bridge"), vutils_1 = require("@visactor/vutils"), util_1 = require("../compile/util"), mark_1 = require("../util/mark");
...
class GroupMark extends base_mark_1.BaseMark {
    ...
    renderInner() {
        ...
        if (this._product.context.finalAttrs = newAttrs, this._product.context.diffState === interface_1.DiffState.update) {
            ...
            this._product.context.diffAttrs = diffAttrs, this.hasAnimationByState(this._product.context.animationState) || (hasAnimation ? (this._product.setAttributesAndPreventAnimate(diffAttrs), 
            this._commitPreventedAnimationStaticAttrs(this._product, diffAttrs)) : this._product.setAttributes(diffAttrs));
...
const registerGroupMark = () => {
    (0, vrender_bridge_1.registerShadowRoot)(), (0, vrender_bridge_1.registerGroup)(), 
