...
const factory_1 = require("./../core/factory"), base_mark_1 = require("./base/base-mark"), vrender_bridge_1 = require("../vrender-bridge"), vutils_1 = require("@visactor/vutils");
...
class TextMark extends base_mark_1.BaseMark {
    ...
    _createGraphic(attrs = {}) {
        ...
        vrender_bridge_1.createRichText)(attrs) : (0, vrender_bridge_1.createText)(attrs);
    }
}
...
const registerTextMark = () => {
    factory_1.Factory.registerMark(TextMark.type, TextMark), (0, vrender_bridge_1.registerShadowRoot)(), 
    (0, vrender_bridge_1.registerText)(), (0, vrender_bridge_1.registerRichtext)(), 
    factory_1.Factory.registerGraphicComponent("text", vrender_bridge_1.createText), 
    factory_1.Factory.registerGraphicComponent("richtext", vrender_bridge_1.createRichText);
};
