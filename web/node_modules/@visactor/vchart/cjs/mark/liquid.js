...
const factory_1 = require("./../core/factory"), glyph_1 = require("./glyph"), vrender_bridge_1 = require("../vrender-bridge");
...
const registerLiquidMark = () => {
    (0, glyph_1.registerGlyphMark)(), (0, vrender_bridge_1.registerArea)(), factory_1.Factory.registerMark(LiquidMark.type, LiquidMark), 
    factory_1.Factory.registerGraphicComponent("area", (attrs => (0, vrender_bridge_1.createArea)(attrs)));
};
