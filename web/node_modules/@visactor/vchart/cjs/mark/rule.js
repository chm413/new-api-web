...
const factory_1 = require("./../core/factory"), base_mark_1 = require("./base/base-mark"), register_line_1 = require("@visactor/vrender-kits/register/register-line"), register_shadowRoot_1 = require("@visactor/vrender-kits/register/register-shadowRoot"), vrender_core_1 = require("@visactor/vrender-core");
...
const registerRuleMark = () => {
    factory_1.Factory.registerMark(RuleMark.type, RuleMark), (0, register_shadowRoot_1.registerShadowRoot)(), 
    (0, register_line_1.registerLine)(), factory_1.Factory.registerGraphicComponent("line", vrender_core_1.createLine);
};
