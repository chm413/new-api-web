...
const factory_1 = require("./../core/factory"), base_mark_1 = require("./base/base-mark"), vrender_bridge_1 = require("../vrender-bridge");
...
class RuleMark extends base_mark_1.BaseMark {
    ...
    _createGraphic(attrs = {}) {
        return (0, vrender_bridge_1.createLine)(attrs);
    }
}
...
const registerRuleMark = () => {
    factory_1.Factory.registerMark(RuleMark.type, RuleMark), (0, vrender_bridge_1.registerShadowRoot)(), 
    (0, vrender_bridge_1.registerLine)(), factory_1.Factory.registerGraphicComponent("line", vrender_bridge_1.createLine);
};
