...
const factory_1 = require("./../core/factory"), glyph_1 = require("./glyph"), vrender_core_1 = require("@visactor/vrender-core"), vutils_1 = require("@visactor/vutils"), register_symbol_1 = require("@visactor/vrender-kits/register/register-symbol");
...
const registerRippleMark = () => {
    (0, glyph_1.registerGlyphMark)(), (0, register_symbol_1.registerSymbol)(), factory_1.Factory.registerMark(RippleMark.type, RippleMark), 
