...
const factory_1 = require("./../core/factory"), glyph_1 = require("./glyph"), vrender_bridge_1 = require("../vrender-bridge"), vutils_1 = require("@visactor/vutils");
...
const registerRippleMark = () => {
    (0, glyph_1.registerGlyphMark)(), (0, vrender_bridge_1.registerSymbol)(), factory_1.Factory.registerMark(RippleMark.type, RippleMark), 
    factory_1.Factory.registerGraphicComponent("symbol", (attrs => (0, vrender_bridge_1.createSymbol)(attrs)));
};
