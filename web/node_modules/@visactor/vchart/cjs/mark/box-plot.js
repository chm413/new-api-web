...
const factory_1 = require("./../core/factory"), vrender_bridge_1 = require("../vrender-bridge"), glyph_1 = require("./glyph"), vutils_1 = require("@visactor/vutils"), BAR_BOX_PLOT_CHANNELS = [ "x", "y", "minMaxWidth", "minMaxHeight", "q1q3Width", "q1q3Height", "q1", "q3", "min", "max", "median", "angle" ], BOX_PLOT_CHANNELS = [ "x", "y", "boxWidth", "boxHeight", "ruleWidth", "ruleHeight", "q1", "q3", "min", "max", "median", "angle" ];
...
const registerBoxPlotMark = () => {
    (0, glyph_1.registerGlyphMark)(), (0, vrender_bridge_1.registerLine)(), (0, vrender_bridge_1.registerRect)(), 
    factory_1.Factory.registerGraphicComponent("line", (attrs => (0, vrender_bridge_1.createLine)(attrs))), 
    factory_1.Factory.registerGraphicComponent("rect", (attrs => (0, vrender_bridge_1.createRect)(attrs))), 
