...
const factory_1 = require("./../core/factory"), vrender_core_1 = require("@visactor/vrender-core"), glyph_1 = require("./glyph"), vutils_1 = require("@visactor/vutils"), register_line_1 = require("@visactor/vrender-kits/register/register-line"), register_rect_1 = require("@visactor/vrender-kits/register/register-rect"), BAR_BOX_PLOT_CHANNELS = [ "x", "y", "minMaxWidth", "minMaxHeight", "q1q3Width", "q1q3Height", "q1", "q3", "min", "max", "median", "angle" ], BOX_PLOT_CHANNELS = [ "x", "y", "boxWidth", "boxHeight", "ruleWidth", "ruleHeight", "q1", "q3", "min", "max", "median", "angle" ];
...
const registerBoxPlotMark = () => {
    (0, glyph_1.registerGlyphMark)(), (0, register_line_1.registerLine)(), (0, register_rect_1.registerRect)(), 
