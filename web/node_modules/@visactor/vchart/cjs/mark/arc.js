...
const factory_1 = require("./../core/factory"), polar_1 = require("../constant/polar"), base_mark_1 = require("./base/base-mark"), config_1 = require("../animation/config"), vutils_1 = require("@visactor/vutils"), vrender_core_1 = require("@visactor/vrender-core"), label_1 = require("@visactor/vrender-components/label"), register_arc_1 = require("@visactor/vrender-kits/register/register-arc"), register_shadowRoot_1 = require("@visactor/vrender-kits/register/register-shadowRoot");
...
const registerArcMark = () => {
    (0, register_shadowRoot_1.registerShadowRoot)(), (0, register_arc_1.registerArc)(), 
    (0, label_1.registerArcDataLabel)(), (0, config_1.registerArcAnimation)(), factory_1.Factory.registerGraphicComponent("arc", vrender_core_1.createArc), 
