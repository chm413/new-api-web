...
const factory_1 = require("./../core/factory"), polar_1 = require("../constant/polar"), base_mark_1 = require("./base/base-mark"), config_1 = require("../animation/config"), vutils_1 = require("@visactor/vutils"), vrender_bridge_1 = require("../vrender-bridge"), label_1 = require("@visactor/vrender-components/label");
...
const registerArcMark = () => {
    (0, vrender_bridge_1.registerShadowRoot)(), (0, vrender_bridge_1.registerArc)(), 
    (0, label_1.registerArcDataLabel)(), (0, config_1.registerArcAnimation)(), factory_1.Factory.registerGraphicComponent("arc", vrender_bridge_1.createArc), 
