...
class BaseMark extends grammar_item_1.GrammarItem {
    ...
    _initProduct(group) {
        ...
        this._product = (0, vrender_bridge_1.createGroup)("group" !== this.type ? {
            pickable: !1,
    ...
    constructor(name, option) {
        ...
        this._graphicMap = new Map, this._graphics = [], this._getEncoderOfStyle = (stateName, style) => {
            ...
            setCustomizedShape && (g.pathProxy = attrs => setCustomizedShape(g.context.data, attrs, new vrender_bridge_1.CustomPath2D)), 
    ...
    _setAnimationState(g) {
        ...
        g.context.animationState === enum_1.DiffState.exit && (g.context.reusing = !0, g.stopAnimates());
    }
    _runJoin(data) {
    ...
    _createIncrementalGraphics() {
        this._product.removeAllChild(), this._dataByGroup.keys.forEach((key => {
            const graphicItem = (0, vrender_bridge_1.createGroup)({
                pickable: !1,
                zIndex: this._markConfig.zIndex
            });
