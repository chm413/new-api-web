...
const factory_1 = require("./../core/factory"), base_mark_1 = require("./base/base-mark"), vrender_bridge_1 = require("../vrender-bridge"), symbol_1 = require("@visactor/vrender-components/label/symbol"), vutils_1 = require("@visactor/vutils");
...
const registerSymbolMark = () => {
    factory_1.Factory.registerMark(SymbolMark.type, SymbolMark), (0, vrender_bridge_1.registerShadowRoot)(), 
    (0, vrender_bridge_1.registerSymbol)(), (0, symbol_1.registerSymbolDataLabel)(), 
    factory_1.Factory.registerGraphicComponent("symbol", vrender_bridge_1.createSymbol);
};
