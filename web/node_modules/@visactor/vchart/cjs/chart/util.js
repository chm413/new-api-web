...
const vutils_1 = require("@visactor/vutils"), util_1 = require("../util"), vutils_extension_1 = require("@visactor/vutils-extension"), vrender_bridge_1 = require("../vrender-bridge");
...
function calculateChartSize(spec, option, defaultSize) {
    ...
    if (container) {
        ...
        let canvasNode;
        canvasNode = (0, vutils_1.isString)(canvas) ? vrender_bridge_1.vglobal.getElementById(canvas) : canvas;
