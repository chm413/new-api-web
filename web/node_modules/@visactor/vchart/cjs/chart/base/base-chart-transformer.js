...
const vutils_1 = require("@visactor/vutils"), core_1 = require("../../core"), interface_1 = require("../../component/interface"), vutils_extension_1 = require("@visactor/vutils-extension"), util_1 = require("./util"), util_2 = require("../../util"), util_3 = require("../../component/util"), DEFAULT_SERIES_RELATED_CHART_SPEC_KEYS = {
    series: !0,
    label: !0,
    animationAppear: !0,
    animationEnter: !0,
...
class BaseChartSpecTransformer {
    ...
    _getDefaultSeriesSpec(chartSpec, pickKeys, pickKeys2) {
        ...
        return seriesType && (this._addSeriesRelatedSpecKeys([ seriesType ]), series.type = seriesType, 
        series[seriesType] = chartSpec[seriesType]), pickKeys && pickKeys.length && pickKeys.forEach((k => {
