...
class WaterfallChartSpecTransformer extends bar_1.BarChartSpecTransformer {
    ...
    _getDefaultSeriesSpec(spec) {
        ...
        return this._addSeriesRelatedSpecKeys([ "bar", "stackLabel", "leaderLine", "total", "calculationMode" ]), 
        series.bar = spec.bar, series.stackLabel = spec.stackLabel, series.leaderLine = spec.leaderLine, 
