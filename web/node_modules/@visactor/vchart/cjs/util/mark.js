...
const getMarkGraphicHost = graphic => {
    var _a;
    return null !== (_a = null == graphic ? void 0 : graphic.glyphHost) && void 0 !== _a ? _a : graphic;
}, isCollectionMark = type => "line" === type || "area" === type;
...
const findMarkGraphic = (rootGroup, target) => {
    ...
    if (null == g ? void 0 : g.context) return g;
    for (;(null == g ? void 0 : g.parent) && g.parent !== rootGroup; ) if (g = getMarkGraphicHost(g.parent), 
    g.context) return g;
    return null;
};
