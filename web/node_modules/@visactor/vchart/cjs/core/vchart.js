...
class VChart {
    ...
    constructor(spec, options) {
        ...
        isTrueBrowseEnv && dom && (this._container = (0, util_1.isString)(dom) ? vrender_bridge_1.vglobal.getElementById(dom) : dom), 
        ...
        if (!1 !== poptip) {
            const poptipInstaller = factory_1.Factory.getRuntimePluginInstaller("poptipForText");
    ...
    updateCustomConfigAndRerender(updateSpecResult, sync, option = {}) {
        ...
        this._reCompile(updateSpecResult, option.morphConfig), (0, util_2.isUpdateSpecResultLocalOnly)(updateSpecResult) ? this : sync ? this._renderSync(option) : this._renderAsync(option);
    }
    _updateCustomConfigAndRecompile(updateSpecResult, option = {}) {
        return !!updateSpecResult && (this._reCompile(updateSpecResult, option.morphConfig), 
        this._beforeRender(option));
    }
    ...
    _forceReleaseExitingVRenderComponents() {
        ...
        (null === (_a = this._exitingVRenderComponents) || void 0 === _a ? void 0 : _a.size) && (this._exitingVRenderComponents.forEach((component => {
            (0, release_vrender_component_1.releaseVRenderComponentSync)(component);
    ...
    updateDataSync(id, data, parserOptions, userUpdateOptions) {
        return this._isReleased ? this : (this._reSetRenderState(), (0, util_1.isNil)(this._dataSet) ? this : this._chart ? (this._chart.updateData(id, data, !0, parserOptions), 
    ...
    _updateModelSpec(model, spec, sync = !1, forceMerge = !1, morphConfig) {
        ...
        const result = model.updateSpec(spec), localOnly = (0, util_2.isUpdateSpecResultLocalOnly)(result), componentOnly = (0, 
        util_2.isUpdateSpecResultComponentOnly)(result);
    ...
    _updateCurrentTheme(nextThemeName) {
        ...
        this._cachedProcessedTheme = null, (0, register_2.setPoptipTheme)(this.getTheme("component", "poptip")), 
    ...
    reLayout() {
        this._chart && this._compiler && !this._isReleased && (this._chart.resetLayoutItemTag(), 
        this._chart.setLayoutTag(!0, null, !1), this._compiler.render(), this._chart.onEvaluateEnd());
    }
    getCompiler() {
    ...
    getContainer() {
        ...
        let canvasNode;
        return canvasNode = (0, util_1.isString)(this._canvas) ? vrender_bridge_1.vglobal.getElementById(this._canvas) : this._canvas, 
    ...
    _reSetRenderState() {
        var _a, _b;
        !this._isReleased && this._compiler && (this._renderState = animate_1.RenderStateEnum.render, 
        null === (_b = null === (_a = this.getStage()) || void 0 === _a ? void 0 : _a.eventSystem) || void 0 === _b || _b.resumeTriggerEvent());
    }
}
...
VChart.ThemeManager = theme_manager_1.ThemeManager, VChart.globalConfig = {
    uniqueTooltip: !0
}, VChart.Utils = util_3.VCHART_UTILS, VChart.vglobal = vrender_bridge_1.vglobal;
