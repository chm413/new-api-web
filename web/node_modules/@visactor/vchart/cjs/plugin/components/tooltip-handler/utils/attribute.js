...
const vutils_1 = require("@visactor/vutils"), vutils_extension_1 = require("@visactor/vutils-extension"), space_1 = require("../../../../util/space"), token_1 = require("../../../../theme/token"), text_1 = require("@visactor/vrender-core/text"), DEFAULT_TEXT_ATTRIBUTES = {
    ...
    const bound = (0, text_1.getRichTextBounds)({
