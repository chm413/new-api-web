...
const common_1 = require("./common"), symbol_1 = require("@visactor/vrender-core/graphic/symbol"), svg_1 = require("@visactor/vrender-core/svg"), vutils_1 = require("@visactor/vutils");
...
function getSvgHtml(option, gradientId) {
    ...
    const getStroke = () => shapeStroke ? (0, common_1.escapeHTML)(shapeStroke) : fillString, sizeNumber = size, createSymbol = symbolType => new symbol_1.Symbol({
    ...
    const isFillGradientStr = svg_1.GradientParser.IsGradientStr(shapeFill);
    ...
    const shapeFillObject = isFillGradientStr ? svg_1.GradientParser.Parse(shapeFill) : (0, 
