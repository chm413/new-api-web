...
const base_1 = require("./base"), tooltip_1 = require("@visactor/vrender-components/tooltip"), vutils_1 = require("@visactor/vutils"), register_1 = require("../register"), constant_1 = require("../../../component/tooltip/constant"), attribute_1 = require("./utils/attribute");
...
class CanvasTooltipHandler extends base_1.BaseTooltipHandler {
    ...
    _initTooltipComponent(stage) {
        ...
        this._tooltipComponent = new tooltip_1.Tooltip({
