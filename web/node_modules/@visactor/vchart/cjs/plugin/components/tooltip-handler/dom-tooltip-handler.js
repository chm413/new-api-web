...
class DomTooltipHandler extends base_1.BaseTooltipHandler {
    ...
    _getTooltipParentElement(tooltipSpec) {
        return isTooltipParentElement(tooltipSpec.parentElement) ? tooltipSpec.parentElement : isTooltipParentElement(this._chartContainer) ? this._chartContainer : isTooltipParentElement(null === env_1.domDocument || void 0 === env_1.domDocument ? void 0 : env_1.domDocument.body) ? env_1.domDocument.body : void 0;
    }
    initEl() {
        const tooltipSpec = this._component.getSpec(), parentElement = this._getTooltipParentElement(tooltipSpec);
    ...
    initRootDom() {
        var _a;
        if (this._container || this.initEl(), !this._container) return;
        const tooltipSpec = this._component.getSpec(), tooltipElement = env_1.domDocument.createElement("div"), themeFontFamily = null === (_a = this._chartOption) || void 0 === _a ? void 0 : _a.getTheme("fontFamily");
        (0, style_1.setStyleToDom)(tooltipElement, Object.assign({
            ...
            fontFamily: null != themeFontFamily ? themeFontFamily : token_1.token.fontFamily,
            fontSize: "11px",
            borderRadius: "3px",
            borderStyle: "solid",
            lineHeight: "initial",
    ...
    _getParentElement(spec) {
        var _a;
        return null !== (_a = this._container) && void 0 !== _a ? _a : this._getTooltipParentElement(spec);
    }
    isTooltipShown() {
