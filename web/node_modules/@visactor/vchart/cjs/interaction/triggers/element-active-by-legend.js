...
const factory_1 = require("../../core/factory"), base_1 = require("./base"), event_1 = require("../../constant/event"), vutils_1 = require("@visactor/vutils"), util_1 = require("./util"), interface_1 = require("../../compile/mark/interface"), graphic_state_1 = require("../../util/graphic-state"), type = "element-active-by-legend", defaultOptions = {
...
class ElementActiveByLegend extends base_1.BaseTrigger {
    ...
    reset(g) {
        ...
        if (g) {
            ...
            statedGraphics && statedGraphics.includes(g) && ((0, graphic_state_1.removeGraphicState)(g, state), 
