...
const factory_1 = require("../../core/factory"), base_1 = require("./base"), interface_1 = require("../../compile/mark/interface"), vutils_1 = require("@visactor/vutils"), util_1 = require("./util"), graphic_state_1 = require("../../util/graphic-state"), type = "element-highlight-by-name", defaultOptions = {
...
class ElementHighlightByName extends base_1.BaseTrigger {
    ...
    reset(g) {
        ...
        if (g) {
            ...
            statedGraphics && statedGraphics.includes(g) && ((0, graphic_state_1.removeGraphicState)(g, [ highlightState, blurState ]), 
