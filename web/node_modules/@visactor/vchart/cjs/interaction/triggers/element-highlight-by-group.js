...
const factory_1 = require("../../core/factory"), base_1 = require("./base"), vutils_1 = require("@visactor/vutils"), util_1 = require("./util"), graphic_state_1 = require("../../util/graphic-state"), type = "element-highlight-by-group";
    ...
    reset(g) {
        if (g) {
            if (this.isGraphicInMark(g)) {
                ...
                (0, graphic_state_1.removeGraphicState)(g, [ this.options.highlightState, this.options.blurState ]), 
