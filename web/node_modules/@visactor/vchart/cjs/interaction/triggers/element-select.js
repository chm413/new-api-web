...
const vutils_1 = require("@visactor/vutils"), interface_1 = require("../../compile/mark/interface"), base_1 = require("./base"), util_1 = require("./util"), factory_1 = require("../../core/factory"), graphic_state_1 = require("../../util/graphic-state"), defaultOptions = {
...
class ElementSelect extends base_1.BaseTrigger {
    ...
    start(markGraphic, e) {
        ...
        if (markGraphic && this._markSet.getMarkInId(markGraphic.context.markId)) if (markGraphic.hasState(state)) {
            ...
            this._timer && clearTimeout(this._timer), (0, graphic_state_1.addGraphicState)(markGraphic, state, !0);
    ...
    reset(markGraphic, e) {
        markGraphic ? this._markSet.getMarkInId(markGraphic.context.markId) && (0, graphic_state_1.removeGraphicState)(markGraphic, [ this.options.state, this.options.reverseState ]) : this.resetAll(e);
    }
}
