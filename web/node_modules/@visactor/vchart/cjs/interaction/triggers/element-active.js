...
const factory_1 = require("../../core/factory"), base_1 = require("./base"), interface_1 = require("../../compile/mark/interface"), graphic_state_1 = require("../../util/graphic-state"), defaultOptions = {
...
class ElementActive extends base_1.BaseTrigger {
    ...
    start(g) {
        if (g) {
            ...
            this.isGraphicInStateMark(g, state) && ((0, graphic_state_1.addGraphicState)(g, state, !0), 
    ...
    reset(graphic) {
        ...
        g && (null == statedGraphics ? void 0 : statedGraphics.includes(g)) && ((0, graphic_state_1.removeGraphicState)(g, state), 
