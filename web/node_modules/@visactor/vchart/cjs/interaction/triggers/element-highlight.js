...
const vutils_1 = require("@visactor/vutils"), interface_1 = require("../../compile/mark/interface"), base_1 = require("./base"), factory_1 = require("../../core/factory"), graphic_state_1 = require("../../util/graphic-state"), defaultOptions = {
...
class ElementHighlight extends base_1.BaseTrigger {
    ...
    reset(markGraphic, e) {
        markGraphic ? this._markSet.getMarkInId(markGraphic.context.markId) && (0, graphic_state_1.removeGraphicState)(markGraphic, [ this.options.highlightState, this.options.blurState ]) : this.resetAll(e);
    }
}
