...
class Compiler {
    ...
    initView() {
        ...
        vrender_core_1.vglobal.setEnv((0, util_1.toRenderMode)(mode), null != appEnvParams ? appEnvParams : {});
        ...
        this._stage = externalStage, !this._stage) {
            ...
            try {
                ...
                throw null === (_d = this._releaseVRenderAppRef) || void 0 === _d || _d.call(this), 
    ...
    _shouldDisableCanvasTouchAction() {
        ...
        return !1 === ((0, vutils_1.isValid)(this._option.supportsTouchEvents) ? this._option.supportsTouchEvents : vrender_core_1.vglobal.supportsTouchEvents) && this._isGeoRegionRoamDragEnabled();
    }
    _setCanvasStyle() {
