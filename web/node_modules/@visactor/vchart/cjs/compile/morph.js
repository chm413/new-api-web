...
const morphing_1 = require("@visactor/vrender-animate/custom/morphing"), vutils_1 = require("@visactor/vutils"), invokeFunctionType = (value, params, morphData, morphElements) => "function" == typeof value ? value(params, morphData, morphElements) : value, doMorph = (prev, next, config, onEnd, parameters) => {
    var _a;
    const morphData = {
    ...
    morphing_1.oneToMultiMorph)(prev[0], next, {
        delay: delay,
        duration: duration,
        easing: easing,
        onEnd: onEnd,
        ...
        splitPath: splitPath
    }) : prev.length > 1 && 1 === next.length && (0, morphing_1.multiToOneMorph)(prev, next[0], {
        delay: delay,
        duration: duration,
        easing: easing,
        onEnd: onEnd,
        individualDelay: individualDelay,
        splitPath: splitPath
    }) : (0, morphing_1.morphPath)(prev[0], next[0], {
        delay: delay,
        duration: duration,
        easing: easing,
        onEnd: onEnd
