...
class LinearAxisMixin {
    ...
    setLinearScaleNice() {
        ...
        vutils_1.isFunction)(tick.tickCount)) {
            ...
            this._lastNiceAxisLength = rangeSize, tickCount = tick.tickCount({
    ...
    reTransformDomainByLayout() {
        var _a;
        if (!this._nice || !(0, vutils_1.isFunction)(null === (_a = this._spec.tick) || void 0 === _a ? void 0 : _a.tickCount)) return;
        const range = this._scale.range(), realLength = Math.abs((0, vutils_1.last)(range) - range[0]);
        realLength <= 1 || (0, vutils_1.isValidNumber)(this._lastNiceAxisLength) && Math.abs(this._lastNiceAxisLength - realLength) < 1 || this.updateScaleDomain();
    }
