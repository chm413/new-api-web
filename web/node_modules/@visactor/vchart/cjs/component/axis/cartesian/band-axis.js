...
class CartesianBandAxis extends axis_1.CartesianAxis {
    ...
    registerTicksTransform() {
        ...
        return (0, register_1.registerDataSetInstanceTransform)(this._option.dataSet, name, linear_1.linearDiscreteTicks), 
        name;
    }
...
const registerCartesianBandAxis = () => {
    factory_1.Factory.registerGraphicComponent(interface_2.AxisEnum.lineAxis, ((attrs, options) => new line_2.LineAxis(attrs, options))), 
    factory_1.Factory.registerGraphicComponent(interface_2.GridEnum.lineAxisGrid, ((attrs, options) => new line_1.LineAxisGrid(attrs, options))), 
