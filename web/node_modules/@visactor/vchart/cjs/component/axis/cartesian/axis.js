...
const vutils_1 = require("@visactor/vutils"), vutils_extension_1 = require("@visactor/vutils-extension"), util_1 = require("../../../util"), vscale_1 = require("@visactor/vscale"), factory_1 = require("../../../core/factory"), common_1 = require("./util/common"), event_1 = require("../../../constant/event"), layout_1 = require("../../../constant/layout"), axis_sync_1 = require("../../../plugin/components/axis-sync/axis-sync"), type_1 = require("../../interface/type"), type_2 = require("../../../series/interface/type"), util_2 = require("../util"), base_axis_1 = require("../base-axis"), vrender_bridge_1 = require("../../../vrender-bridge"), region_1 = require("../../../util/region"), CartesianAxisPlugin = [ axis_sync_1.AxisSyncPlugin ];
...
class CartesianAxis extends base_axis_1.AxisComponent {
    ...
    _getContinuousBarBandwidth(depth = 0) {
        if (0 !== depth || !(0, vscale_1.isContinuous)(this._scale.type)) return;
        const scale = this._scales[0], domain = scale.domain(), range = scale.range(), domainStart = +(null == domain ? void 0 : domain[0]), domainEnd = +(null == domain ? void 0 : domain[domain.length - 1]), rangeStart = +(null == range ? void 0 : range[0]), rangeEnd = +(null == range ? void 0 : range[range.length - 1]);
        ...
        const valueSet = new Set, orient = this.getOrient();
        (0, util_1.eachSeries)(this._regions, (s => {
            var _a, _b, _c, _d;
            if (s.type !== type_2.SeriesTypeEnum.bar) return;
            const barSeries = s, field = (0, common_1.isXAxis)(orient) && "vertical" === barSeries.direction ? barSeries.fieldX[0] : (0, 
            common_1.isYAxis)(orient) && "horizontal" === barSeries.direction ? barSeries.fieldY[0] : void 0, values = field ? null === (_d = null === (_c = null === (_b = null === (_a = s.getViewDataStatistics) || void 0 === _a ? void 0 : _a.call(s)) || void 0 === _b ? void 0 : _b.latestData) || void 0 === _c ? void 0 : _c[field]) || void 0 === _d ? void 0 : _d.values : void 0;
        ...
        let minStep = 1 / 0, lastValue = values[0];
        for (let i = 1; i < values.length; i++) {
            const value = values[i], step = value - lastValue;
    ...
    initEvent() {
        super.initEvent(), (0, util_1.eachSeries)(this._regions, (s => {
            var _a, _b;
            ...
            userId: this._seriesUserId,
            specIndex: this._seriesIndex
        }), this._specVisible && (this.event.on(event_1.ChartEvent.layoutEnd, this._updateAxisLayout), 
    ...
    _appendAxisUnit(bounds, isX) {
        ...
        if (this._spec.unit && this._spec.unit.visible) {
            ...
            vrender_bridge_1.createText)(unitTextStyle), this._unitText.name = "axis-unit", 
            null === (_a = this.getContainer()) || void 0 === _a || _a.add(this._unitText));
