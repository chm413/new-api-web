...
class CartesianLinearAxis extends axis_1.CartesianAxis {
    ...
    updateScaleRange() {
        ...
        return isScaleChange && this.reTransformDomainByLayout(), isScaleChange;
    }
    ...
    registerTicksTransform() {
        ...
        return (0, register_1.registerDataSetInstanceTransform)(this._option.dataSet, name, continuous_1.continuousTicks), 
        name;
    }
}
...
const registerCartesianLinearAxis = () => {
    factory_1.Factory.registerGraphicComponent(interface_1.AxisEnum.lineAxis, ((attrs, options) => new line_2.LineAxis(attrs, options))), 
    factory_1.Factory.registerGraphicComponent(interface_1.GridEnum.lineAxisGrid, ((attrs, options) => new line_1.LineAxisGrid(attrs, options))), 
