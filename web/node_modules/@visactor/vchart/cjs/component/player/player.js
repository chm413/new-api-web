...
class Player extends base_component_1.BaseComponent {
    constructor() {
        ...
        this._getPlayerAttrs = () => {
            ...
            var _a;
            (null === (_a = this._spec) || void 0 === _a ? void 0 : _a.auto) && this._playerComponent && (this._playerComponent.pause(), 
    ...
    _compareSpec(spec, prevSpec) {
        const result = super._compareSpec(spec, prevSpec), specChanged = !(0, vutils_1.isEqual)(prevSpec, spec);
        return (null == prevSpec ? void 0 : prevSpec.type) !== (null == spec ? void 0 : spec.type) ? (result.reMake = !0, 
        result) : (!specChanged || result.reMake || result.reCompile || (result.change = !0, 
        result.reRender = !0, result.effects = Object.assign(Object.assign({}, result.effects), {
            component: !0,
            layout: !0,
            render: !0
        })), result);
    ...
    changePlayerIndex(index) {
        ...
        spec && (null === (_b = this._option) || void 0 === _b ? void 0 : _b.globalInstance) && (this._option.globalInstance.updateFullData(spec.data), 
    ...
    release() {
        var _a, _b, _c, _d;
        null === (_b = null === (_a = this._playerComponent) || void 0 === _a ? void 0 : _a.pause) || void 0 === _b || _b.call(_a), 
        null === (_d = null === (_c = this._option) || void 0 === _c ? void 0 : _c.globalInstance) || void 0 === _d || _d.off(event_1.ChartEvent.rendered, this.autoPlayCallback), 
        super.release(), this._playerComponent = null, this._cacheAttrs = null, this._specs = [];
    }
}
