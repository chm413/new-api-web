...
const interface_1 = require("../../series/interface"), vutils_1 = require("@visactor/vutils"), vrender_bridge_1 = require("../../vrender-bridge"), util_1 = require("../util"), core_1 = require("../../core");
...
function stackLabel(labelInfo, datumTransform, attributeTransform) {
    ...
    return {
        customLayoutFunc: labels => labels.map((label => {
            ...
            null == attributeTransform || attributeTransform(label, datum, attribute), (0, vrender_bridge_1.createText)(Object.assign(Object.assign({}, attribute), {
                id: label.id
            }));
        })),
        dataFilter: labels => {
