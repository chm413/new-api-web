...
const base_1 = require("./base"), constant_1 = require("@visactor/vrender-core/event/constant"), mark_1 = require("../../../util/mark"), factory_1 = require("../../../core/factory");
            ...
            if (activeTriggers) {
                ...
                layer.globalTransMatrix.transformPoint({
                    ...
                    mark.getGraphics().forEach((g => {
                        g !== params.node && g && g.containsPoint(point.x, point.y, constant_1.IContainPointMode.GLOBAL, g.stage.getPickerService()) && tooltipData[0].datum.push((0, 
