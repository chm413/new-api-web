...
const vrender_bridge_1 = require("../../vrender-bridge"), util_1 = require("../../util"), base_1 = require("../base"), constant_1 = require("./constant"), common_1 = require("./utils/common"), vutils_extension_1 = require("@visactor/vutils-extension"), TOOLTIP_STYLE_THEME_KEYS = [ "panel", "shape", "titleLabel", "keyLabel", "valueLabel", "spaceRow", "maxContentHeight", "align" ];
...
class TooltipSpecTransformer extends base_1.BaseComponentSpecTransformer {
    ...
    _transformSpecAfterMergingTheme(spec, chartSpec, chartSpecInfo) {
        ...
        (0, util_1.isValid)(spec.parentElement) ? (0, util_1.isString)(spec.parentElement) && (spec.parentElement = vrender_bridge_1.vglobal.getElementById(spec.parentElement)) : (0, 
