...
class BaseComponent extends layout_model_1.LayoutModel {
    constructor() {
        ...
        this._forceReleaseVRenderComponents = !1, this._delegateEvent = (component, event, type, item = null, datum = null) => {
            var _a, _b;
            event instanceof constant_1.CustomEvent || this.event.emit(type, {
                model: this,
                node: component,
                event: event,
                item: item,
    ...
    release() {
        var _a;
        this._shouldReleaseVRenderComponentsImmediately() && this._forceReleaseExitingVRenderComponents(), 
        this.clear(), super.release(), null === (_a = this.pluginService) || void 0 === _a || _a.releaseAll(), 
    ...
    _forceReleaseExitingVRenderComponents() {
        ...
        (null === (_a = this._exitingVRenderComponents) || void 0 === _a ? void 0 : _a.size) && (this._exitingVRenderComponents.forEach((component => {
            var _a, _b, _c;
            (0, release_vrender_component_1.releaseVRenderComponentSync)(component), null === (_c = null === (_b = null === (_a = this._option) || void 0 === _a ? void 0 : _a.globalInstance) || void 0 === _b ? void 0 : _b._unregisterExitingVRenderComponent) || void 0 === _c || _c.call(_b, component);
        })), this._exitingVRenderComponents.clear());
    }
    _releaseVRenderComponent(component) {
        var _a;
        if (!this._shouldReleaseVRenderComponentsImmediately()) {
            const exitingComponents = (0, release_vrender_component_1.collectVRenderComponents)(component), releasedWithExit = (0, 
            release_vrender_component_1.releaseVRenderComponent)(component, {
                enableExitAnimation: !0,
                removeFromParent: !0,
                onComplete: () => {
                    exitingComponents.forEach((exitingComponent => {
                        var _a, _b, _c, _d;
                        null === (_a = this._exitingVRenderComponents) || void 0 === _a || _a.delete(exitingComponent), 
                        null === (_d = null === (_c = null === (_b = this._option) || void 0 === _b ? void 0 : _b.globalInstance) || void 0 === _c ? void 0 : _c._unregisterExitingVRenderComponent) || void 0 === _d || _d.call(_c, exitingComponent);
                    }));
                }
            });
            return releasedWithExit ? (this._exitingVRenderComponents = null !== (_a = this._exitingVRenderComponents) && void 0 !== _a ? _a : new Set, 
            void exitingComponents.forEach((exitingComponent => {
                var _a, _b, _c;
