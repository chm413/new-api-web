...
class BaseLegend extends base_component_1.BaseComponent {
    ...
    _compareSpec(spec, prevSpec) {
        ...
        return result.reMake ? result : (null == spec ? void 0 : spec.orient) !== (null == prevSpec ? void 0 : prevSpec.orient) ? (result.reMake = !0, 
        result) : specChanged && !result.reCompile && this._isComponentOnlySpecChange(spec, prevSpec) ? (result.effects = Object.assign(Object.assign({}, result.effects), {
            component: !0,
            layout: !0,
            render: !0
    ...
    _isComponentOnlySpecChange(spec, prevSpec) {
        const prevSpecRecord = prevSpec, specRecord = spec;
        return Object.keys(Object.assign(Object.assign({}, prevSpec), spec)).every((key => (0, 
        vutils_1.isEqual)(null == prevSpecRecord ? void 0 : prevSpecRecord[key], null == specRecord ? void 0 : specRecord[key]) || LEGEND_COMPONENT_ONLY_CHANGE_KEYS[key]));
    }
