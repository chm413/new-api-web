...
class DiscreteLegend extends base_legend_1.BaseLegend {
    ...
    _initLegendData() {
        (0, register_1.registerDataSetInstanceTransform)(this._option.dataSet, "discreteLegendFilter", discrete_2.discreteLegendFilter), 
        (0, register_1.registerDataSetInstanceTransform)(this._option.dataSet, "discreteLegendDataMake", discrete_2.discreteLegendDataMake);
    ...
    _getLegendAttributes(rect) {
        ...
        }, (0, util_1.getLegendAttributes)(this._spec, rect, this.layoutOrient)), {
            maxWidth: rect.width,
    ...
    _initEvent() {
        if (this._legendComponent) {
            ...
            this._legendComponent.addEventListener(constant_1.LegendEvent.legendItemClick, (e => {
            ...
            })), this._legendComponent.addEventListener(constant_1.LegendEvent.legendItemHover, (e => {
            ...
            })), this._legendComponent.addEventListener(constant_1.LegendEvent.legendItemUnHover, (e => {
                const detail = (0, vutils_1.get)(e, "detail");
