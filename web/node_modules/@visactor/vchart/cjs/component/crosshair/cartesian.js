...
class CartesianCrossHair extends base_1.BaseCrossHair {
    ...
    _updateCrosshairByField(field, positionAttribute) {
        ...
        if (crosshairComp) crosshairComp.setAttributes(positionAttribute); else {
            ...
            "line" === attributes.type ? crosshairComp = new line_1.LineCrosshair(Object.assign(Object.assign({}, positionAttribute), {
                lineStyle: style,
                zIndex: this.gridZIndex + 1,
                disableTriggerEvent: this._option.disableTriggerEvent,
                pickable: !1
            })) : "rect" === attributes.type && (crosshairComp = new rect_1.RectCrosshair(Object.assign(Object.assign({}, positionAttribute), {
                rectStyle: style,
