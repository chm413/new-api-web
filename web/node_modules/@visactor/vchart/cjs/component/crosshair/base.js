...
class BaseCrossHair extends base_component_1.BaseComponent {
    ...
    _compareSpec(spec, prevSpec) {
        ...
        return !(0, vutils_1.isEqual)(prevSpec, spec) && (result.change = !0, result.reRender = !0, 
        result.reMake || (this._isComponentOnlySpecChange(spec, prevSpec) ? result.effects = Object.assign(Object.assign({}, result.effects), {
            component: !0,
            layout: !0,
            render: !0
    ...
    _isComponentOnlySpecChange(spec, prevSpec) {
        ...
        vutils_1.isEqual)(null == prevSpec ? void 0 : prevSpec[key], null == spec ? void 0 : spec[key]) || CROSSHAIR_COMPONENT_ONLY_TOP_LEVEL_CHANGE_KEYS[key] || CROSSHAIR_FIELD_KEYS[key] && this._isFieldComponentOnlySpecChange(null == prevSpec ? void 0 : prevSpec[key], null == spec ? void 0 : spec[key])));
    }
    _isFieldComponentOnlySpecChange(prevSpec, spec) {
        return Object.keys(Object.assign(Object.assign({}, prevSpec), spec)).every((key => (0, 
        vutils_1.isEqual)(null == prevSpec ? void 0 : prevSpec[key], null == spec ? void 0 : spec[key]) || "label" === key || "line" === key && this._isLineComponentOnlySpecChange(null == prevSpec ? void 0 : prevSpec.line, null == spec ? void 0 : spec.line)));
    }
    _isLineComponentOnlySpecChange(prevSpec, spec) {
        return Object.keys(Object.assign(Object.assign({}, prevSpec), spec)).every((key => (0, 
        vutils_1.isEqual)(null == prevSpec ? void 0 : prevSpec[key], null == spec ? void 0 : spec[key]) || CROSSHAIR_LINE_COMPONENT_ONLY_CHANGE_KEYS[key]));
    }
    _initEvent() {
    ...
    _updateCrosshairLabel(label, labelAttrs, callback) {
        ...
        label ? label.setAttributes(labelAttrs) : (label = new tag_1.Tag(labelAttrs), null == container || container.add(label), 
        callback(label)), (0, common_2.limitTagInBounds)(label, this._getLimitBounds());
    }
    clearOutEvent() {
