...
const base_component_1 = require("../base/base-component"), type_1 = require("../interface/type"), layout_1 = require("../../constant/layout"), base_1 = require("../../constant/base"), vutils_1 = require("@visactor/vutils"), factory_1 = require("../../core/factory"), utils_1 = require("../../animation/utils"), CUSTOM_MARK_COMPONENT_ONLY_CHANGE_KEYS = {
    style: !0,
    state: !0
};
...
class CustomMark extends base_component_1.BaseComponent {
    ...
    _compareSpec(spec, prevSpec) {
        ...
        return (0, vutils_1.isEqual)(prevSpec, spec) || (result.reMake || result.reCompile || !this._isComponentOnlySpecChange(spec, prevSpec) ? result.reMake = !0 : result.effects = Object.assign(Object.assign({}, result.effects), {
            component: !0,
            render: !0
    ...
    _isComponentOnlySpecChange(spec, prevSpec) {
        ...
        vutils_1.isEqual)(null == prevSpec ? void 0 : prevSpec[key], null == spec ? void 0 : spec[key]) || CUSTOM_MARK_COMPONENT_ONLY_CHANGE_KEYS[key]));
    }
    reInit(spec) {
        super.reInit(spec), this._updateMarkStyleWithSpec(this._spec, this.getMarks()[0]), 
