...
class DataFilterBaseComponent extends base_component_1.BaseComponent {
    ...
    constructor(spec, options) {
        ...
        this._stateField = "x", this._currentDataCollection = [], this._handleStateChange = (startValue, endValue, tag) => {
            var _a, _b;
    ...
    _compareSpec(spec, prevSpec) {
        ...
        return result.reMake || (0, vutils_1.isEqual)(prevSpec, spec) || (result.change = !0, 
        result.reRender = !0, !result.reCompile && this._isComponentOnlySpecChange(spec, prevSpec) ? result.effects = Object.assign(Object.assign({}, result.effects), {
            component: !0,
            layout: !0,
            render: !0
    ...
    _isComponentOnlySpecChange(spec, prevSpec) {
        ...
        vutils_1.isEqual)(null == prevSpec ? void 0 : prevSpec[key], null == spec ? void 0 : spec[key]) || componentOnlySpecKeys[key]));
    }
    reInit(spec) {
    ...
    _initData() {
        const {dataCollection: dataCollection, seriesCollection: seriesCollection, stateFields: stateFields, valueFields: valueFields, isCategoryState: isCategoryState} = this._collectDataInfo(), {dataSet: dataSet} = this._option;
        ...
        this._currentDataCollection = dataCollection, dataSet.multipleDataViewAddListener(dataCollection, "change", this._handleDataCollectionChangeBound);
    }
    ...
    onDataUpdate() {
        var _a;
        const {dataCollection: dataCollection, seriesCollection: seriesCollection, stateFields: stateFields, valueFields: valueFields, isCategoryState: isCategoryState} = this._collectDataInfo();
        ...
        this._stateScale.domain(domain, !1), ((0, vutils_1.isValid)(this._spec.start) || (0, 
        vutils_1.isValid)(this._spec.end)) && this._setStateFromSpec(), this._handleChange(this._start, this._end, !0), 
