...
class CartesianMarkPoint extends base_mark_point_1.BaseMarkPoint {
    ...
    _computePointsAttr() {
        ...
        let point;
        return isXYLayout ? point = null === (_c = null === (_b = (0, utils_1.xyLayout)(data, relativeSeries, relativeSeries, relativeSeries, autoRange, !1, this._getAutoRangeExtendDomainKeyPrefix())) || void 0 === _b ? void 0 : _b[0]) || void 0 === _c ? void 0 : _c[0] : isCoordinateLayout ? point = (0, 
        utils_1.cartesianCoordinateLayout)(data, relativeSeries, autoRange, spec.coordinatesOffset, this._getAutoRangeExtendDomainKeyPrefix())[0] : isPositionLayout && (point = (0, 
