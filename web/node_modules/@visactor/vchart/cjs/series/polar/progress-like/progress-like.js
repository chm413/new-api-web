...
const vutils_1 = require("@visactor/vutils"), data_1 = require("../../../constant/data"), polar_1 = require("../../../constant/polar"), attribute_1 = require("../../../constant/attribute"), scale_1 = require("../../../util/scale"), polar_2 = require("../polar"), vrender_bridge_1 = require("../../../vrender-bridge"), constant_1 = require("./constant"), PROGRESS_LIKE_SERIES_COMPILE_ONLY_KEYS = {
    radius: !0,
    outerRadius: !0,
    innerRadius: !0,
    startAngle: !0,
            ...
            clipPath: () => {
                ...
                if (this._isTickMaskVisible(axis)) {
                    ...
                    return subTickData.map((({value: value}) => {
                        ...
                        return (0, vrender_bridge_1.createArc)(Object.assign(Object.assign({}, markStyle), {
                            x: x,
                            y: y,
                ...
                return [ (0, vrender_bridge_1.createRect)({
                    width: width,
                    height: height,
                    fill: !0
                }) ];
