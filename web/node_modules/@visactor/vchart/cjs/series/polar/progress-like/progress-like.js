...
const vutils_1 = require("@visactor/vutils"), data_1 = require("../../../constant/data"), polar_1 = require("../../../constant/polar"), attribute_1 = require("../../../constant/attribute"), scale_1 = require("../../../util/scale"), polar_2 = require("../polar"), vrender_core_1 = require("@visactor/vrender-core"), constant_1 = require("./constant"), PROGRESS_LIKE_SERIES_COMPILE_ONLY_KEYS = {
    radius: !0,
    outerRadius: !0,
    innerRadius: !0,
    startAngle: !0,
