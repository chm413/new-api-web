...
const custom_animate_1 = require("@visactor/vrender-animate/custom/custom-animate"), tag_points_1 = require("@visactor/vrender-animate/custom/tag-points"), vutils_1 = require("@visactor/vutils"), util_1 = require("../../util");

class PolarPointUpdate extends custom_animate_1.ACustomAnimate {
...
class PolarTagPointsUpdate extends tag_points_1.TagPointsUpdate {
    onBind() {
        super.onBind();
