...
const cartesian_1 = require("../cartesian/cartesian"), type_1 = require("../interface/type"), line_mixin_1 = require("../mixin/line-mixin"), vutils_1 = require("@visactor/vutils"), utils_1 = require("../../animation/utils"), config_1 = require("../../animation/config"), constant_1 = require("./constant"), line_1 = require("../../mark/line"), symbol_1 = require("../../mark/symbol"), factory_1 = require("../../core/factory"), line_mixin_transformer_1 = require("../mixin/line-mixin-transformer"), utils_2 = require("../util/utils"), band_axis_1 = require("../../component/axis/cartesian/band-axis"), linear_axis_1 = require("../../component/axis/cartesian/linear-axis"), symbol_overlap_1 = require("../../mark/transform/symbol-overlap"), data_sampling_1 = require("../../mark/transform/data-sampling"), line_2 = require("../../theme/builtin/common/series/line");
...
class LineSeries extends cartesian_1.CartesianSeries {
    ...
    _getSpecUpdatePolicy() {
        ...
        return Object.assign(Object.assign({}, policy), {
            dataRelatedKeys: Object.assign(Object.assign({}, policy.dataRelatedKeys), line_mixin_1.LINE_LIKE_SERIES_DATA_RELATED_KEYS)
        });
    }
    compile() {
...
const registerLineSeries = () => {
    ...
    (0, config_1.registerScaleInOutAnimation)(), (0, band_axis_1.registerCartesianBandAxis)(), 
    (0, linear_axis_1.registerCartesianLinearAxis)(), factory_1.Factory.registerSeries(LineSeries.type, LineSeries);
};
