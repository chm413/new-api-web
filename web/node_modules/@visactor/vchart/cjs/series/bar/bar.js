...
class BarSeries extends cartesian_1.CartesianSeries {
    ...
    getStatisticFields() {
        var _a;
        const fields = super.getStatisticFields(), positionAxisHelper = "horizontal" === this.direction ? this.getYAxisHelper() : this.getXAxisHelper(), positionFields = "horizontal" === this.direction ? this._fieldY : this._fieldX, positionScale = null === (_a = null == positionAxisHelper ? void 0 : positionAxisHelper.getScale) || void 0 === _a ? void 0 : _a.call(positionAxisHelper, 0);
        return positionScale && (0, vscale_1.isContinuous)(positionScale.type) && positionFields.forEach((field => {
    ...
    initMarkStyle() {
        ...
        }, "normal", attribute_1.AttributeLevel.Series), this.initRectMarkStyle();
    }
    initRectMarkStyle() {
        var _a;
        if (!this._barMark) return;
        const bandAxisHelper = "vertical" === this.direction ? this._xAxisHelper : this._yAxisHelper, scale = null === (_a = null == bandAxisHelper ? void 0 : bandAxisHelper.getScale) || void 0 === _a ? void 0 : _a.call(bandAxisHelper, 0);
    ...
    _initStackBarMarkStyle() {
        ...
        if (!this._spec.stackCornerRadius) {
            ...
            return void (!markConfig.clip && (0, vutils_1.isNil)(markConfig.clipPath) || this._barMark.setMarkConfig({
                clip: !1,
                clipPath: []
            }));
        }
        const xScale = null === (_b = null === (_a = this._xAxisHelper) || void 0 === _a ? void 0 : _a.getScale) || void 0 === _b ? void 0 : _b.call(_a, 0), yScale = null === (_d = null === (_c = this._yAxisHelper) || void 0 === _c ? void 0 : _c.getScale) || void 0 === _d ? void 0 : _d.call(_c, 0), isVertical = "vertical" === this.direction;
        this._barMark.setMarkConfig({
            ...
            clipPath: () => {
                ...
                return this._forEachStackGroup((node => {
                    let min = 1 / 0, max = -1 / 0, rectMin = 1 / 0, rectMax = -1 / 0, hasPercent = !1, minPercent = 1 / 0, maxPercent = -1 / 0;
                    node.values.forEach((datum => {
                        ...
                        if (min = Math.min(min, start, end), max = Math.max(max, start, end), usePreCalculatedRect) {
                            const rectStart = datum[isVertical ? constant_2.RECT_Y : constant_2.RECT_X], rectEnd = datum[isVertical ? constant_2.RECT_Y1 : constant_2.RECT_X1];
                            rectMin = Math.min(rectMin, rectStart, rectEnd), rectMax = Math.max(rectMax, rectStart, rectEnd);
                        }
                        (0, vutils_1.isValid)(startPercent) && (0, vutils_1.isValid)(endPercent) && (hasPercent = !0, 
                    ...
                    rectPaths.push((0, vrender_bridge_1.createRect)(Object.assign(Object.assign({}, rectAttr), {
    ...
    _getBarWidth(axisHelper, scaleDepth) {
        ...
        vutils_1.isNil)(scaleDepth) ? depthFromSpec : Math.min(depthFromSpec, scaleDepth), hasBarWidth = (0, 
        vutils_1.isValid)(this._spec.barWidth) && depth === depthFromSpec, axisBandWidth = hasBarWidth && "number" == typeof this._spec.barWidth && "string" != typeof this._spec.barMinWidth && "string" != typeof this._spec.barMaxWidth || null === (_a = axisHelper.getBandwidth) || void 0 === _a ? void 0 : _a.call(axisHelper, depth - 1), bandWidth = null != axisBandWidth ? axisBandWidth : exports.DefaultBandWidth, hasBarMinWidth = (0, 
        vutils_1.isValid)(this._spec.barMinWidth), hasBarMaxWidth = (0, vutils_1.isValid)(this._spec.barMaxWidth);
        let width = !axisHelper.isContinuous || (0, vutils_1.isNil)(axisBandWidth) || hasBarWidth ? bandWidth : .5 * bandWidth;
