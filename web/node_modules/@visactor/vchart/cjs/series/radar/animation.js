...
const clip_graphic_1 = require("@visactor/vrender-animate/custom/clip-graphic"), factory_1 = require("../../core/factory"), animation_1 = require("../polar/animation"), config_1 = require("../../animation/config"), vrender_bridge_1 = require("../../vrender-bridge"), radarFadeAnimation = animationType => ({
...
const radarGroupClipAnimation = (params, animationType) => ({
    custom: clip_graphic_1.ClipAngleAnimate,
...
const registerRadarAnimation = () => {
    ...
    }))), (0, vrender_bridge_1.registerArc)();
};
