...
class BaseSeries extends base_model_1.BaseModel {
    ...
    _compareSpec(spec, prevSpec, ignoreCheckKeys) {
        ...
        if (this._compareExtensionMarksSpec((0, vutils_1.array)(spec.extensionMark), (0, 
    ...
    _getSeriesDataKey(datum) {
        ...
        for (let i = 0; i < dimensionFields.length; i++) {
            ...
            key += `${i > 0 ? "_" : ""}${(0, vutils_1.isNil)(dimensionValue) ? "" : dimensionValue}`, 
