...
class TreemapSeries extends cartesian_1.CartesianSeries {
    ...
    initData() {
        var _a;
        super.initData(), (0, register_1.registerDataSetInstanceTransform)(this._dataSet, "treemap", treemap_1.treemapLayout), 
    ...
    handleZoom(event) {
        ...
        const {a: a, b: b, c: c, d: d, e: e, f: f} = this._matrix;
        this._matrix.multiply(a, b, c, d, e, f), this.disableMarkAnimation(), this.event.on(event_1.HOOK_EVENT.AFTER_DO_RENDER, this._enableAnimationHook), 
...
TreemapSeries.mark = constant_1.treemapSeriesMark, TreemapSeries.builtInTheme = {
    treemap: treemap_2.treemap
}, TreemapSeries.transformerConstructor = treemap_transform_1.TreemapSeriesSpecTransformer, 
...
const registerTreemapSeries = () => {
    (0, filter_1.registerMarkFilterTransform)(), (0, map_1.registerMarkMapTransform)(), 
