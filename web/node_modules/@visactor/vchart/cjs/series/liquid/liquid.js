    ...
    constructor() {
        ...
        this._liquidBackgroundMark = null, this._liquidOutlineMark = null, this._getLiquidPosY = () => {
            ...
            if ("rect" === this._maskShape) {
                ...
                symbolPath = (0, vrender_bridge_1.createRect)({
                    x: x - width / 2,
                    y: y - height / 2,
                    width: width,
                    height: height,
                ...
                symbolPath = (0, vrender_bridge_1.createSymbol)({
                    x: x,
                    y: y,
                    size: size,
