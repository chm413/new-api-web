...
const factory_1 = require("../../core/factory"), config_1 = require("../../animation/config"), config_2 = require("../../animation/config"), custom_animate_1 = require("@visactor/vrender-animate/custom/custom-animate"), animate_executor_1 = require("@visactor/vrender-animate/executor/animate-executor"), sankeyGrowIn = (params, isOverall = !0) => ({
...
class LinkPathGrowIn extends custom_animate_1.ACustomAnimate {
    onBind() {
        var _a, _b, _c;
...
class LinkPathGrowOut extends custom_animate_1.ACustomAnimate {
    onBind() {
        var _a, _b, _c;
        super.onBind(), (null === (_a = this.params) || void 0 === _a ? void 0 : _a.diffAttrs) && this.target.setAttributes(this.params.diffAttrs);
...
class LinkPathUpdate extends custom_animate_1.ACustomAnimate {
    onBind() {
        var _a, _b, _c;
...
const registerSankeyAnimation = () => {
    ...
    }))), animate_executor_1.AnimateExecutor.registerBuiltInAnimate("linkPathGrowOut", LinkPathGrowOut), 
    animate_executor_1.AnimateExecutor.registerBuiltInAnimate("linkPathGrowIn", LinkPathGrowIn);
};
