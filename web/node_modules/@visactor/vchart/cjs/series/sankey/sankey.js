...
class SankeySeries extends cartesian_1.CartesianSeries {
        ...
        this._viewBox = new vutils_1.Bounds, this._fillByNode = datum => {
            ...
            if (this._linkMark) {
                ...
                allLinkElements.forEach(((linkEl, i) => {
                    ...
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0)) : linkDatum.target === nodeDatum.key ? (highlightNodes.includes(linkDatum.source) || highlightNodes.push(linkDatum.source), 
                    (0, graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), 
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0)) : ((0, 
                    graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS), 
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0));
                }));
            }
    ...
    _highLightElements(graphics, highlightNodes) {
        graphics && graphics.length && graphics.forEach((g => {
            ...
            highlightNodes.includes((0, util_2.getDatumOfGraphic)(g).key) ? (0, graphic_state_1.addGraphicState)(g, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0) : (0, 
            graphic_state_1.addGraphicState)(g, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0);
        }));
    }
    initTooltip() {
