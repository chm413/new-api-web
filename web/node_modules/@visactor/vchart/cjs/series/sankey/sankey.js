...
const cartesian_1 = require("../cartesian/cartesian"), type_1 = require("../interface/type"), utils_1 = require("../../animation/utils"), config_1 = require("../../animation/config"), register_1 = require("../../data/register"), sankey_1 = require("../../data/transforms/sankey"), sankey_nodes_1 = require("../../data/transforms/sankey-nodes"), sankey_links_1 = require("../../data/transforms/sankey-links"), interface_1 = require("../../compile/mark/interface"), vdataset_1 = require("@visactor/vdataset"), layout_1 = require("../../constant/layout"), attribute_1 = require("../../constant/attribute"), event_1 = require("../../constant/event"), tooltip_helper_1 = require("./tooltip-helper"), vutils_1 = require("@visactor/vutils"), animation_1 = require("./animation"), color_ordinal_scale_1 = require("../../scale/color-ordinal-scale"), rect_1 = require("../../mark/rect"), text_1 = require("../../mark/text"), link_path_1 = require("../../mark/link-path"), constant_1 = require("./constant"), flatten_1 = require("../../data/transforms/flatten"), factory_1 = require("../../core/factory"), initialize_1 = require("../../data/initialize"), data_key_1 = require("../../data/transforms/data-key"), sankey_transformer_1 = require("./sankey-transformer"), util_1 = require("../../component/util"), util_2 = require("../../util"), glyph_1 = require("../../mark/utils/glyph"), sankey_2 = require("../../theme/builtin/common/series/sankey"), graphic_state_1 = require("../../util/graphic-state");
...
class SankeySeries extends cartesian_1.CartesianSeries {
    constructor() {
        ...
        this._viewBox = new vutils_1.Bounds, this._fillByNode = datum => {
            ...
            allLinkElements && allLinkElements.length && (allNodeElements.forEach((el => {
                (0, graphic_state_1.removeGraphicState)(el, [ interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE ]);
            ...
            if (this._linkMark) {
                ...
                allLinkElements.forEach(((linkEl, i) => {
                    ...
                    (0, graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), 
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0, this._hasLinkStateAnimation())) : linkDatum.target === nodeDatum.key ? (highlightNodes.includes(linkDatum.source) || highlightNodes.push(linkDatum.source), 
                    (0, graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), 
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0, this._hasLinkStateAnimation())) : ((0, 
                    graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS), 
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0, this._hasLinkStateAnimation()));
                }));
            }
            ...
            if (this._linkMark) {
                ...
                allLinkElements.forEach((linkEl => {
                    linkEl === graphic ? ((0, graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), 
                    (0, glyph_1.addRuntimeState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, {
                        ratio: 1
                    }, !0, this._hasLinkStateAnimation())) : ((0, graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS), 
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0, this._hasLinkStateAnimation()));
                }));
            }
            this._nodeMark && this._highLightElements(this._nodeMark.getGraphics(), highlightNodes), 
            ...
            if ("source" === father) {
                ...
                if (allLinkElements.forEach(((linkEl, i) => {
                    ...
                    allLinkElements.forEach(((linkEl, i) => {
                        var _a;
                        const linkDatum = (0, util_2.getDatumOfGraphic)(linkEl);
                        highlightLinks.includes(null !== (_a = linkDatum.key) && void 0 !== _a ? _a : linkDatum.index) ? ((0, 
                        graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), 
                        (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0, this._hasLinkStateAnimation())) : ((0, 
                        graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS), 
                        (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0, this._hasLinkStateAnimation()));
                    }));
                ...
                allLinkElements.forEach(((linkEl, i) => {
                    ...
                    if (selectedDatum && selectedDatum.length) {
                        ...
                        return (0, graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), 
                    ...
                    (0, graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS), 
                    (0, graphic_state_1.addGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0, this._hasLinkStateAnimation());
                })), this._nodeMark && this._highLightElements(this._nodeMark.getGraphics(), highlightNodes);
            }
            this._needClear = !0;
            ...
            if ("source" === ((0, util_2.getDatumOfGraphic)(graphic) ? "parents" : "source")) this._linkMark && allLinkElements.forEach((linkEl => {
                (0, graphic_state_1.removeGraphicState)(linkEl, [ interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE ]);
                ...
                (0, vutils_1.array)(curLinkDatum.datum).forEach((dividedLink => {
                    ...
                    if (linkDatum.source === curLinkDatum.source && linkDatum.target === curLinkDatum.target) return (0, 
                    graphic_state_1.removeGraphicState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), 
                    void (0, glyph_1.addRuntimeState)(linkEl, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, {
                        ratio: 1
                    }, !0, this._hasLinkStateAnimation());
    ...
    _hasStateAnimation(mark) {
        var _a;
        return (0, utils_1.isAnimationEnabledForSeries)(this) && !!(null === (_a = null == mark ? void 0 : mark.hasAnimationByState) || void 0 === _a ? void 0 : _a.call(mark, "state"));
    }
    ...
    _highLightElements(graphics, highlightNodes) {
        graphics && graphics.length && graphics.forEach((g => {
            (0, graphic_state_1.removeGraphicState)(g, [ interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS ]), 
            highlightNodes.includes((0, util_2.getDatumOfGraphic)(g).key) ? (0, graphic_state_1.addGraphicState)(g, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0, this._hasNodeStateAnimation()) : (0, 
            graphic_state_1.addGraphicState)(g, interface_1.STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0, this._hasNodeStateAnimation());
        }));
    }
    initTooltip() {
