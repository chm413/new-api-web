...
class BoxPlotSeries extends cartesian_1.CartesianSeries {
    constructor() {
        super(...arguments), this.type = type_1.SeriesTypeEnum.boxPlot, this.transformerConstructor = box_plot_transformer_1.BoxPlotSeriesSpecTransformer, 
    ...
    initMarkStyle() {
        ...
        outlierMark && this.setMarkStyle(outlierMark, {
            ...
            size: (0, vutils_1.isNumber)(null === (_f = this._outliersStyle) || void 0 === _f ? void 0 : _f.size) ? this._outliersStyle.size : 10
    ...
    initLabelMarkStyle(textMark) {
        textMark && this.setMarkStyle(textMark, {
            ...
            text: datum => datum[this.getMedianField()],
    ...
    initData() {
        ...
        }, !1), this._outlierData = new data_2.CompilableData(this._option, outlierDataView);
    }
    compileData() {
        var _a;
    ...
    _getMarkWidth() {
        ...
        const bandAxisHelper = "horizontal" === this._direction ? this._yAxisHelper : this._xAxisHelper, depthFromSpec = this._groups ? this._groups.fields.length : 1, bandWidth = null !== (_b = null === (_a = bandAxisHelper.getBandwidth) || void 0 === _a ? void 0 : _a.call(bandAxisHelper, depthFromSpec - 1)) && void 0 !== _b ? _b : Math.max(this._boxWidth, this._shaftWidth);
        let width = bandWidth;
    ...
    _getPosition(direction, datum) {
        ...
        const scale = axisHelper.getScale(0), depth = this._groups ? this._groups.fields.length : 1, bandWidth = null !== (_b = null === (_a = axisHelper.getBandwidth) || void 0 === _a ? void 0 : _a.call(axisHelper, depth - 1)) && void 0 !== _b ? _b : Math.max(this._boxWidth, this._shaftWidth), size = this._boxPlotMark.getAttribute(sizeAttribute, datum);
        if (depth > 1 && (0, vutils_1.isValid)(this._spec.boxGapInGroup)) {
            ...
            for (let index = groupFields.length - 1; index >= 1; index--) {
                ...
                space_1.getActualNumValue)(null !== (_e = boxGapInGroup[index - 1]) && void 0 !== _e ? _e : (0, 
...
}, BoxPlotSeries.mark = constant_1.boxPlotSeriesMark, BoxPlotSeries.transformerConstructor = box_plot_transformer_1.BoxPlotSeriesSpecTransformer;
