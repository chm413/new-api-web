...
const vutils_1 = require("@visactor/vutils"), custom_animate_1 = require("@visactor/vrender-animate/custom/custom-animate"), animate_executor_1 = require("@visactor/vrender-animate/executor/animate-executor"), scaleIn = computeCenter => (graphic, options, animationParameters) => {
    var _a;
...
class BoxplotScaleIn extends custom_animate_1.ACustomAnimate {
...
class BoxplotScaleOut extends custom_animate_1.ACustomAnimate {
    constructor(from, to, duration, easing, params) {
        super(from, to, duration, easing, params);
    }
    onBind() {
...
const registeBoxPlotScaleAnimation = () => {
    animate_executor_1.AnimateExecutor.registerBuiltInAnimate("boxplotScaleIn", BoxplotScaleIn), 
    animate_executor_1.AnimateExecutor.registerBuiltInAnimate("boxplotScaleOut", BoxplotScaleOut), 
    animate_executor_1.AnimateExecutor.registerBuiltInAnimate("barBoxplotScaleIn", BarBoxplotScaleIn), 
    animate_executor_1.AnimateExecutor.registerBuiltInAnimate("barBoxplotScaleOut", BarBoxplotScaleOut);
};
