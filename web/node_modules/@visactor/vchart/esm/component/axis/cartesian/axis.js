...
export class CartesianAxis extends AxisComponent {
    ...
    _getContinuousBarBandwidth(depth = 0) {
        ...
        eachSeries(this._regions, (s => {
            ...
            const barSeries = s, field = isXAxis(orient) && "vertical" === barSeries.direction ? barSeries.fieldX[0] : isYAxis(orient) && "horizontal" === barSeries.direction ? barSeries.fieldY[0] : void 0, values = field ? null === (_d = null === (_c = null === (_b = null === (_a = s.getViewDataStatistics) || void 0 === _a ? void 0 : _a.call(s)) || void 0 === _b ? void 0 : _b.latestData) || void 0 === _c ? void 0 : _c[field]) || void 0 === _d ? void 0 : _d.values : void 0;
    ...
    initEvent() {
        super.initEvent(), eachSeries(this._regions, (s => {
            ...
            userId: this._seriesUserId,
            specIndex: this._seriesIndex
        }), this._specVisible && (this.event.on(ChartEvent.layoutEnd, this._updateAxisLayout), 
