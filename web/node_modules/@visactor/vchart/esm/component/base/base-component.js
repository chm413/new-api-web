...
import { collectVRenderComponents, releaseVRenderComponent, releaseVRenderComponentSync } from "./release-vrender-component";
...
export class BaseComponent extends LayoutModel {
    ...
    _releaseVRenderComponent(component) {
        ...
        if (!this._shouldReleaseVRenderComponentsImmediately()) {
            const exitingComponents = collectVRenderComponents(component), releasedWithExit = releaseVRenderComponent(component, {
