...
export class VChart {
    ...
    updateCustomConfigAndRerender(updateSpecResult, sync, option = {}) {
        ...
        this._reCompile(updateSpecResult, option.morphConfig), isUpdateSpecResultLocalOnly(updateSpecResult) ? this : sync ? this._renderSync(option) : this._renderAsync(option);
    }
    ...
    updateDataSync(id, data, parserOptions, userUpdateOptions) {
        return this._isReleased ? this : (this._reSetRenderState(), isNil(this._dataSet) ? this : this._chart ? (this._chart.updateData(id, data, !0, parserOptions), 
    ...
    _reSetRenderState() {
        var _a, _b;
        !this._isReleased && this._compiler && (this._renderState = RenderStateEnum.render, 
