...
export class SankeySeries extends CartesianSeries {
        ...
        this._viewBox = new Bounds, this._fillByNode = datum => {
            ...
            if (this._linkMark) {
                ...
                allLinkElements.forEach(((linkEl, i) => {
                    ...
                    removeGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), addGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0)) : linkDatum.target === nodeDatum.key ? (highlightNodes.includes(linkDatum.source) || highlightNodes.push(linkDatum.source), 
                    removeGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE), addGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0)) : (removeGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS), 
                    addGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0));
                }));
            }
            ...
            if ("source" === father) {
                ...
                if (allLinkElements.forEach(((linkEl, i) => {
                    ...
                    allLinkElements.forEach(((linkEl, i) => {
                        ...
                        addGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0)) : (removeGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS), 
                        addGraphicState(linkEl, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0));
                    }));
                }
                this._nodeMark && this._highLightElements(this._nodeMark.getGraphics(), highlightNodes);
    ...
    _highLightElements(graphics, highlightNodes) {
        graphics && graphics.length && graphics.forEach((g => {
            ...
            highlightNodes.includes(getDatumOfGraphic(g).key) ? addGraphicState(g, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS, !0) : addGraphicState(g, STATE_VALUE_ENUM.STATE_SANKEY_EMPHASIS_REVERSE, !0);
        }));
    }
    initTooltip() {
